Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 28 Nov 2013 18:22:47 +0100 (CET)
Received: from nbd.name ([46.4.11.11]:48497 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6820493Ab3K1RWpQKEqw (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 28 Nov 2013 18:22:45 +0100
Message-ID: <52977B72.40407@phrozen.org>
Date:   Thu, 28 Nov 2013 18:20:50 +0100
From:   John Crispin <john@phrozen.org>
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:10.0.12) Gecko/20130116 Icedove/10.0.12
MIME-Version: 1.0
To:     linux-mips@linux-mips.org
Subject: Re: [RFC][PATCH another try] MIPS: BCM47XX: Prepare support for GPIO
 buttons
References: <1385651664-17551-1-git-send-email-zajec5@gmail.com>
In-Reply-To: <1385651664-17551-1-git-send-email-zajec5@gmail.com>
...
i spoke to hauke earlier today. we are fighting bloat and the INPUT 
based button drivers are part of what we consider bloat. we have been 
movin all targets to the gpio-button-hotplug module in oder to drop the 
dependency on the rather cumbersome input subsystem.

currently the gpio-button-hotplug module uses polled gpios. However i 
have a semi finished patch that adds irq support. i will revamp it and 
push it in the very near future.

as 47xx will need to use the same button driver as all other platforms i 
am afraid that this patch gets a nak and we will need to rebase the 
functionality ontop of the module once irq support was added.
