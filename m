Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 04 Jun 2009 14:13:30 +0100 (WEST)
Received: from mail-px0-f186.google.com ([209.85.216.186]:42358 "EHLO
	mail-px0-f186.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S20022647AbZFDNLq (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Thu, 4 Jun 2009 14:11:46 +0100
Received: by pxi16 with SMTP id 16so752331pxi.22
        for <multiple recipients>; Thu, 04 Jun 2009 06:11:38 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=Ie1DvNIoJwHctkE8fZzKWlD+tfhkPTQ6603K9Mpegxo=;
        b=R+10PWHA4cM9uAfrSvl1XcHnwDQtxyt0xXtSiFJqY32HTyXHVF2g52xKFsXfRnz+zi
         tNEz/W+3eefmqz4KVZx6SnDFi7BO0MYCrnJlNLjNtXPDaCf1+UIRblqTGozoeGWY0Slp
         LW18EJTUFAaF4iRQnREe3bs1YJrfpfbrnDzAU=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=bvVJ/Dy5jTInCsLD/EhSW9amSAPeo6y48lpUCtGHQsB9NYEUUXb7EM0tlOq8JBFgzj
         lxw+1PhCA3O/gvKuztW+oZqHLiLwRme18afQ1YfcO2kMCWMLnCo8pdB5eZMAnMyeX0uh
         weJ6p4eYPo9rYeQs/e2TO33u79+yQisQUlbFk=
Received: by 10.115.92.8 with SMTP id u8mr3403385wal.152.1244121097799;
        Thu, 04 Jun 2009 06:11:37 -0700 (PDT)
Received: from localhost.localdomain ([202.201.14.140])
        by mx.google.com with ESMTPS id j34sm10985742waf.29.2009.06.04.06.11.28
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Thu, 04 Jun 2009 06:11:35 -0700 (PDT)
...
Subject: [loongson-PATCH-v3 25/25] add default kernel config file for loongson-based machines
Date:	Thu,  4 Jun 2009 21:11:20 +0800
Message-Id: <44d9ec4917b6ec7e806797b6526ed2e5d018ccf9.1244120575.git.wuzj@lemote.com>
...
these default kernel config files are stored in arch/mips/configs
    ...
    yeeloong2f_defconfig -->      yeeloong(2f)-8.9inch
	yeeloong2f-7inch_defconfig -->yeeloong(2f)-7inch
...
---
 ...
 5 files changed, 8968 insertions(+), 1912 deletions(-)
