Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 19 Apr 2012 22:06:27 +0200 (CEST)
Received: from home.bethel-hill.org ([63.228.164.32]:50822 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1903730Ab2DSUFj (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 19 Apr 2012 22:05:39 +0200
Received: by home.bethel-hill.org with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
        (Exim 4.72)
        (envelope-from <sjhill@mips.com>)
        id 1SKxbh-0005gi-7H; Thu, 19 Apr 2012 15:05:33 -0500
From:   "Steven J. Hill" <sjhill@mips.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     "Steven J. Hill" <sjhill@mips.com>
Subject: [PATCH v2,03/10] MIPS: Add support for the M14K core.
Date:   Thu, 19 Apr 2012 15:05:12 -0500
Message-Id: <1334865913-12212-2-git-send-email-sjhill@mips.com>
...
+	case CPU_14K:
 	...
 	case CPU_34K:
 	case CPU_1004K:
@@ -832,6 +834,10 @@ static inline void cpu_probe_mips(struct cpuinfo_mips *c, unsigned int cpu)
 		c->cputype = CPU_74K;
