Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 21 Nov 2009 13:09:18 +0100 (CET)
Received: from mail-px0-f173.google.com ([209.85.216.173]:39983 "EHLO
	mail-px0-f173.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S1492484AbZKUMJG (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Sat, 21 Nov 2009 13:09:06 +0100
Received: by pxi3 with SMTP id 3so2992177pxi.22
        for <multiple recipients>; Sat, 21 Nov 2009 04:08:56 -0800 (PST)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer;
        bh=LCdrBDACapQaEUoOs5Tzre0j+nBUOpf9uZUu+4b25+8=;
        b=fSlAEkEL9WfJP8b8zbY4i6fvbyndVc2l/1Ehyj4VfStiiyg1RQfiqbwzb4H5vp81OM
         dJfUPlJGNb+MzXJVrdJndh2AQFoNRoCVin0L4jPdeoWTKv4eI8G3G0QwOfear9qBYsKz
         pqVCehUkF+7V3ACOBrRR6mnB2Pa12jzsGDPDA=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer;
        b=RTeL6ogyRSgRwTkns6/Px0kgmyLnlaiY8/31zRIW1eEXNT4u4Pxs3VuqE84MCU5/sL
         gWGIUc/dLfiftdTbALztu0jecg0XWalie+7vN959ar5rUedyV49VRVWWhPKSSBTYtaxf
         y3z3VWlhcNki2uwNoScHw+NhnM1CNcDdgXb34=
Received: by 10.115.149.10 with SMTP id b10mr3663984wao.157.1258805336649;
        Sat, 21 Nov 2009 04:08:56 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id 23sm1575252pzk.8.2009.11.21.04.08.49
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Sat, 21 Nov 2009 04:08:55 -0800 (PST)
...
Subject: [PATCH v2] [loongson] yeeloong2f: add platform specific support
Date:	Sat, 21 Nov 2009 20:08:39 +0800
Message-Id: <9ef5a0038ec5e9b584be8c960693c434a323620a.1258803311.git.wuzhangjin@gmail.com>
X-Mailer: git-send-email 1.6.2.1
Return-Path: <wuzhangjin@gmail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 25019
...
(This v2 revision adds some cleanups)
...
All of the above drivers have been tested and used in the
2.6.30,2.6.31,2.6.32-rcX kernel for YeeLoong.

Hi, Ralf, Could you please queue it for 2.6.33? without this driver, the
yeeloong netbook will work as a desktop PC ;) 
...
---
 ...
 arch/mips/loongson/lemote-2f/yeeloong_laptop.c | 1350 ++++++++++++++++++++++++
