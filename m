Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 08 Sep 2014 11:14:20 +0200 (CEST)
Received: from qmta08.westchester.pa.mail.comcast.net ([76.96.62.80]:52197
        "EHLO qmta08.westchester.pa.mail.comcast.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27008399AbaIHJOPgpsAP (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 8 Sep 2014 11:14:15 +0200
Received: from omta21.westchester.pa.mail.comcast.net ([76.96.62.72])
        by qmta08.westchester.pa.mail.comcast.net with comcast
        id oZDZ1o0061ZXKqc58ZE84z; Mon, 08 Sep 2014 09:14:08 +0000
Received: from [192.168.1.13] ([50.190.84.14])
        by omta21.westchester.pa.mail.comcast.net with comcast
        id oZE71o00Q0JZ7Re3hZE8q5; Mon, 08 Sep 2014 09:14:08 +0000
Message-ID: <540D7349.7020504@gentoo.org>
Date:   Mon, 08 Sep 2014 05:13:45 -0400
...
Subject: [PATCH 01/02] RTC: Add driver for DS1685 family of real time clocks
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: 7bit
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=comcast.net;
        s=q20140121; t=1410167648;
        bh=pULK47W9ceqGHiLtbqNy94YIX6lUZlbTJe8pyjx1/P4=;
        h=Received:Received:Message-ID:Date:From:MIME-Version:To:Subject:
         Content-Type;
        b=
Return-Path: <kumba@gentoo.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 42467
...
---
 ...
 drivers/rtc/rtc-ds1685.c   | 2246 +++++++++++++++++++++++++++++++++++
 include/linux/rtc/ds1685.h |  375 +++++
 5 files changed, 2718 insertions(+)

The checkpatch errors regarding "Macros with complex values should be enclosed in parenthesis" should be fine.  That macro construct I copied from elsewhere in the kernel, and I don't think wrapping them in parenthesis helps at all.  Please let me know of any problems, thanks!

linux-rtc-ds1685.patch
diff --git a/MAINTAINERS b/MAINTAINERS
index 5e7866a..8a4aea3 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -2754,6 +2754,12 @@ S:	Supported
...
index a168e96..033f451 100644
--- a/drivers/rtc/Kconfig
+++ b/drivers/rtc/Kconfig
@@ -759,6 +759,96 @@ config RTC_DRV_DS1553
...
index 56f061c..3dd3293 100644
--- a/drivers/rtc/Makefile
+++ b/drivers/rtc/Makefile
@@ -52,6 +52,7 @@ obj-$(CONFIG_RTC_DRV_DS1390)	+= rtc-ds1390.o
