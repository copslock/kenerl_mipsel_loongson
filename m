Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 30 Dec 2017 17:37:00 +0100 (CET)
Received: from mail.kapsi.fi ([IPv6:2001:67c:1be8::25]:46266 "EHLO
        mail.kapsi.fi" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S23990412AbdL3QgtoTAh8 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sat, 30 Dec 2017 17:36:49 +0100
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=kapsi.fi; s=20161220;
        h=Content-Transfer-Encoding:Content-Type:In-Reply-To:MIME-Version:Date:Message-ID:From:References:Cc:To:Subject; bh=SfBvxjKh3dTUczaYBXfhZa9bfUibAe7vC0x3w7WMrec=;
        b=;
Received: from dsl-hkibng22-54f983-249.dhcp.inet.fi ([84.249.131.249])
        by mail.kapsi.fi with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.84_2)
        (envelope-from <cyndis@kapsi.fi>)
        id 1eVK7J-0004zx-Mz; Sat, 30 Dec 2017 18:36:14 +0200
...
X-SA-Exim-Connect-IP: 84.249.131.249
X-SA-Exim-Mail-From: cyndis@kapsi.fi
X-SA-Exim-Scanned: No (on mail.kapsi.fi); SAEximRunCond expanded to false
Return-Path: <cyndis@kapsi.fi>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 61789
X-ecartis-version: Ecartis v1.0.0
Sender: linux-mips-bounce@linux-mips.org
Errors-to: linux-mips-bounce@linux-mips.org
X-original-sender: cyndis@kapsi.fi
Precedence: bulk
