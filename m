Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 16 Aug 2013 08:24:48 +0200 (CEST)
Received: from arrakis.dune.hu ([78.24.191.176]:56025 "EHLO arrakis.dune.hu"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6822956Ab3HPGYk1KMBD (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 16 Aug 2013 08:24:40 +0200
Received: from arrakis.dune.hu (localhost [127.0.0.1])
        by arrakis.dune.hu (Postfix) with ESMTP id ED2CC280314;
        Fri, 16 Aug 2013 08:24:17 +0200 (CEST)
...
Subject: [PATCH v2] MIPS: add driver for the built-in PCI controller of the RT3883 SoC
Date:   Fri, 16 Aug 2013 08:24:25 +0200
Message-Id: <1376634265-2433-1-git-send-email-juhosg@openwrt.org>
X-Mailer: git-send-email 1.7.10
Return-Path: <juhosg@openwrt.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 37567
...
---
 .../devicetree/bindings/pci/ralink,rt3883-pci.txt  |  191 ++++++
