Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 02 Mar 2017 10:45:00 +0100 (CET)
Received: from mailapp01.imgtec.com ([195.59.15.196]:48163 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S23993890AbdCBJhiXuBjt (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 2 Mar 2017 10:37:38 +0100
Received: from hhmail02.hh.imgtec.org (unknown [10.100.10.20])
        by Forcepoint Email with ESMTPS id 00944C32829AB;
        Thu,  2 Mar 2017 09:37:29 +0000 (GMT)
Received: from jhogan-linux.le.imgtec.org (192.168.154.110) by
 hhmail02.hh.imgtec.org (10.100.10.21) with Microsoft SMTP Server (TLS) id
 14.3.294.0; Thu, 2 Mar 2017 09:37:30 +0000
...
Subject: [PATCH 17/32] KVM: MIPS: Abstract guest CP0 register access for VZ
Date:   Thu, 2 Mar 2017 09:36:44 +0000
Message-ID: <aa1a9576daf8748326712d8c846090ac16f61ce9.1488447004.git-series.james.hogan@imgtec.com>
...
index 3fee98e44f67..cff18b2156f9 100644
--- a/arch/mips/include/asm/kvm_host.h
+++ b/arch/mips/include/asm/kvm_host.h
@@ -363,78 +363,6 @@ struct kvm_vcpu_arch {
 	u8 msa_enabled;
 };
...
-
 static inline void _kvm_atomic_set_c0_guest_reg(unsigned long *reg,
 						unsigned long val)
 {
@@ -485,26 +413,265 @@ static inline void _kvm_atomic_change_c0_guest_reg(unsigned long *reg,
 	} while (unlikely(!temp));
 }
...
index 9dd9905681ed..a500d2be2022 100644
--- a/arch/mips/kvm/mips.c
+++ b/arch/mips/kvm/mips.c
@@ -1114,7 +1114,7 @@ int kvm_arch_vcpu_dump_regs(struct kvm_vcpu *vcpu)
...
@@ -1289,7 +1289,7 @@ int kvm_mips_handle_exit(struct kvm_run *run, struct kvm_vcpu *vcpu)
 		break;
...
@@ -1360,7 +1360,7 @@ int kvm_mips_handle_exit(struct kvm_run *run, struct kvm_vcpu *vcpu)
 			opc += 1;
 		inst = 0;
...
index 1e039fb592e0..cc9a8667b80e 100644
...
+	kvm_err("Exception Code: %d not handled @ PC: %p, inst: 0x%08x BadVaddr: %#lx Status: %#x\n",
 		...
 		kvm_read_c0_guest_status(vcpu->arch.cop0));
 	kvm_arch_vcpu_dump_regs(vcpu);
@@ -936,10 +936,12 @@ static int kvm_trap_emul_set_one_reg(struct kvm_vcpu *vcpu,
 			if (v & CAUSEF_DC) {
 				/* disable timer first */
