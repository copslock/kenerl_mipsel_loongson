Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 29 Aug 2016 18:13:18 +0200 (CEST)
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:42466 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by eddie.linux-mips.org
        with ESMTP id S23992211AbcH2QNK5iA5e (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 29 Aug 2016 18:13:10 +0200
Received: from Internal Mail-Server by MTLPINE1 (envelope-from cmetcalf@mellanox.com)
        with ESMTPS (AES256-SHA encrypted); 29 Aug 2016 19:13:00 +0300
Received: from ld-1.internal.tilera.com (ld-1.internal.tilera.com [10.15.7.41])
        by mtbu-labmail01.internal.tilera.com (8.14.4/8.14.4) with ESMTP id u7TGCwcK025189;
        Mon, 29 Aug 2016 12:12:58 -0400
Received: (from cmetcalf@localhost)
        by ld-1.internal.tilera.com (8.14.4/8.14.4/Submit) id u7TGCw2T014973;
        Mon, 29 Aug 2016 12:12:58 -0400
...
Subject: [PATCH v9 1/4] nmi_backtrace: add more trigger_*_cpu_backtrace() methods
Date:   Mon, 29 Aug 2016 12:12:46 -0400
Message-Id: <1472487169-14923-2-git-send-email-cmetcalf@mellanox.com>
X-Mailer: git-send-email 2.7.2
In-Reply-To: <1472487169-14923-1-git-send-email-cmetcalf@mellanox.com>
References: <1472487169-14923-1-git-send-email-cmetcalf@mellanox.com>
Return-Path: <cmetcalf@mellanox.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 54833
