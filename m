Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 20 Oct 2006 20:57:44 +0100 (BST)
Received: from smtp111.sbc.mail.mud.yahoo.com ([68.142.198.210]:13731 "HELO
	smtp111.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S20038952AbWJTT5l (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 20 Oct 2006 20:57:41 +0100
Received: (qmail 97025 invoked from network); 20 Oct 2006 19:57:30 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@71.146.96.39 with login)
  by smtp111.sbc.mail.mud.yahoo.com with SMTP; 20 Oct 2006 19:57:29 -0000
Received: by lucon.org (Postfix, from userid 500)
	id 32C3E105CB; Fri, 20 Oct 2006 12:57:28 -0700 (PDT)
Date:	Fri, 20 Oct 2006 12:57:28 -0700
...
Subject: The Linux binutils 2.17.50.0.6 is released
Message-ID: <20061020195728.GA18006@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.6 to hjl@lucon.org
...
1. binutils-2.17.50.0.6.tar.bz2. Source code.
2. binutils-2.17.50.0.5-2.17.50.0.6.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.6-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.6-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.6-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.6.tar.bz2
