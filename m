Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 24 Feb 2016 22:22:36 +0100 (CET)
Received: from mail-pa0-f45.google.com ([209.85.220.45]:35058 "EHLO
        mail-pa0-f45.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27013928AbcBXVWdekG3f convert rfc822-to-8bit
        (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 24 Feb 2016 22:22:33 +0100
Received: by mail-pa0-f45.google.com with SMTP id ho8so19799886pac.2
        for <linux-mips@linux-mips.org>; Wed, 24 Feb 2016 13:22:33 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=NcZYg3PwDcZQw28BvZHDSTH/sxR0ZRuxBpG6UVrplrU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=NcZYg3PwDcZQw28BvZHDSTH/sxR0ZRuxBpG6UVrplrU=;
        b=
X-Gm-Message-State: AG10YOSlpVp8VOPhtYiRf6v6DN+HfHQFsZnLI3y+sMggjfMkXQ4g0msIT+uATnLgO4qeQpQC
X-Received: by 10.66.102.8 with SMTP id fk8mr58129342pab.12.1456348947194;
        Wed, 24 Feb 2016 13:22:27 -0800 (PST)
Received: from localhost (cpe-172-248-200-249.socal.res.rr.com. [172.248.200.249])
        by smtp.gmail.com with ESMTPSA id r65sm7110454pfa.27.2016.02.24.13.22.25
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Wed, 24 Feb 2016 13:22:25 -0800 (PST)
...
In-Reply-To: <1456330090-27226-3-git-send-email-joshua.henderson@microchip.com>
Cc:     linux-mips@linux-mips.org, ralf@linux-mips.org,
        "Purna Chandra Mandal" <purna.mandal@microchip.com>,
        "Joshua Henderson" <joshua.henderson@microchip.com>,
        "Stephen Boyd" <sboyd@codeaurora.org>, linux-clk@vger.kernel.org
References: <1456330090-27226-1-git-send-email-joshua.henderson@microchip.com>
 <1456330090-27226-3-git-send-email-joshua.henderson@microchip.com>
Message-ID: <20160224212226.2278.10980@quark.deferred.io>
User-Agent: alot/0.3.6
Subject: Re: [PATCH v8 2/3] clk: clk-pic32: Add PIC32 clock driver
Date:   Wed, 24 Feb 2016 13:22:26 -0800
Return-Path: <mturquette@baylibre.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 52223
...
Quoting Joshua Henderson (2016-02-24 08:07:16)
...
Thanks for looking into the CLK_OF_DECLARE/platform_driver thing. We're
seeing a common pattern where it is necessary to register some clocks
very early (like in your case), but we always want to conform to the
Linux driver model. Since you need CLK_OF_DECLARE, can you split your
registration into just the early timer clocks and everything else?

Joachim has done this for the lpc18xx clock driver here:
