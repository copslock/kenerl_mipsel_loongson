Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 22 Jan 2007 19:47:05 +0000 (GMT)
Received: from smtp112.sbc.mail.mud.yahoo.com ([68.142.198.211]:31158 "HELO
	smtp112.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S28577246AbXAVTq7 (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Mon, 22 Jan 2007 19:46:59 +0000
Received: (qmail 88767 invoked from network); 22 Jan 2007 19:46:52 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@71.146.69.37 with login)
  by smtp112.sbc.mail.mud.yahoo.com with SMTP; 22 Jan 2007 19:46:51 -0000
X-YMail-OSG: q8bPB5AVM1lJWd0PYZkILBXisA3flJkeaQdJdAtkRZCdE.sl9T5XZJFd6xbNwMWrAL.ck2NMszIw7iPBkR5qcFabp16Lj75W_h1zbeBTUEnQPNDyqMg-
Received: by lucon.org (Postfix, from userid 500)
	id A82C746EEB1; Mon, 22 Jan 2007 11:46:41 -0800 (PST)
Date:	Mon, 22 Jan 2007 11:46:41 -0800
From:	"H. J. Lu" <hjl@lucon.org>
To:	GNU C Library <libc-alpha@sources.redhat.com>, gcc@gcc.gnu.org,
	linux-gcc@vger.kernel.org, Mat Hostetter <mat@lcs.mit.edu>,
	Warner Losh <imp@village.org>, linux-mips@linux-mips.org,
	Ralf Baechle <ralf@linux-mips.org>,
	Linas Vepstas <linas@linas.org>, linux-vax@pergamentum.com
Subject: The Linux binutils 2.17.50.0.10 is released
Message-ID: <20070122194641.GA27561@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.10 to hjl@lucon.org
...
1. binutils-2.17.50.0.10.tar.bz2. Source code.
2. binutils-2.17.50.0.9-2.17.50.0.10.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.10-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.10-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.10-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.10.tar.bz2
