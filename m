Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 20 Aug 2017 00:24:47 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:33690 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995034AbdHSWUPOV70i (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 20 Aug 2017 00:20:15 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id C291449109;
        Sun, 20 Aug 2017 00:20:07 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter02.heinlein-hosting.de (spamfilter02.heinlein-hosting.de [80.241.56.116]) (amavisd-new, port 10030)
        with ESMTP id 9Qrp5eYnRgYx; Sun, 20 Aug 2017 00:20:05 +0200 (CEST)
...
Subject: [PATCH v10 10/16] reset: Add a reset controller driver for the Lantiq XWAY based SoCs
Date:   Sun, 20 Aug 2017 00:18:17 +0200
Message-Id: <20170819221823.13850-11-hauke@hauke-m.de>
