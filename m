Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 08 Apr 2014 13:51:21 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.89.28.114]:34345 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S6822536AbaDHLrcbv100 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 8 Apr 2014 13:47:32 +0200
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id 494F1D44B8D49
        for <linux-mips@linux-mips.org>; Tue,  8 Apr 2014 12:47:21 +0100 (IST)
Received: from LEMAIL01.le.imgtec.org (192.168.152.62) by
 KLMAIL01.kl.imgtec.org (192.168.5.35) with Microsoft SMTP Server (TLS) id
 14.3.181.6; Tue, 8 Apr 2014 12:47:23 +0100
Received: from mchandras-linux.le.imgtec.org (192.168.154.89) by
 LEMAIL01.le.imgtec.org (192.168.152.62) with Microsoft SMTP Server (TLS) id
 14.3.174.1; Tue, 8 Apr 2014 12:47:22 +0100
From:   Markos Chandras <markos.chandras@imgtec.com>
To:     <linux-mips@linux-mips.org>
CC:     Markos Chandras <markos.chandras@imgtec.com>
Subject: [PATCH 13/14] MIPS: net: Add BPF JIT
Date:   Tue, 8 Apr 2014 12:47:14 +0100
Message-ID: <1396957635-27071-14-git-send-email-markos.chandras@imgtec.com>
...
+}
+
+static inline void emit_ins(unsigned int dst, unsigned int src,
+			    unsigned int pos, unsigned int size,
+			    struct jit_ctx *ctx)
+{
+	emit_instr(ctx, ins, dst, src, pos, size);
+}
+
...
+		emit_load_imm(r_tmp, imm >> 32, ctx);
