Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 09 Aug 2008 11:26:16 +0100 (BST)
Received: from elvis.franken.de ([193.175.24.41]:47241 "EHLO elvis.franken.de")
	by ftp.linux-mips.org with ESMTP id S20045372AbYHIKZt (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Sat, 9 Aug 2008 11:25:49 +0100
Received: from uucp (helo=solo.franken.de)
	by elvis.franken.de with local-bsmtp (Exim 3.36 #1)
	id 1KRldr-000090-02; Sat, 09 Aug 2008 12:25:47 +0200
Received: by solo.franken.de (Postfix, from userid 1000)
	id 18C55C3163; Sat,  9 Aug 2008 12:25:39 +0200 (CEST)
From:	Thomas Bogendoerfer <tsbogend@alpha.franken.de>
Subject: [PATCH v3] IP27: Switch over to RTC class driver
To:	linux-mips@linux-mips.org
cc:	ralf@linux-mips.org
Message-Id: <20080809102539.18C55C3163@solo.franken.de>
Date:	Sat,  9 Aug 2008 12:25:39 +0200 (CEST)
Return-Path: <tsbogend@alpha.franken.de>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 20162
