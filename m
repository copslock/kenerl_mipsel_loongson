Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 22 Nov 2009 08:41:30 +0100 (CET)
Received: from mail-px0-f173.google.com ([209.85.216.173]:39813 "EHLO
	mail-px0-f173.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S1492015AbZKVHlY (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Sun, 22 Nov 2009 08:41:24 +0100
Received: by pxi3 with SMTP id 3so3326934pxi.22
        for <multiple recipients>; Sat, 21 Nov 2009 23:41:16 -0800 (PST)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer;
        bh=jfe5v5bwc2MC0YBv5f4soAvtZkbpGwfwBhZCIRovHro=;
        b=ipBY7OQYLKNAzDIlOQ66W7olipBtvGRh4Wh3HCe7NEHh28/4Yt4FwEbnPbEsbQa4mK
         u5hNpRA174WvHiEuzS3mWnDdzE7C8tOGBZDocLMTLae2BNc7GXPAnBJtniIurH6EcbO0
         pJLP3QnAzhMXsn4bISC4EyXr75Lem3G3uDCfY=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer;
        b=cuH4/GsbZMRM1J492c1VR/TsId6WTfgngCUPRPvC81sZWxFI14xFGFZjEodpncxpdn
         nI7Il6c3lGDkhj4oKNuqAaHa3TBykqRETgaojqhMxlVFZzS9B+/s6g/IoilMi8MLqx4E
         pyRGnfgbweNTkI9SMjYb97SaxFUp2VnIKyQN0=
Received: by 10.115.67.8 with SMTP id u8mr5510681wak.190.1258875676621;
        Sat, 21 Nov 2009 23:41:16 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id 23sm2082372pxi.9.2009.11.21.23.41.06
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Sat, 21 Nov 2009 23:41:15 -0800 (PST)
From:	Wu Zhangjin <wuzhangjin@gmail.com>
To:	Ralf Baechle <ralf@linux-mips.org>
Cc:	linux-mips@linux-mips.org, Wu Zhangjin <wuzhangjin@gmail.com>
Subject: [PATCH v3] [loongson] yeeloong2f: add platform specific support
Date:	Sun, 22 Nov 2009 15:40:59 +0800
Message-Id: <1258875659-13358-1-git-send-email-wuzhangjin@gmail.com>
X-Mailer: git-send-email 1.6.2.1
Return-Path: <wuzhangjin@gmail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 25029
...
(This v3 revision fixes the handling of ec version string, avoid to cut
 off the strings of arcs_cmdline after EC_VER=xxx)
