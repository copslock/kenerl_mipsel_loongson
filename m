Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 28 Jun 2012 00:37:09 +0200 (CEST)
Received: from mail.work-microwave.de ([62.245.205.51]:29750 "EHLO
        work-microwave.de" rhost-flags-OK-OK-OK-FAIL) by eddie.linux-mips.org
        with ESMTP id S1903549Ab2F0WhD (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 28 Jun 2012 00:37:03 +0200
Received: from rst-pc1.lan.work-microwave.de ([192.168.11.78])
        (authenticated bits=0)
        by mail.work-microwave.de  with ESMTP id q5RMaxDN030844
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=NO);
        Wed, 27 Jun 2012 23:37:00 +0100
Received: by rst-pc1.lan.work-microwave.de (Postfix, from userid 1000)
        id 54315AE06F; Thu, 28 Jun 2012 00:36:59 +0200 (CEST)
...
Message-Id: <1340836617-21666-1-git-send-email-stigge@antcom.de>
X-Mailer: git-send-email 1.7.10.4
X-FEAS-SYSTEM-WL: rst@work-microwave.de, 192.168.11.78
X-archive-position: 33860
