Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 24 Oct 2014 12:06:46 +0200 (CEST)
Received: from localhost.localdomain ([127.0.0.1]:52472 "EHLO linux-mips.org"
        rhost-flags-OK-OK-OK-FAIL) by eddie.linux-mips.org with ESMTP
        id S27010490AbaJXKGoJsRiB (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 24 Oct 2014 12:06:44 +0200
Received: from scotty.linux-mips.net (localhost.localdomain [127.0.0.1])
        by scotty.linux-mips.net (8.14.8/8.14.8) with ESMTP id s9OA6h3k022103;
        Fri, 24 Oct 2014 12:06:43 +0200
Received: (from ralf@localhost)
        by scotty.linux-mips.net (8.14.8/8.14.8/Submit) id s9OA6gwM022102;
        Fri, 24 Oct 2014 12:06:42 +0200
Date:   Fri, 24 Oct 2014 12:06:42 +0200
From:   Ralf Baechle <ralf@linux-mips.org>
To:     Markos Chandras <markos.chandras@imgtec.com>,
        Chris Dearman <chris.dearman@imgtec.com>
Cc:     linux-mips@linux-mips.org
Subject: [PATCH] MIPS: SEAD3: Nuke unused sead3-pic32-i2c-drv.
Message-ID: <20141024100642.GB12641@linux-mips.org>
References: <1412847261-7930-1-git-send-email-markos.chandras@imgtec.com>
 ...
 <20141024081509.GA12641@linux-mips.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20141024081509.GA12641@linux-mips.org>
User-Agent: Mutt/1.5.23 (2014-03-12)
Return-Path: <ralf@linux-mips.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 43554
...
index febf433..9d9ff6f 100644
--- a/arch/mips/mti-sead3/Makefile
+++ b/arch/mips/mti-sead3/Makefile
@@ -14,8 +14,7 @@ obj-y				:= sead3-lcd.o sead3-display.o sead3-init.o \
 				   sead3-setup.o sead3-time.o
 
 obj-y				+= sead3-i2c-dev.o sead3-i2c.o \
-				   sead3-pic32-i2c-drv.o sead3-pic32-bus.o \
-				   leds-sead3.o sead3-leds.o
+				   sead3-pic32-bus.o leds-sead3.o sead3-leds.o
