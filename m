Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 29 Aug 2006 14:54:50 +0100 (BST)
Received: from mba.ocn.ne.jp ([210.190.142.172]:22988 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S20039460AbWH2Nyr (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Tue, 29 Aug 2006 14:54:47 +0100
Received: from localhost (p4102-ipad205funabasi.chiba.ocn.ne.jp [222.146.99.102])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 455FE9BDB; Tue, 29 Aug 2006 22:54:41 +0900 (JST)
Date:	Tue, 29 Aug 2006 22:56:31 +0900 (JST)
Message-Id: <20060829.225631.41630441.anemo@mba.ocn.ne.jp>
To:	linux-mips@linux-mips.org
Cc:	ralf@linux-mips.org
Subject: Re: [PATCH] rewrite restore_fp_context/save_fp_context
From:	Atsushi Nemoto <anemo@mba.ocn.ne.jp>
In-Reply-To: <20060620.003746.78731943.anemo@mba.ocn.ne.jp>
References: <20060208.015250.130239257.anemo@mba.ocn.ne.jp>
	<20060411.185449.126141341.nemoto@toshiba-tops.co.jp>
	<20060620.003746.78731943.anemo@mba.ocn.ne.jp>
...
@@ -107,19 +140,16 @@ #undef restore_gp_reg
...
+
 ...
 {
 	u32 used_math;
@@ -367,19 +399,16 @@ #undef restore_gp_reg
 	err |= __get_user(used_math, &sc->sc_used_math);
 	conditional_used_math(used_math);
...
@@ -598,15 +627,14 @@ #undef save_gp_reg
 	 * current FPU state.
 	 */
 	preempt_disable();
-
...
index e51d8fd..5ac6c35 100644
--- a/arch/mips/kernel/traps.c
+++ b/arch/mips/kernel/traps.c
@@ -1276,77 +1276,6 @@ static inline void mips_srs_init(void)
...
@@ -1577,11 +1506,6 @@ void __init trap_init(void)
 	else
...
index 58c561a..4d91c0b 100644
--- a/include/asm-mips/fpu.h
+++ b/include/asm-mips/fpu.h
@@ -24,15 +24,6 @@ #ifdef CONFIG_MIPS_MT_FPAFF
