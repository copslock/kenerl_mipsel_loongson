Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 01 Apr 2011 05:08:59 +0200 (CEST)
Received: from mx1.netlogicmicro.com ([12.49.93.86]:2655 "EHLO
        orion5.netlogicmicro.com" rhost-flags-OK-OK-OK-FAIL)
        by eddie.linux-mips.org with ESMTP id S1491010Ab1DADIv (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 1 Apr 2011 05:08:51 +0200
X-TM-IMSS-Message-ID: <7513b18c00009b54@netlogicmicro.com>
Received: from orion8.netlogicmicro.com ([10.10.16.60]) by netlogicmicro.com ([10.10.16.19]) with ESMTP (TREND IMSS SMTP Service 7.0) id 7513b18c00009b54 ; Thu, 31 Mar 2011 20:08:44 -0700
Received: from jayachandranc.netlogicmicro.com ([10.7.0.77]) by orion8.netlogicmicro.com with Microsoft SMTPSVC(6.0.3790.3959);
         Thu, 31 Mar 2011 20:08:58 -0700
Date:   Fri, 1 Apr 2011 08:38:32 +0530
From:   Jayachandran C <jayachandranc@netlogicmicro.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Subject: [PATCH 5/6] Kconfig and Makefile update for Netlogic XLR/XLS
Message-ID: <4ed99b58db8aafa2bed24b90ede3486b64dcb0ff.1301626288.git.jayachandranc@netlogicmicro.com>
...
X-OriginalArrivalTime: 01 Apr 2011 03:08:59.0077 (UTC) FILETIME=[25001750:01CBF01A]
Return-Path: <jayachandranc@netlogicmicro.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 29669
...
@@ -1425,6 +1453,17 @@ config CPU_BMIPS5000
 	help
...
+	  Netlogic Microsystems XLR/XLS processors.
 ...
 if CPU_LOONGSON2F
@@ -1555,6 +1594,9 @@ config SYS_HAS_CPU_BMIPS4380
