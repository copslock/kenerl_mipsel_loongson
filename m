Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 18 Jun 2013 16:39:30 +0200 (CEST)
Received: from mail.windriver.com ([147.11.1.11]:42001 "EHLO
        mail.windriver.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S6824790Ab3FROjS2VVKx (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 18 Jun 2013 16:39:18 +0200
Received: from ALA-HCA.corp.ad.wrs.com (ala-hca.corp.ad.wrs.com [147.11.189.40])
        by mail.windriver.com (8.14.5/8.14.3) with ESMTP id r5IEdA4Z029854
        (version=TLSv1/SSLv3 cipher=AES128-SHA bits=128 verify=FAIL);
        Tue, 18 Jun 2013 07:39:10 -0700 (PDT)
Received: from yow-lpgnfs-02.corp.ad.wrs.com (128.224.149.8) by
 ALA-HCA.corp.ad.wrs.com (147.11.189.40) with Microsoft SMTP Server id
 14.2.342.3; Tue, 18 Jun 2013 07:39:10 -0700
From:   Paul Gortmaker <paul.gortmaker@windriver.com>
To:     Ralf Baechle <ralf@linux-mips.org>
CC:     <linux-mips@linux-mips.org>,
        Paul Gortmaker <paul.gortmaker@windriver.com>
Subject: [PATCH v2] mips: delete __cpuinit/__CPUINIT usage from MIPS code
Date:   Tue, 18 Jun 2013 10:38:59 -0400
Message-ID: <1371566339-18336-1-git-send-email-paul.gortmaker@windriver.com>
...
[v2 -- also deal with __CPUINIT, add comment about temporary
 section warnings, rebase to today's (Jun18) version of
 ...
 61 files changed, 294 insertions(+), 332 deletions(-)
...
-	__CPUINIT
 NESTED(nlm_boot_secondary_cpus, 16, sp)
 	...
 	move	t1, zero
@@ -102,7 +101,6 @@ END(nlm_boot_secondary_cpus)
