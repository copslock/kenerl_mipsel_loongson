Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 20 Nov 2015 05:53:28 +0100 (CET)
Received: from mxout51.expurgate.net ([194.37.255.51]:35486 "EHLO
        mxout51.expurgate.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27010850AbbKTExZ0H1qp convert rfc822-to-8bit
        (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 20 Nov 2015 05:53:25 +0100
Received: from [127.0.0.1] (helo=localhost)
        by relay.expurgate.net with smtp (Exim 4.80.1)
        (envelope-from <mschiller@tdt.de>)
        id 1ZzdhG-0001I4-Sb; Fri, 20 Nov 2015 05:53:18 +0100
Received: from [195.243.126.94] (helo=ms.tdt.de)
        by relay.expurgate.net with esmtp (Exim 4.80.1)
        (envelope-from <mschiller@tdt.de>)
        id 1ZzdhF-0004Tg-Qv; Fri, 20 Nov 2015 05:53:17 +0100
...
Subject: [PATCH 2/4] pinctrl/lantiq: introduce new dedicated devicetree bindings
Date:   Fri, 20 Nov 2015 05:52:29 +0100
Message-ID: <1447995151-3857-2-git-send-email-mschiller@tdt.de>
...
X-purgate-sourceid: 1ZzdhF-0004Tg-Qv
X-purgate-Ad: Checked for spam and viruses by eXpurgate(R), see www.eleven.de for details.
X-purgate-ID: 151534::1447995198-000033D1-7A59CED7/0/0
X-purgate: clean
