Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 16 Feb 2014 22:12:18 +0100 (CET)
Received: from [195.154.112.97] ([195.154.112.97]:52992 "EHLO hall.aurel32.net"
        rhost-flags-FAIL-FAIL-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6827297AbaBPVMOLhWSj (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 16 Feb 2014 22:12:14 +0100
Received: from aurel32 by hall.aurel32.net with local (Exim 4.80)
        (envelope-from <aurelien@aurel32.net>)
        id 1WF90R-0003sw-0e; Sun, 16 Feb 2014 22:12:07 +0100
Date:   Sun, 16 Feb 2014 22:12:06 +0100
...
Subject: Re: [PATCH V19 09/13] MIPS: Loongson: Add swiotlb to support
 All-Memory DMA
Message-ID: <20140216211206.GA491@hall.aurel32.net>
...
In-Reply-To: <1392537690-5961-10-git-send-email-chenhc@lemote.com>
...
#ifdef CONFIG_ZONE_DMA32
	if (dev->coherent_dma_mask < DMA_BIT_MASK(loongson_sysconf.dma_mask_bits))
		gfp |= __GFP_DMA32;
	else
#endif
