Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 29 Mar 2012 19:11:08 +0200 (CEST)
Received: from smtp-vbr12.xs4all.nl ([194.109.24.32]:2821 "EHLO
        smtp-vbr12.xs4all.nl" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1903600Ab2C2RLD (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 29 Mar 2012 19:11:03 +0200
Received: from starbug-2.trinair2002 (dhcp-089-098-069-120.chello.nl [89.98.69.120])
        (authenticated bits=0)
        by smtp-vbr12.xs4all.nl (8.13.8/8.13.8) with ESMTP id q2THB1eJ024110;
        Thu, 29 Mar 2012 19:11:02 +0200 (CEST)
        (envelope-from maarten@treewalker.org)
Received: from hyperion.trinair2002 (hyperion.trinair2002 [192.168.0.43])
        by starbug-2.trinair2002 (Postfix) with ESMTP id EDC933DF38;
        Thu, 29 Mar 2012 19:11:00 +0200 (CEST)
From:   Maarten ter Huurne <maarten@treewalker.org>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org,
        Maarten ter Huurne <maarten@treewalker.org>
Subject: [PATCH 1/2] MTD: NAND: JZ4740: Multi-bank support with autodetection
Date:   Thu, 29 Mar 2012 19:17:01 +0200
Message-Id: <1333041422-20411-1-git-send-email-maarten@treewalker.org>
X-Mailer: git-send-email 1.7.7
X-Virus-Scanned: by XS4ALL Virus Scanner
X-archive-position: 32818
...
---
 ...
 drivers/mtd/nand/jz4740_nand.c                  |  226 +++++++++++++++++++----
