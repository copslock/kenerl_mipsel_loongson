...
Received: from login_0246.mailservice.net (mx.service.net[206.212.231.77] (may be forged)) by [212.201.122.247] (8.8.5/8.7.3) with SMTP id XAA05637 for <linux-mips@oss.sgi.com>;  星期一, 15 十月 2001 01:26:47 -0700 (EDT)
To: <linux-mips@oss.sgi.com>
From: <e82_2vgkalf3lycv@misys.co.uk>
Subject: 真的！無條件送您手機與門號
...
贈送手機： MOTOROLA  T2288（英文機）

精算188月租費：     188元

免費通話：  抵188元月租費

一般時段：  0.16元/秒，週一至週日全日

減價時段：  同一般時段收費

本網互打：  0.08元/秒（半價）

（精算188計費方式對任何和信使用者皆相同）
...
（哈拉900計費方式對任何和信使用者皆相同）




請注意：哈啦900每月免費通話分鐘數，當月未用完的，
       不得遞延到下個月使用。
       哈啦900之每月免費通話之200分鐘不含網內互撥。
       哈啦900和信網內互撥有免費規定，
       精算188網內互撥有半價規定，
       最適合常常相互聯絡的朋友們一起申請。
       精算188與哈啦900之門號使用期限規定為至少兩年，
       與在一般通訊行申請相同。


日後的通話費，您可在和信門市、7-11、匯款、劃撥..等等繳納，
當然也可由和信電訊採銀行帳號自動扣款方式。

（每月通話費付費方式對任何和信使用者皆相同）

申請門號所需證件
1.您需準備身份證影本（正反面）
2.銀行存摺封面影本（與身份證相同名字）
3.便章一顆（與身份證影本名字相同，不需要印鑑證明圖章）
...
如選擇免費方案，您不必出任何半毛錢，即可擁有手機＋門號！

如選擇合算付費方案，您只要付888元，即可擁有手機＋門號！
