Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 26 Feb 2015 20:02:22 +0100 (CET)
Received: from home.bethel-hill.org ([63.228.164.32]:34162 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27007493AbbBZTBouaKhO (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 26 Feb 2015 20:01:44 +0100
Received: by home.bethel-hill.org with esmtpsa (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.84)
        (envelope-from <Steven.Hill@imgtec.com>)
        id 1YR3dA-0007Ul-S0; Thu, 26 Feb 2015 12:57:52 -0600
From:   "Steven J. Hill" <Steven.Hill@imgtec.com>
To:     linux-mips@linux-mips.org
Cc:     ralf@linux-mips.org, "Steven J. Hill" <Steven.Hill@imgtec.com>
Subject: [PATCH V6 1/3] MIPS: Rearrange PTE bits into fixed positions.
Date:   Thu, 26 Feb 2015 13:01:32 -0600
Message-Id: <1424977294-49507-2-git-send-email-Steven.Hill@imgtec.com>
X-Mailer: git-send-email 1.7.10.4
In-Reply-To: <1424977294-49507-1-git-send-email-Steven.Hill@imgtec.com>
References: <1424977294-49507-1-git-send-email-Steven.Hill@imgtec.com>
Return-Path: <Steven.Hill@imgtec.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 46007
...
-
 ...
 #ifndef __ASSEMBLY__
 /*
@@ -245,7 +268,7 @@ static inline uint64_t pte_to_entrylo(unsigned long pte_val)
