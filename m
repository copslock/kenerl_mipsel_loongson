Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 19 Oct 2008 03:09:10 +0100 (BST)
Received: from sakura.staff.proxad.net ([213.228.1.107]:42964 "EHLO
	sakura.staff.proxad.net") by ftp.linux-mips.org with ESMTP
	id S21816160AbYJSCHG (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Sun, 19 Oct 2008 03:07:06 +0100
Received: by sakura.staff.proxad.net (Postfix, from userid 1000)
	id ED85C1124070; Sun, 19 Oct 2008 04:07:02 +0200 (CEST)
From:	Maxime Bizon <mbizon@freebox.fr>
To:	linux-pcmcia@lists.infradead.org
Cc:	linux-mips@linux-mips.org, Maxime Bizon <mbizon@freebox.fr>
Subject: [PATCH/RFC v1 06/12] [MIPS] BCM63XX: Add PCMCIA & Cardbus support.
Date:	Sun, 19 Oct 2008 04:07:02 +0200
Message-Id: <1224382022-24319-1-git-send-email-mbizon@freebox.fr>
X-Mailer: git-send-email 1.5.4.3
Return-Path: <max@sakura.staff.proxad.net>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 20802
...
index b46c60b..323bdb2 100644
--- a/drivers/pcmcia/Makefile
+++ b/drivers/pcmcia/Makefile
@@ -28,6 +28,7 @@ obj-$(CONFIG_PCMCIA_SA1111)			+= sa11xx_core.o sa1111_cs.o
