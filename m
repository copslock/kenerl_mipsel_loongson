Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 14 Jun 2011 20:42:59 +0200 (CEST)
Received: from mail-ww0-f43.google.com ([74.125.82.43]:40778 "EHLO
        mail-ww0-f43.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491017Ab1FNSmQ (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 14 Jun 2011 20:42:16 +0200
Received: by mail-ww0-f43.google.com with SMTP id 17so5199458wwb.24
        for <linux-mips@linux-mips.org>; Tue, 14 Jun 2011 11:42:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlemail.com; s=gamma;
        h=domainkey-signature:from:to:cc:subject:date:message-id:x-mailer
         :in-reply-to:references;
        bh=HZD6g68Vyp8HZ+39jblQbmEEnP7x0Kc0ekCr9KGthhI=;
        b=baRmxJ3znOrp7UPXOB56w8yZTlAn6ErAAri+gDkG0wbXf5zU7N/GE8lCU4pp62Mi8r
         pNaVf+LsReRcr3mhscMJ9hlTDatV00qo0icaCbCSu/9jMGAWkyI6CKW7fUqohhcAd397
         WDnpTLyZsjItmCp82m6jbtT79ZrGoVD+XhPA0=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=googlemail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=e0KM4tJiLS2qdD5NpYep+QIfnZq3M7qugOUUMs0BQd/Pfr8O9h6dwFcaSy9sdjmIs1
         6Z6jqg/RJhHFUdwhZbM5ZjJfinMnfkRXr1txG7QH1ngNV8jJvzKo7aCi/pzuFifNtTTa
         3Jg/ugKSoMRv3S8IYnRUdy3mYCmeDcNPeNfgo=
Received: by 10.216.232.41 with SMTP id m41mr4676338weq.31.1308076934916;
        Tue, 14 Jun 2011 11:42:14 -0700 (PDT)
Received: from localhost.localdomain (188-22-154-149.adsl.highway.telekom.at [188.22.154.149])
        by mx.google.com with ESMTPS id l5sm3650327weq.9.2011.06.14.11.42.10
        (version=TLSv1/SSLv3 cipher=OTHER);
        Tue, 14 Jun 2011 11:42:12 -0700 (PDT)
From:   Manuel Lauss <manuel.lauss@googlemail.com>
To:     Linux-MIPS <linux-mips@linux-mips.org>
Cc:     Manuel Lauss <manuel.lauss@googlemail.com>
Subject: [PATCH V2 1/2] MIPS: Alchemy: Au1300 SoC support
Date:   Tue, 14 Jun 2011 20:42:02 +0200
Message-Id: <1308076923-13492-3-git-send-email-manuel.lauss@googlemail.com>
...
V2: simplified plat_irq_dispatch which made the assembly significantly smaller.
 ...
 24 files changed, 1530 insertions(+), 42 deletions(-)
...
+	else if (likely(c & CAUSEF_GPIC)) {		/* GPIC */
