Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 21 Nov 2011 13:37:54 +0100 (CET)
Received: from nbd.name ([46.4.11.11]:58345 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1903751Ab1KUMgE (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Mon, 21 Nov 2011 13:36:04 +0100
From:   John Crispin <blogic@openwrt.org>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, John Crispin <blogic@openwrt.org>,
        Thomas Langer <thomas.langer@lantiq.com>
Subject: [PATCH V2 4/6] MIPS: lantiq: add basic support for FALC-ON
Date:   Mon, 21 Nov 2011 14:35:23 +0100
Message-Id: <1321882525-13780-4-git-send-email-blogic@openwrt.org>
...
+	return ltq_32(ltq_ebu_membase + r)
+};
...
+	return ltq_32(ltq_sys1_membase + r)
+};
