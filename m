Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 20 Aug 2017 00:20:01 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:33569 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994951AbdHSWTxlOXZi (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 20 Aug 2017 00:19:53 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id E44B849027;
        Sun, 20 Aug 2017 00:19:46 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by hefe.heinlein-support.de (hefe.heinlein-support.de [91.198.250.172]) (amavisd-new, port 10030)
        with ESMTP id encUyWY3OmMZ; Sun, 20 Aug 2017 00:19:44 +0200 (CEST)
...
Subject: [PATCH v10 00/16] MIPS: lantiq: handle RCU register by separate drivers
Date:   Sun, 20 Aug 2017 00:18:07 +0200
Message-Id: <20170819221823.13850-1-hauke@hauke-m.de>
Return-Path: <hauke@hauke-m.de>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 59699
...
Changelog:
v10:
 * update commit message for "spi: spi-falcon: drop check of boot select"
 * small fixes suggested by Rob.

v9:
 * usb phy: remove ctrl clock, this should be controlled by the USB core,
   not the phy.
 * usb phy: build under COMPILE_TEST
 * usb phy: move code from ltq_rcu_usb2_start_cores() to init() and
   power_on()
 * usb phy: use of_get_address() to get address offset.
 * reset: use of_get_address() to get address offset.
...
Martin Blumenstingl (6):
 ...
 31 files changed, 1197 insertions(+), 608 deletions(-)
