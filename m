Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 27 Aug 2013 20:34:07 +0200 (CEST)
Received: from mms3.broadcom.com ([216.31.210.19]:1357 "EHLO mms3.broadcom.com"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6865284Ab3H0Sdz7IPIQ (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Tue, 27 Aug 2013 20:33:55 +0200
Received: from [10.9.208.57] by mms3.broadcom.com with ESMTP (Broadcom
 SMTP Relay (Email Firewall v6.5)); Tue, 27 Aug 2013 11:23:28 -0700
X-Server-Uuid: B86B6450-0931-4310-942E-F00ED04CA7AF
Received: from IRVEXCHSMTP2.corp.ad.broadcom.com (10.9.207.52) by
 IRVEXCHCAS08.corp.ad.broadcom.com (10.9.208.57) with Microsoft SMTP
 Server (TLS) id 14.1.438.0; Tue, 27 Aug 2013 11:33:23 -0700
Received: from mail-irva-13.broadcom.com (10.10.10.20) by
 IRVEXCHSMTP2.corp.ad.broadcom.com (10.9.207.52) with Microsoft SMTP
 Server id 14.1.438.0; Tue, 27 Aug 2013 11:33:23 -0700
Received: from ltrmn-lnxub75-vm (testboard-syin2.ric.broadcom.com
 ...
 8F63FF2D72; Tue, 27 Aug 2013 11:33:22 -0700 (PDT)
Received: by ltrmn-lnxub75-vm (Postfix, from userid 35077) id
 4DE0E607A8; Tue, 27 Aug 2013 11:32:52 -0700 (PDT)
...
cc:     linux-rpi-kernel@lists.infradead.org,
        ...
        csd@broadcom.com, mmayer@broadcom.com, syin@broadcom.com
Subject: [PATCH v4] pinctrl: Pass all configs to driver on
 pin_config_set()
Date:   Tue, 27 Aug 2013 11:32:12 -0700
Message-ID: <1377628332-12303-1-git-send-email-syin@broadcom.com>
X-Mailer: git-send-email 1.7.9.5
In-Reply-To: <1377134300-25480-1-git-send-email-syin@broadcom.com>
References: <1377134300-25480-1-git-send-email-syin@broadcom.com>
MIME-Version: 1.0
X-WSS-ID: 7E0231042L878642975-19-01
...
index 64ad0c0..6461aef 100644
--- a/drivers/pinctrl/pinctrl-rockchip.c
+++ b/drivers/pinctrl/pinctrl-rockchip.c
@@ -575,32 +575,45 @@ static bool rockchip_pinconf_pull_valid(struct rockchip_pin_ctrl *ctrl,
