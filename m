Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 21 Oct 2015 10:55:04 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.59.15.196]:33426 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27009210AbbJUIy74ithX (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 21 Oct 2015 10:54:59 +0200
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id 322683E9A0FB0
        for <linux-mips@linux-mips.org>; Wed, 21 Oct 2015 09:54:51 +0100 (IST)
Received: from LEMAIL01.le.imgtec.org (192.168.152.62) by
 KLMAIL01.kl.imgtec.org (192.168.5.35) with Microsoft SMTP Server (TLS) id
 14.3.195.1; Wed, 21 Oct 2015 09:54:52 +0100
Received: from mchandras-linux.le.imgtec.org (192.168.154.37) by
 LEMAIL01.le.imgtec.org (192.168.152.62) with Microsoft SMTP Server (TLS) id
 14.3.210.2; Wed, 21 Oct 2015 09:54:51 +0100
From:   Markos Chandras <markos.chandras@imgtec.com>
To:     <linux-mips@linux-mips.org>
CC:     Alex Smith <alex.smith@imgtec.com>,
        Matthew Fortune <matthew.fortune@imgtec.com>,
        Markos Chandras <markos.chandras@imgtec.com>
Subject: [PATCH v3 1/3] MIPS: Initial implementation of a VDSO
Date:   Wed, 21 Oct 2015 09:54:38 +0100
Message-ID: <1445417678-31235-1-git-send-email-markos.chandras@imgtec.com>
X-Mailer: git-send-email 2.6.2
In-Reply-To: <1444377952-21385-1-git-send-email-markos.chandras@imgtec.com>
References: <1444377952-21385-1-git-send-email-markos.chandras@imgtec.com>
MIME-Version: 1.0
...
---
Changes since v2:
- Restrict VDSO support for pre-R6 and binutils < 2.25 because a
suitable relocation is missing and we can't determine the base
of the VDSO during runtime. VDSO will work fine for R6
(because an R6 instruction is used to determine the base address)
or binutils >= 2.25
