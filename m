Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 24 Oct 2017 20:18:00 +0200 (CEST)
Received: from rnd-relay.smtp.broadcom.com ([192.19.229.170]:41157 "EHLO
        rnd-relay.smtp.broadcom.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23990901AbdJXSQvXybgV (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 24 Oct 2017 20:16:51 +0200
Received: from mail-irv-17.broadcom.com (mail-irv-17.lvn.broadcom.net [10.75.224.233])
        by rnd-relay.smtp.broadcom.com (Postfix) with ESMTP id 9A32A30C019;
        Tue, 24 Oct 2017 11:16:47 -0700 (PDT)
Received: from stbsrv-and-3.and.broadcom.com (stbsrv-and-3.and.broadcom.com [10.28.16.21])
        by mail-irv-17.broadcom.com (Postfix) with ESMTP id 05CFE81EB3;
        Tue, 24 Oct 2017 11:16:44 -0700 (PDT)
...
Subject: [PATCH 4/8] PCI: host: brcmstb: add dma-ranges for inbound traffic
Date:   Tue, 24 Oct 2017 14:15:45 -0400
Message-Id: <1508868949-16652-5-git-send-email-jim2101024@gmail.com>
...
+
 ...
 static int num_memc;
@@ -360,26 +364,43 @@ static u64 roundup_pow_of_two_64(u64 n)
...
@@ -652,6 +673,74 @@ static int brcm_parse_ranges(struct brcm_pcie *pcie)
 	return 0;
 }
...
@@ -728,10 +817,34 @@ static void brcm_pcie_setup_prep(struct brcm_pcie *pcie)
 	 */
...
@@ -1020,7 +1133,6 @@ static int brcm_pcie_probe(struct platform_device *pdev)
...
@@ -1039,11 +1151,6 @@ static int brcm_pcie_probe(struct platform_device *pdev)
 		return -EINVAL;
 	}
...
@@ -1117,6 +1224,10 @@ static int brcm_pcie_probe(struct platform_device *pdev)
 	if (ret)
 		return ret;
