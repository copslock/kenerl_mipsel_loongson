Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 09 Jul 2010 17:32:35 +0200 (CEST)
Received: from mailhost.informatik.uni-hamburg.de ([134.100.9.70]:50743 "EHLO
        mailhost.informatik.uni-hamburg.de" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491064Ab0GIPc2 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 9 Jul 2010 17:32:28 +0200
Received: from localhost (localhost [127.0.0.1])
        by mailhost.informatik.uni-hamburg.de (Postfix) with ESMTP id 20EB8DA4;
        Fri,  9 Jul 2010 17:32:21 +0200 (CEST)
X-Virus-Scanned: amavisd-new at informatik.uni-hamburg.de
Received: from mailhost.informatik.uni-hamburg.de ([127.0.0.1])
        by localhost (mailhost.informatik.uni-hamburg.de [127.0.0.1]) (amavisd-new, port 10024)
        with LMTP id XsKC3DNf0j+T; Fri,  9 Jul 2010 17:32:20 +0200 (CEST)
Received: from [192.168.37.30] (port-8961.pppoe.wtnet.de [84.46.35.36])
        (using TLSv1 with cipher DHE-RSA-AES256-SHA (256/256 bits))
        (Client did not present a certificate)
        (Authenticated sender: 7clausen)
        by mailhost.informatik.uni-hamburg.de (Postfix) with ESMTPSA id 1A155D9C;
        Fri,  9 Jul 2010 17:32:05 +0200 (CEST)
Message-ID: <4C3740E5.5080200@metafoo.de>
Date:   Fri, 09 Jul 2010 17:31:49 +0200
...
References: <1276924111-11158-1-git-send-email-lars@metafoo.de>        <1276924111-11158-17-git-send-email-lars@metafoo.de>        <4C310ACD.6040604@metafoo.de> <AANLkTikwGwXeCpwL8KfLVB3b9IoWoUJwaTStTwr8iR8z@mail.gmail.com>
In-Reply-To: <AANLkTikwGwXeCpwL8KfLVB3b9IoWoUJwaTStTwr8iR8z@mail.gmail.com>
