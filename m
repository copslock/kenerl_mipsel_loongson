Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 17 Aug 2018 18:14:26 +0200 (CEST)
Received: from mail.bootlin.com ([62.4.15.54]:54489 "EHLO mail.bootlin.com"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994683AbeHQQJwwXHnq (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 17 Aug 2018 18:09:52 +0200
Received: by mail.bootlin.com (Postfix, from userid 110)
        id AAFB0215DE; Fri, 17 Aug 2018 18:09:45 +0200 (CEST)
Received: from localhost.localdomain (91-160-177-164.subs.proxad.net [91.160.177.164])
        by mail.bootlin.com (Postfix) with ESMTPSA id 6691C20F77;
        Fri, 17 Aug 2018 18:09:44 +0200 (CEST)
...
Subject: [PATCH 17/23] mtd: rawnand: Pass a nand_chip object to chip->waitfunc()
Date:   Fri, 17 Aug 2018 18:09:16 +0200
Message-Id: <20180817160922.6224-18-boris.brezillon@bootlin.com>
...
index 4bcdefb73659..f964914cbcf0 100644
...
index 612b3072b0f1..87ca07c8a1b6 100644
--- a/drivers/mtd/nand/raw/denali.c
+++ b/drivers/mtd/nand/raw/denali.c
@@ -911,9 +911,9 @@ static void denali_select_chip(struct nand_chip *chip, int cs)
...
index c76d765bb1aa..1a39e9701191 100644
...
index 26f06d0594e6..bdbc5bdb1289 100644
--- a/drivers/mtd/nand/raw/fsl_ifc_nand.c
+++ b/drivers/mtd/nand/raw/fsl_ifc_nand.c
@@ -613,8 +613,9 @@ static void fsl_ifc_read_buf(struct nand_chip *chip, u8 *buf, int len)
  * This function is called after Program and Erase Operations to
  * check for success or failure.
  */
...
index 2a74de9012c4..520c0932d15a 100644
