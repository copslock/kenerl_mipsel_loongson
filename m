Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 12 Dec 2014 23:15:31 +0100 (CET)
Received: from resqmta-po-07v.sys.comcast.net ([96.114.154.166]:57495 "EHLO
        resqmta-po-07v.sys.comcast.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27008621AbaLLWOKt40Cb (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 12 Dec 2014 23:14:10 +0100
Received: from resomta-po-15v.sys.comcast.net ([96.114.154.239])
        by resqmta-po-07v.sys.comcast.net with comcast
        id SmDp1p0085AAYLo01mE4uo; Fri, 12 Dec 2014 22:14:04 +0000
Received: from [192.168.1.13] ([76.100.35.31])
        by resomta-po-15v.sys.comcast.net with comcast
        id SmE31p00B0gJalY01mE3Nr; Fri, 12 Dec 2014 22:14:04 +0000
Message-ID: <548B689A.1010007@gentoo.org>
Date:   Fri, 12 Dec 2014 17:13:46 -0500
...
Subject: [PATCH 02/02 resend] MIPS: IP32: Add platform data hooks to use DS1685
 driver
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: 7bit
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=comcast.net;
        s=q20140121; t=1418422444;
        bh=l9enFU5Lu154HbLueyoPUMHT/uJMNbfM0qVXew7m7Sk=;
        h=Received:Received:Message-ID:Date:From:MIME-Version:To:Subject:
         Content-Type;
        b=
Return-Path: <kumba@gentoo.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 44663
