Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 24 Jun 2014 19:32:52 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.59.15.196]:64579 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S6862378AbaFXRbgsbhjE (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 24 Jun 2014 19:31:36 +0200
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id 0F62E10DA0D3;
        Tue, 24 Jun 2014 18:31:26 +0100 (IST)
...
Received: from BAMAIL02.ba.imgtec.org (192.168.66.28) by
 ...
 14.3.181.6; Tue, 24 Jun 2014 18:31:27 +0100
...
Subject: [PATCH v3 2/9] MIPS: KVM: Use KVM internal logger
Date:   Tue, 24 Jun 2014 10:31:03 -0700
Message-ID: <1403631071-6012-3-git-send-email-dengcheng.zhu@imgtec.com>
...
+			cause, opc, badvaddr);
 		...
 		kvm_arch_vcpu_dump_regs(vcpu);
 		run->exit_reason = KVM_EXIT_INTERNAL_ERROR;
@@ -207,9 +205,8 @@ static int kvm_trap_emul_handle_tlb_ld_miss(struct kvm_vcpu *vcpu)
 			ret = RESUME_HOST;
 		}
 	} else {
-		printk
...
+			cause, opc, badvaddr);
 		...
 		kvm_arch_vcpu_dump_regs(vcpu);
 		run->exit_reason = KVM_EXIT_INTERNAL_ERROR;
@@ -232,7 +229,7 @@ static int kvm_trap_emul_handle_addr_err_st(struct kvm_vcpu *vcpu)
...
@@ -240,9 +237,8 @@ static int kvm_trap_emul_handle_addr_err_st(struct kvm_vcpu *vcpu)
 			ret = RESUME_HOST;
 		}
 	} else {
-		printk
...
@@ -262,7 +258,7 @@ static int kvm_trap_emul_handle_addr_err_ld(struct kvm_vcpu *vcpu)
...
@@ -270,9 +266,8 @@ static int kvm_trap_emul_handle_addr_err_ld(struct kvm_vcpu *vcpu)
 			ret = RESUME_HOST;
 		}
 	} else {
-		printk
