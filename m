Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 02 Sep 2016 22:46:12 +0200 (CEST)
Received: from emh02.mail.saunalahti.fi ([62.142.5.108]:52233 "EHLO
        emh02.mail.saunalahti.fi" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23992111AbcIBUogW4myg (ORCPT
...
Received: from localhost.localdomain (85-76-72-196-nat.elisa-mobile.fi [85.76.72.196])
        by emh02.mail.saunalahti.fi (Postfix) with ESMTP id 98C9B23419B;
...
Subject: [PATCH v2 4/6] MIPS: OCTEON: delete cvmx_helper_board_link_set_phy
Date:   Fri,  2 Sep 2016 23:44:19 +0300
Message-Id: <20160902204421.8265-5-aaro.koskinen@iki.fi>
