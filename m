Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 15 Aug 2013 11:20:55 +0200 (CEST)
Received: from nbd.name ([46.4.11.11]:56416 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6865280Ab3HOJUaWv7yw (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 15 Aug 2013 11:20:30 +0200
Received: by nf.lan (Postfix, from userid 501)
        id 9EB1E4FF3E0F; Thu, 15 Aug 2013 11:20:27 +0200 (CEST)
From:   Felix Fietkau <nbd@openwrt.org>
To:     linux-mips@linux-mips.org
Subject: [PATCH v2 1/3] MIPS: remove unnecessary platform dma helper functions
Date:   Thu, 15 Aug 2013 11:20:25 +0200
Message-Id: <1376558427-26033-1-git-send-email-nbd@openwrt.org>
X-Mailer: git-send-email 1.8.0.2
Return-Path: <nbd@nbd.name>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 37554
