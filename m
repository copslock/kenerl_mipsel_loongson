Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 20 Oct 2008 13:26:58 +0100 (BST)
Received: from mba.ocn.ne.jp ([122.1.235.107]:9460 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S21913802AbYJTM0z (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Mon, 20 Oct 2008 13:26:55 +0100
Received: from localhost (p1245-ipad307funabasi.chiba.ocn.ne.jp [123.217.179.245])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 25CDEAA70; Mon, 20 Oct 2008 21:26:48 +0900 (JST)
Date:	Mon, 20 Oct 2008 21:27:01 +0900 (JST)
Message-Id: <20081020.212701.59651580.anemo@mba.ocn.ne.jp>
To:	linux-mips@linux-mips.org
Cc:	linux-ide@vger.kernel.org,
	Bartlomiej Zolnierkiewicz <bzolnier@gmail.com>,
	ralf@linux-mips.org, sshtylyov@ru.mvista.com
Subject: [PATCH] ide: Add tx4939ide driver (v5)
...
Changes since v4:
* do not select IDE_TIMINGS
* remove unneeded BUG_ON
* use ATA_DMA_XXX symbols
* refactor tx4939ide_tf_load and tx4939ide_tf_load_fixup
* call devm_request_mem_region
* some whitespace and spelling fixes

 drivers/ide/Kconfig          |    5 +
 drivers/ide/mips/Makefile    |    1 +
 drivers/ide/mips/tx4939ide.c |  756 ++++++++++++++++++++++++++++++++++++++++++
 3 files changed, 762 insertions(+), 0 deletions(-)
 create mode 100644 drivers/ide/mips/tx4939ide.c

diff --git a/drivers/ide/Kconfig b/drivers/ide/Kconfig
index 74a369a..1f0eeba 100644
