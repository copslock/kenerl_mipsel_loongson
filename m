Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 20 Aug 2017 00:26:10 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:37944 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994951AbdHSWUSLH8Yi (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 20 Aug 2017 00:20:18 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id 3A65742954;
        Sun, 20 Aug 2017 00:20:12 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter02.heinlein-hosting.de (spamfilter02.heinlein-hosting.de [80.241.56.116]) (amavisd-new, port 10030)
        with ESMTP id yCnQX3FHeybD; Sun, 20 Aug 2017 00:20:10 +0200 (CEST)
...
Subject: [PATCH v10 12/16] MIPS: lantiq: Add a GPHY driver which uses the RCU syscon-mfd
Date:   Sun, 20 Aug 2017 00:18:19 +0200
Message-Id: <20170819221823.13850-13-hauke@hauke-m.de>
