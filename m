Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 24 Jul 2010 03:45:44 +0200 (CEST)
Received: from sj-iport-5.cisco.com ([171.68.10.87]:34450 "EHLO
        sj-iport-5.cisco.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1492627Ab0GXBnX (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sat, 24 Jul 2010 03:43:23 +0200
Authentication-Results: sj-iport-5.cisco.com; dkim=neutral (message not signed) header.i=none
X-IronPort-AV: E=Sophos;i="4.55,251,1278288000"; 
   d="scan'208";a="230180367"
Received: from sj-core-5.cisco.com ([171.71.177.238])
  by sj-iport-5.cisco.com with ESMTP; 24 Jul 2010 01:43:14 +0000
Received: from localhost (dhcp-171-71-47-67.cisco.com [171.71.47.67])
        by sj-core-5.cisco.com (8.13.8/8.14.3) with ESMTP id o6O1hF8M012872;
        Sat, 24 Jul 2010 01:43:15 GMT
Date:   Fri, 23 Jul 2010 21:43:14 -0400
From:   Dezhong Diao <dediao@cisco.com>
To:     linux-mips@linux-mips.org
Cc:     ralf@linux-mips.org, dvomlehn@cisco.com
Subject: [PATCH] MIPS: Apply kmap_high_get on DMA functions.
Message-ID: <20100724014314.GA29846@dediao-lnx2.corp.sa.net>
...
The changes mentioned in the link below are intended to apply on MIPS dma functions.

http://lkml.org/lkml/2009/3/7/137



Kevin Cernekee had a comment for my previous patch:
...
When addr == 0, no flush is performed and that results in serious coherency problems on my system.

The latest ARM code has a special "VIPT" handler for this case; I suspect that MIPS needs something similar:
