Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 20 Apr 2009 19:57:26 +0100 (BST)
Received: from mail-fx0-f175.google.com ([209.85.220.175]:51369 "EHLO
	...
	id S20031410AbZDTS5U (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Mon, 20 Apr 2009 19:57:20 +0100
Received: by fxm23 with SMTP id 23so2289643fxm.0
        for <linux-mips@linux-mips.org>; Mon, 20 Apr 2009 11:57:13 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlemail.com; s=gamma;
        h=domainkey-signature:received:received:sender:from:to:cc:subject
         :date:message-id:x-mailer;
        bh=+TwZrVS8r6Mjui+vB22x9BaFj9UGTI/+9wdec6X25/o=;
        b=nJ485eM4TjgrBC9DL3nS0ZAHV3TS8dMME+JN0dpBo9f6I0apRJFEexIZHhzj3Low2h
         4lqLBgZpcL3/spFrttmXqpCSuwwTsuSXsWr0XXdyeEBdZ4j0BG3e+MQnsT52bRqItE22
         ZyktwMZEIqEpLE+1VHKhQylWfGQ/k8uBwj1pk=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=googlemail.com; s=gamma;
        h=sender:from:to:cc:subject:date:message-id:x-mailer;
        b=pGH4bXL+FBMWJy5DVyAtRuJ29QG1lt4/w7jES+uOXFOlobJlZs7d2c7jqzwOOpZp3e
         Qyfykg1pc6kOwlkxQDMjlg+5gb9ZVfUHWsOZhYdms2JaW+kVGtROolYUaALX7GYnMYgL
         GNiBexpv8LjhS36SE52JwFPUk6yayc0eKjKi0=
Received: by 10.103.221.5 with SMTP id y5mr3282226muq.66.1240253833084;
        Mon, 20 Apr 2009 11:57:13 -0700 (PDT)
Received: from localhost.localdomain (p5496DEF2.dip.t-dialin.net [84.150.222.242])
        by mx.google.com with ESMTPS id n7sm14669850mue.6.2009.04.20.11.57.00
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Mon, 20 Apr 2009 11:57:10 -0700 (PDT)
From:	Manuel Lauss <mano@roarinelk.homelinux.net>
To:	Linux-MIPS <linux-mips@linux-mips.org>
Cc:	Manuel Lauss <mano@roarinelk.homelinux.net>,
	Florian Fainelli <florian@openwrt.org>
Subject: [PATCH v5 1/2] Alchemy: rewrite GPIO support.
Date:	Mon, 20 Apr 2009 20:56:46 +0200
Message-Id: <1240253807-29778-1-git-send-email-mano@roarinelk.homelinux.net>
X-Mailer: git-send-email 1.6.2.3
Return-Path: <manuel.lauss@googlemail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 22388
...
To complete GPIO2 support, macros for GPIO2 shared interrupt management
and GPIO2 block control are also introduced.
...
v2: added gpio_to_irq and irq_to_gpio, some renaming.
 ...
 arch/mips/include/asm/mach-au1x00/gpio.h |  569 ++++++++++++++++++++++++++++--
 4 files changed, 615 insertions(+), 146 deletions(-)
