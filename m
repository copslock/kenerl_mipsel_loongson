Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 29 Aug 2013 18:23:15 +0200 (CEST)
Received: from mail-ob0-f178.google.com ([209.85.214.178]:62280 "EHLO
        mail-ob0-f178.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6823099Ab3H2QXKOcAtS (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 29 Aug 2013 18:23:10 +0200
Received: by mail-ob0-f178.google.com with SMTP id ef5so721596obb.9
        for <multiple recipients>; Thu, 29 Aug 2013 09:23:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=message-id:date:from:user-agent:mime-version:to:cc:subject
         :references:in-reply-to:content-type:content-transfer-encoding;
        bh=h1WG9COJ15LV1N91xXIvbqfWQwCXBywtyyVq6/N08Bw=;
        b=
X-Received: by 10.182.158.104 with SMTP id wt8mr3033742obb.95.1377793383652;
        Thu, 29 Aug 2013 09:23:03 -0700 (PDT)
Received: from dl.caveonetworks.com (64.2.3.195.ptr.us.xo.net. [64.2.3.195])
        by mx.google.com with ESMTPSA id y1sm33165697oek.4.1969.12.31.16.00.00
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Thu, 29 Aug 2013 09:23:02 -0700 (PDT)
Message-ID: <521F7565.9000708@gmail.com>
Date:   Thu, 29 Aug 2013 09:23:01 -0700
From:   David Daney <ddaney.cavm@gmail.com>
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:17.0) Gecko/20130625 Thunderbird/17.0.7
MIME-Version: 1.0
To:     "Steven J. Hill" <Steven.Hill@imgtec.com>
CC:     linux-mips@linux-mips.org, ralf@linux-mips.org
Subject: Re: [PATCH v2] MIPS: Allow ASID size to be determined at boot time.
References: <1377785632-13113-1-git-send-email-Steven.Hill@imgtec.com>
In-Reply-To: <1377785632-13113-1-git-send-email-Steven.Hill@imgtec.com>
...
On 08/29/2013 07:13 AM, Steven J. Hill wrote:
...
What are the advantages of this patch over something like:

unsigned long ASID_INC __read_mostly;
unsigned long ASID_MASK __read_mostly;
unsigned long ASID_FIRST_VERSION __read_mostly;
.
.
.

void setup_asid(void)
{
  /* Assign system specific values for ASID parameters, all written in C */
}

Unless you can document real performance bottlenecks with doing 
everything in C, this whole thing looks like an unnecessary Rube 
Goldberg Apparatus.
