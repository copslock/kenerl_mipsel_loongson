Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 20 May 2009 23:07:11 +0100 (BST)
Received: from mail-pz0-f202.google.com ([209.85.222.202]:46456 "EHLO
	mail-pz0-f202.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S20025182AbZETWGm (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Wed, 20 May 2009 23:06:42 +0100
Received: by pzk40 with SMTP id 40so630212pzk.22
        for <multiple recipients>; Wed, 20 May 2009 15:06:35 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=bjDB752AwcG6xnOtXEJnTjqymky0j2W1+iLKluRRvKc=;
        b=aPTCmaK0Su8u6oVD7PJmBcKRN3+4US2KGC13JrHQX/zLyM6dJVMgnB+6sP6yG42eGf
         yA3LBfhlSvYR1Nr7J0TRGEPXBWOFuJ5QRpN73UDNgNYn5SaXv8f4u+5T3/vV0TGvOQG+
         vhAQGVanZRJ9Agr78aBg3Hg8NfzKjws2PUNIs=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=ObGzRi3mADttVCSCp6qJFSdpcqS/x06RpmlC5nBuiLOEHEQSMG3WzOkp4EyETIXTrq
         B1hBKbOjPtU12Jpzf27enYJZQiJ+dSoxxqvcWZdGq7AyAfmBwoRk6kJeKl3EaBBelgHB
         CyCM36xHr+TijViCdUJF7JoxdipIU27eaMIqU=
Received: by 10.142.226.7 with SMTP id y7mr500035wfg.79.1242857194871;
        Wed, 20 May 2009 15:06:34 -0700 (PDT)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id 29sm4296637wfg.28.2009.05.20.15.06.26
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Wed, 20 May 2009 15:06:33 -0700 (PDT)
...
Subject: [loongson-PATCH-v1 13/27] add basic fuloong(2f) support
Date:	Thu, 21 May 2009 06:06:20 +0800
Message-Id: <1cb69445cfff01ccc805487692bf63d98fd045fa.1242855716.git.wuzhangjin@gmail.com>
...
---
 ...
 27 files changed, 3148 insertions(+), 162 deletions(-)
...
@@ -310,6 +310,7 @@ core-$(CONFIG_LOONGSON_SYSTEMS) +=arch/mips/loongson/
...
+		break;
+	case PCI_INTERRUPT_LINE:
+		conf_data = CFG_PCI_INTERRUPT_LINE(PCI_DEFAULT_PIN, CS5536_FLASH_INTR);
+		break;
+	case PCI_NAND_FLASH_TDATA_REG:
...
+		break;
+	case PCI_INTERRUPT_LINE:
+		conf_data = CFG_PCI_INTERRUPT_LINE(PCI_DEFAULT_PIN, CS5536_IDE_INTR);
+		break;
+	case PCI_IDE_CFG_REG:
