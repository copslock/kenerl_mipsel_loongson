Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 03 Aug 2017 01:02:34 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:56733 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994857AbdHBW7HPYoEW (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 3 Aug 2017 00:59:07 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id B34EA4614C;
        Thu,  3 Aug 2017 00:59:01 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by gerste.heinlein-support.de (gerste.heinlein-support.de [91.198.250.173]) (amavisd-new, port 10030)
        with ESMTP id veVCpOZYpJJx; Thu,  3 Aug 2017 00:58:58 +0200 (CEST)
...
Subject: [PATCH v8 08/16] MIPS: lantiq: Convert the fpi bus driver to a platform_driver
Date:   Thu,  3 Aug 2017 00:57:09 +0200
Message-Id: <20170802225717.24408-9-hauke@hauke-m.de>
