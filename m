Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 19 Feb 2015 17:20:14 +0100 (CET)
Received: from mailapp01.imgtec.com ([195.59.15.196]:38112 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27013238AbbBSQTS5HWQY (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 19 Feb 2015 17:19:18 +0100
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id 52FB72E0D1FE7
        for <linux-mips@linux-mips.org>; Thu, 19 Feb 2015 16:19:09 +0000 (GMT)
...
Subject: [PATCH V4 4/5] MIPS: Add support for XPA.
Date:   Thu, 19 Feb 2015 10:18:53 -0600
Message-ID: <1424362734-30364-5-git-send-email-Steven.Hill@imgtec.com>
...
@@ -1597,6 +1599,33 @@ config CPU_MIPS32_3_5_EVA
...
+
 ...
 config CPU_NOP_WORKAROUNDS
 	bool
@@ -1703,6 +1732,9 @@ config SYS_HAS_CPU_MIPS32_R3_5
...
@@ -1837,6 +1869,9 @@ config CPU_MIPSR6
 config EVA
 	bool
...
@@ -162,8 +160,8 @@ static inline void pte_clear(struct mm_struct *mm, unsigned long addr, pte_t *pt
...
+		null.pte_high = _PAGE_GLOBAL;
 	...
 	htw_start();
@@ -245,21 +243,21 @@ static inline int pte_file(pte_t pte)	{ return pte.pte_low & _PAGE_FILE; }
...
@@ -267,30 +265,24 @@ static inline pte_t pte_mkold(pte_t pte)
...
-	}
 ...
 #else
@@ -395,10 +387,10 @@ static inline pgprot_t pgprot_writecombine(pgprot_t _prot)
 #if defined(CONFIG_PHYS_ADDR_T_64BIT) && defined(CONFIG_CPU_MIPS32)
...
@@ -2298,6 +2339,26 @@ static void config_htw_params(void)
 	print_htw_config();
 }
...
+
 ...
 {
 	/*
@@ -2362,8 +2423,9 @@ void build_tlb_refill_handler(void)
 		}
