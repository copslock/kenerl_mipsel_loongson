Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 23 Mar 2007 16:10:11 +0000 (GMT)
Received: from smtp110.sbc.mail.mud.yahoo.com ([68.142.198.209]:30550 "HELO
	smtp110.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S20022388AbXCWQJl (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 23 Mar 2007 16:09:41 +0000
Received: (qmail 38566 invoked from network); 23 Mar 2007 16:08:34 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@75.61.93.28 with login)
  by smtp110.sbc.mail.mud.yahoo.com with SMTP; 23 Mar 2007 16:08:33 -0000
X-YMail-OSG: lUDWMaYVM1nebagSC9nb32xkYxg5m4RcHM600EO55Q3roGf4PI2TtjArFh7T0oZNpnnLYJ9DlrqsmLCCWdBjEFBNsxHCzbXyiG50GBDfwuQFbsKSck6ZLa2wIIXxNNP2JpdtRocjym0kE8E-
Received: by lucon.org (Postfix, from userid 500)
	id 1DD6646EEB1; Fri, 23 Mar 2007 09:08:32 -0700 (PDT)
Date:	Fri, 23 Mar 2007 09:08:32 -0700
...
Subject: The Linux binutils 2.17.50.0.14 is released
Message-ID: <20070323160832.GA1229@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.14 to hjl@lucon.org
...
1. binutils-2.17.50.0.14.tar.bz2. Source code.
2. binutils-2.17.50.0.13-2.17.50.0.14.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.14-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.14-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.14-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.14.tar.bz2
