Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 29 Apr 2014 17:58:37 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.89.28.114]:38252 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S6843039AbaD2P6a0SwM7 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 29 Apr 2014 17:58:30 +0200
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id D75317F478EF4;
        Tue, 29 Apr 2014 16:58:18 +0100 (IST)
Received: from KLMAIL02.kl.imgtec.org (192.168.5.97) by KLMAIL01.kl.imgtec.org
 (192.168.5.35) with Microsoft SMTP Server (TLS) id 14.3.181.6; Tue, 29 Apr
 2014 16:58:22 +0100
Received: from LEMAIL01.le.imgtec.org (192.168.152.62) by
 klmail02.kl.imgtec.org (192.168.5.97) with Microsoft SMTP Server (TLS) id
 14.3.181.6; Tue, 29 Apr 2014 16:58:22 +0100
Received: from mchandras-linux.le.imgtec.org (192.168.154.57) by
 LEMAIL01.le.imgtec.org (192.168.152.62) with Microsoft SMTP Server (TLS) id
 14.3.174.1; Tue, 29 Apr 2014 16:58:21 +0100
From:   Markos Chandras <markos.chandras@imgtec.com>
To:     <linux-mips@linux-mips.org>
CC:     Markos Chandras <markos.chandras@imgtec.com>,
        "David S. Miller" <davem@davemloft.net>, <netdev@vger.kernel.org>
Subject: [PATCH v4 13/14] MIPS: net: Add BPF JIT
Date:   Tue, 29 Apr 2014 16:58:17 +0100
Message-ID: <1398787097-3622-1-git-send-email-markos.chandras@imgtec.com>
X-Mailer: git-send-email 1.9.2
In-Reply-To: <1398351013-29490-1-git-send-email-markos.chandras@imgtec.com>
References: <1398351013-29490-1-git-send-email-markos.chandras@imgtec.com>
MIME-Version: 1.0
...
---
Changes since v3:
- Replace cpu_has_mips_r1 with !cpu_has_mips_r2 to avoid taking the slow path
even on MIPS R2 processors
---
 arch/mips/Kbuild        |    1 +
