Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 26 May 2006 21:25:38 +0200 (CEST)
Received: from smtp106.sbc.mail.mud.yahoo.com ([68.142.198.205]:44694 "HELO
	smtp106.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S8133833AbWEZTZ0 (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 26 May 2006 21:25:26 +0200
Received: (qmail 69555 invoked from network); 26 May 2006 19:25:19 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@71.146.96.173 with login)
  by smtp106.sbc.mail.mud.yahoo.com with SMTP; 26 May 2006 19:25:18 -0000
Received: by lucon.org (Postfix, from userid 1000)
	id 478A5641B3; Fri, 26 May 2006 12:25:17 -0700 (PDT)
Date:	Fri, 26 May 2006 12:25:17 -0700
...
Subject: The Linux binutils 2.17.50.0.2 is released
Message-ID: <20060526192517.GA24173@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.2 to hjl@lucon.org
...
1. binutils-2.17.50.0.2.tar.bz2. Source code.
2. binutils-2.17.50.0.1-2.17.50.0.2.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.2-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.2-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.2-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.2.tar.bz2
