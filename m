Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 21 Nov 2011 13:36:10 +0100 (CET)
Received: from nbd.name ([46.4.11.11]:58333 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1903745Ab1KUMgB (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Mon, 21 Nov 2011 13:36:01 +0100
From:   John Crispin <blogic@openwrt.org>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, John Crispin <blogic@openwrt.org>
Subject: [PATCH V2 1/6] MIPS: lantiq: reorganize xway code
Date:   Mon, 21 Nov 2011 14:35:20 +0100
Message-Id: <1321882525-13780-1-git-send-email-blogic@openwrt.org>
X-Mailer: git-send-email 1.7.7.1
X-archive-position: 31858
...
Changes in V2:
* remove trailing \n in panic calls
* use inlines rather that function type defines
 ...
 arch/mips/lantiq/xway/reset.c                      |   23 ++----
 ...
 19 files changed, 221 insertions(+), 297 deletions(-)
...
@@ -220,19 +218,10 @@ ltq_dma_init(void)
 {
 	int i;
...
@@ -67,19 +65,10 @@ static void ltq_machine_power_off(void)
