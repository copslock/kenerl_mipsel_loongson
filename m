Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 24 Feb 2016 15:37:37 +0100 (CET)
Received: from smtpbgsg2.qq.com ([54.254.200.128]:52072 "EHLO smtpbgsg2.qq.com"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S27013921AbcBXOhfhnGk6 (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 24 Feb 2016 15:37:35 +0100
X-QQ-mid: bizesmtp8t1456324610t680t180
Received: from software.domain.org (unknown [222.92.8.142])
        by esmtp4.qq.com (ESMTP) with 
        id ; Wed, 24 Feb 2016 22:35:45 +0800 (CST)
X-QQ-SSF: 01100000002000F0FK70B00A0000000
X-QQ-FEAT: 
X-QQ-GoodBg: 0
...
Subject: [PATCH V3 3/5] MIPS: Loongson-3: Fast TLB refill handler
Date:   Wed, 24 Feb 2016 22:33:02 +0800
Message-Id: <1456324384-18118-6-git-send-email-chenhc@lemote.com>
...
index 858d036..0d9bf6c 100644
--- a/arch/mips/include/asm/cpu.h
+++ b/arch/mips/include/asm/cpu.h
@@ -393,6 +393,7 @@ enum cpu_type_enum {
...
+#define MIPS_CPU_LDPTE		0x200000000000ull /* CPU has ldpte/lddir instructions */
...
index 1e95151..da68ffb 100644
--- a/arch/mips/mm/tlbex.c
+++ b/arch/mips/mm/tlbex.c
@@ -290,7 +290,12 @@ static inline void dump_handler(const char *symbol, const u32 *handler, int coun
...
@@ -830,7 +835,10 @@ build_get_pmde64(u32 **p, struct uasm_label **l, struct uasm_reloc **r,
...
+			UASM_i_MFC0(p, ptr, c0_kscratch(), pgd_reg);
 		...
 		/*
@@ -1443,6 +1451,108 @@ static void build_r4000_tlb_refill_handler(void)
...
@@ -1490,7 +1600,10 @@ static void build_setup_pgd(void)
 	} else {
 		/* PGD in c0_KScratch */
 		uasm_i_jr(&p, 31);
...
+			UASM_i_MTC0(&p, a0, c0_kscratch(), pgd_reg);
 ...
 #else
 #ifdef CONFIG_SMP
@@ -2466,13 +2579,18 @@ void build_tlb_refill_handler(void)
 		break;
