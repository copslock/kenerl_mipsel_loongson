Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 03 Apr 2015 13:40:43 +0200 (CEST)
Received: from ip4-83-240-67-251.cust.nbox.cz ([83.240.67.251]:54024 "EHLO
        ip4-83-240-18-248.cust.nbox.cz" rhost-flags-OK-OK-OK-FAIL)
        by eddie.linux-mips.org with ESMTP id S27009692AbbDCLklsDqYI (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 3 Apr 2015 13:40:41 +0200
Received: from ku by ip4-83-240-18-248.cust.nbox.cz with local (Exim 4.85)
        (envelope-from <jslaby@suse.cz>)
        id 1Ydzxg-00011e-F8; Fri, 03 Apr 2015 13:40:32 +0200
...
Subject: [patch added to the 3.12 stable tree] MIPS: asm/reg.h: Make 32- and 64-bit definitions available at the same time
Date:   Fri,  3 Apr 2015 13:40:28 +0200
Message-Id: <1428061232-3877-6-git-send-email-jslaby@suse.cz>
X-Mailer: git-send-email 2.3.4
In-Reply-To: <1428061232-3877-1-git-send-email-jslaby@suse.cz>
References: <1428061232-3877-1-git-send-email-jslaby@suse.cz>
Return-Path: <jslaby@suse.cz>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 46714
