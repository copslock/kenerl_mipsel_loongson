Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 27 Sep 2013 14:42:11 +0200 (CEST)
Received: from nbd.name ([46.4.11.11]:34023 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6817505Ab3I0Mlr6zf3h (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 27 Sep 2013 14:41:47 +0200
Received: by nf.lan (Postfix, from userid 501)
        id C94B754E2D97; Fri, 27 Sep 2013 14:41:45 +0200 (CEST)
From:   Felix Fietkau <nbd@openwrt.org>
To:     linux-mips@linux-mips.org
Subject: [PATCH v2 2/2] MIPS: partially inline dma ops
Date:   Fri, 27 Sep 2013 14:41:45 +0200
Message-Id: <1380285705-58915-2-git-send-email-nbd@openwrt.org>
X-Mailer: git-send-email 1.8.0.2
In-Reply-To: <1380285705-58915-1-git-send-email-nbd@openwrt.org>
References: <1380285705-58915-1-git-send-email-nbd@openwrt.org>
Return-Path: <nbd@nbd.name>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 38005
...
---
 arch/mips/Kconfig                   |   4 +
 arch/mips/include/asm/dma-mapping.h | 362 +++++++++++++++++++++++++++++++++++-
 arch/mips/mm/dma-default.c          | 163 ++--------------
 3 files changed, 375 insertions(+), 154 deletions(-)

diff --git a/arch/mips/Kconfig b/arch/mips/Kconfig
index 0e08fdd..50f769a 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -1376,6 +1376,7 @@ config CPU_CAVIUM_OCTEON
 	select LIBFDT
 	select USE_OF
...
@@ -1598,6 +1599,9 @@ config SYS_HAS_CPU_XLR
...
@@ -30,12 +73,312 @@ static inline bool dma_capable(struct device *dev, dma_addr_t addr, size_t size)
...
@@ -43,7 +386,9 @@ static inline int dma_mapping_error(struct device *dev, u64 mask)
 	struct dma_map_ops *ops = get_dma_ops(dev);
...
+	return 0;
 ...
 static inline int
@@ -69,7 +414,11 @@ static inline void *dma_alloc_attrs(struct device *dev, size_t size,
 	void *ret;
 	struct dma_map_ops *ops = get_dma_ops(dev);
...
@@ -84,7 +433,10 @@ static inline void dma_free_attrs(struct device *dev, size_t size,
 {
 	struct dma_map_ops *ops = get_dma_ops(dev);
...
@@ -45,30 +45,6 @@ static int __init setnocoherentio(char *str)
...
-
 ...
 {
 	gfp_t dma_flag;
@@ -124,8 +100,9 @@ void *dma_alloc_noncoherent(struct device *dev, size_t size,
 }
...
@@ -149,6 +126,7 @@ static void *mips_dma_alloc_coherent(struct device *dev, size_t size,
...
@@ -159,8 +137,8 @@ void dma_free_noncoherent(struct device *dev, size_t size, void *vaddr,
 }
...
@@ -175,6 +153,7 @@ static void mips_dma_free_coherent(struct device *dev, size_t size, void *vaddr,
...
+EXPORT_SYMBOL(mips_dma_free_coherent);
 ...
 static inline void __dma_sync_virtual(void *addr, size_t size,
 	enum dma_data_direction direction)
@@ -203,8 +182,8 @@ static inline void __dma_sync_virtual(void *addr, size_t size,
...
@@ -233,108 +212,7 @@ static inline void __dma_sync(struct page *page,
 		left -= len;
 	} while (left);
 }
-
...
+EXPORT_SYMBOL(__dma_sync);
 ...
 void dma_cache_sync(struct device *dev, void *vaddr, size_t size,
 			 enum dma_data_direction direction)
@@ -347,23 +225,10 @@ void dma_cache_sync(struct device *dev, void *vaddr, size_t size,
