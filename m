Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 17 Dec 2015 01:42:09 +0100 (CET)
Received: from youngberry.canonical.com ([91.189.89.112]:35918 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27014080AbbLQAlFGAkvE (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 17 Dec 2015 01:41:05 +0100
Received: from 1.general.kamal.us.vpn ([10.172.68.52] helo=fourier)
        by youngberry.canonical.com with esmtpsa (TLS1.0:DHE_RSA_AES_128_CBC_SHA1:16)
        (Exim 4.76)
        (envelope-from <kamal@canonical.com>)
        id 1a9McS-0006ma-4G; Thu, 17 Dec 2015 00:40:32 +0000
Received: from kamal by fourier with local (Exim 4.82)
        (envelope-from <kamal@whence.com>)
        id 1a9McP-0001Ju-Nb; Wed, 16 Dec 2015 16:40:29 -0800
...
Subject: [PATCH 3.13.y-ckt 02/78] stackprotector: Unify the HAVE_CC_STACKPROTECTOR logic between architectures
Date:   Wed, 16 Dec 2015 16:38:46 -0800
Message-Id: <1450312802-4938-3-git-send-email-kamal@canonical.com>
