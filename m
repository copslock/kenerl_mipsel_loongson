Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 15 Jun 2010 19:12:47 +0200 (CEST)
Received: from mail-wy0-f177.google.com ([74.125.82.177]:39133 "EHLO
        mail-wy0-f177.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1492268Ab0FORMV (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 15 Jun 2010 19:12:21 +0200
Received: by wyb40 with SMTP id 40so1407461wyb.36
        for <linux-mips@linux-mips.org>; Tue, 15 Jun 2010 10:12:15 -0700 (PDT)
Received: by 10.216.85.71 with SMTP id t49mr1045117wee.19.1276621930449;
        Tue, 15 Jun 2010 10:12:10 -0700 (PDT)
Received: from localhost.localdomain ([122.171.5.172])
        by mx.google.com with ESMTPS id n50sm1710803weq.33.2010.06.15.10.12.06
        (version=SSLv3 cipher=RC4-MD5);
        Tue, 15 Jun 2010 10:12:09 -0700 (PDT)
From:   Himanshu Chauhan <hschauhan@nulltrace.org>
To:     linux-kernel@vger.kernel.org
Cc:     ralf@linux-mips.org, linux-mips@linux-mips.org,
        ddaney@caviumnetworks.com
Subject: [PATCH 1/2] MIPS: KProbes Support
Date:   Tue, 15 Jun 2010 20:12:48 +0530
Message-Id: <1276612969-13508-2-git-send-email-hschauhan@nulltrace.org>
...
This incorporates some of the comments from Daney.
Break codes being used are 515 and 516. do_break
has been removed and kprobes are handled in do_bp itself.
...
---
 ...
 arch/mips/kernel/kprobes.c      |  378 +++++++++++++++++++++++++++++++++++++++
...
+		 */
+	case cop1_op:
+		printk(KERN_ERR "Kprobes for branch and jump instructions "
+		       "is not supported\n");
+		ret = -EINVAL;
+		goto out;
+	}
...
@@ -706,6 +708,35 @@ asmlinkage void do_fpe(struct pt_regs *regs, unsigned long fcr31)
...
+
 static void do_trap_or_bp(struct pt_regs *regs, unsigned int code,
 	const char *str)
 {
@@ -783,6 +814,16 @@ asmlinkage void do_bp(struct pt_regs *regs)
 	if (bcode >= (1 << 10))
 		bcode >>= 10;
...
@@ -47,6 +50,11 @@ asmlinkage void do_page_fault(struct pt_regs *regs, unsigned long write,
 	       field, regs->cp0_epc);
 #endif
