Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 24 Sep 2006 18:35:42 +0100 (BST)
Received: from smtp108.sbc.mail.mud.yahoo.com ([68.142.198.207]:3197 "HELO
	smtp108.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S20037896AbWIXRfk (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Sun, 24 Sep 2006 18:35:40 +0100
Received: (qmail 1903 invoked from network); 24 Sep 2006 17:35:32 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@71.146.100.252 with login)
  by smtp108.sbc.mail.mud.yahoo.com with SMTP; 24 Sep 2006 17:35:31 -0000
Received: by lucon.org (Postfix, from userid 500)
	id A6A54105CB; Sun, 24 Sep 2006 10:35:30 -0700 (PDT)
Date:	Sun, 24 Sep 2006 10:35:30 -0700
...
Subject: The Linux binutils 2.17.50.0.4 is released
Message-ID: <20060924173530.GA13779@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.4 to hjl@lucon.org
...
1. binutils-2.17.50.0.4.tar.bz2. Source code.
2. binutils-2.17.50.0.3-2.17.50.0.4.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.4-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.4-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.4-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.4.tar.bz2
