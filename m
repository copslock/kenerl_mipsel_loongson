Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 28 Jan 2007 17:01:07 +0000 (GMT)
Received: from smtp101.sbc.mail.mud.yahoo.com ([68.142.198.200]:27481 "HELO
	smtp101.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S20038207AbXA1RA7 convert rfc822-to-8bit (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Sun, 28 Jan 2007 17:00:59 +0000
Received: (qmail 77449 invoked from network); 28 Jan 2007 16:59:50 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@71.146.69.37 with login)
  by smtp101.sbc.mail.mud.yahoo.com with SMTP; 28 Jan 2007 16:59:49 -0000
X-YMail-OSG: tbNQbqQVM1n4ok_cTAOGPNosqTqigYswhmWt7V4.jwPjscS.3ADzkr.SJfL2Dq0Kc3NkS3bCaU_DtD0GNPx8q0REZfjXTkWQm9Shtw3Iw2B.H0.1L6A-
Received: by lucon.org (Postfix, from userid 500)
	id 5F2A446EEF1; Sun, 28 Jan 2007 08:59:48 -0800 (PST)
Date:	Sun, 28 Jan 2007 08:59:48 -0800
From:	"H. J. Lu" <hjl@lucon.org>
To:	Mike Frysinger <vapier@gentoo.org>
Cc:	John David Anglin <dave@hiauly1.hia.nrc.ca>,
	linux-gcc@vger.kernel.org, gcc@gcc.gnu.org,
...
Subject: The Linux binutils 2.17.50.0.12 is released
Message-ID: <20070128165948.GA14444@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.12 to hjl@lucon.org
...
1. binutils-2.17.50.0.12.tar.bz2. Source code.
2. binutils-2.17.50.0.11-2.17.50.0.12.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.12-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.12-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.12-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.12.tar.bz2
