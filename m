Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 16 Aug 2012 11:10:47 +0200 (CEST)
Received: from nbd.name ([46.4.11.11]:50532 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1903438Ab2HPJKj (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 16 Aug 2012 11:10:39 +0200
From:   John Crispin <blogic@openwrt.org>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, John Crispin <blogic@openwrt.org>
Subject: [PATCH 1/4] MIPS: lantiq: split up IRQ IM ranges
Date:   Thu, 16 Aug 2012 11:09:19 +0200
Message-Id: <1345108162-1080-1-git-send-email-blogic@openwrt.org>
X-Mailer: git-send-email 1.7.9.1
X-archive-position: 34195
...
the SVIP we need to support IM ranges that are scattered in out register range.
