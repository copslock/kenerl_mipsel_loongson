Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 22 Apr 2003 11:11:51 +0100 (BST)
Received: from mo03.iij4u.or.jp ([IPv6:::ffff:210.130.0.20]:30678 "EHLO
	mo03.iij4u.or.jp") by linux-mips.org with ESMTP id <S8225196AbTDVKLq>;
	Tue, 22 Apr 2003 11:11:46 +0100
Received: from mdo00.iij4u.or.jp (mdo00.iij4u.or.jp [210.130.0.170])
	by mo03.iij4u.or.jp (8.8.8/MFO1.5) with ESMTP id TAA19497;
	Tue, 22 Apr 2003 19:11:39 +0900 (JST)
Received: 4UMDO00 id h3MABd902062; Tue, 22 Apr 2003 19:11:39 +0900 (JST)
Received: 4UMRO01 id h3MABbr09155; Tue, 22 Apr 2003 19:11:38 +0900 (JST)
	from pudding.montavista.co.jp (localhost [127.0.0.1]) (authenticated)
Date: Tue, 22 Apr 2003 19:11:37 +0900
From: Yoichi Yuasa <yuasa@hh.iij4u.or.jp>
To: ralf@linux-mips.org
Cc: yuasa@hh.iij4u.or.jp, linux-mips@linux-mips.org
Subject: [patch] TANBAC TB0226(NEC VR4131) for v2.5
Message-Id: <20030422191137.4ac88897.yuasa@hh.iij4u.or.jp>
X-Mailer: Sylpheed version 0.8.11 (GTK+ 1.2.10; i686-pc-linux-gnu)
Mime-Version: 1.0
Content-Type: multipart/mixed;
 boundary="Multipart_Tue__22_Apr_2003_19:11:37_+0900_0829a4b0"
Return-Path: <yuasa@hh.iij4u.or.jp>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 2121
...
--Multipart_Tue__22_Apr_2003_19:11:37_+0900_0829a4b0
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: 7bit

Hello Ralf,

I made a TANBAC TB0226 patch for v2.5.
TB0226 is already included in the CVS tree of v2.4.
...
--- linux.orig/arch/mips/Kconfig-shared	Thu Apr 17 12:31:41 2003
+++ linux/arch/mips/Kconfig-shared	Tue Apr 22 17:58:35 2003
@@ -26,7 +26,7 @@
 
 config PCI_AUTO
 	bool "Support for PCI AUTO Config" if MIPS_PB1000
-	default y if ZAO_CAPCELLA || VICTOR_MPC30X || TOSHIBA_JMR3927 || TOSHIBA_RBTX4927 || NEC_EAGLE || DDB5477 || DDB5476 || DDB5074 || MIPS_ITE8172 || MIPS_IVR || MIPS_EV96100 || MIPS_PB1500
...
-	default y if ZAO_CAPCELLA || VICTOR_MPC30X || TOSHIBA_JMR3927 || TOSHIBA_RBTX4927 || SNI_RM200_PCI || SGI_IP32 || SGI_IP27 || NEC_EAGLE || DDB5477 || DDB5476 || DDB5074 || MOMENCO_OCELOT_G || MOMENCO_OCELOT || MIPS_MALTA || MIPS_ATLAS || LASAT || MIPS_ITE8172 || HP_LASERJET || MIPS_IVR || MIPS_EV96100 || MIPS_EV64120 || MIPS_COBALT || MIPS_PB1500 || MIPS_PB1100 || MIPS_PB1000
...
@@ -558,7 +564,7 @@
 ...
 config NEW_PCI
 	bool
-	depends on ZAO_CAPCELLA || VICTOR_MPC30X || TOSHIBA_JMR3927 || TOSHIBA_RBTX4927 || NEC_EAGLE || DDB5477 || DDB5476 || DDB5074 || MIPS_ITE8172 || HP_LASERJET || MIPS_IVR || MIPS_EV96100 || MIPS_PB1500 || MIPS_PB1100 || MIPS_PB1000
...
--- linux.orig/arch/mips/Makefile	Mon Apr 14 10:48:17 2003
+++ linux/arch/mips/Makefile	Tue Apr 22 17:55:33 2003
@@ -277,6 +277,12 @@
...
+++ linux/arch/mips/defconfig-tb0226	Tue Apr 22 18:36:44 2003
@@ -0,0 +1,901 @@
+#
...
+++ linux/arch/mips/vr41xx/tanbac-tb0226/Makefile	Tue Apr 22 17:55:33 2003
@@ -0,0 +1,7 @@
+#
...
+++ linux/arch/mips/vr41xx/tanbac-tb0226/init.c	Tue Apr 22 18:10:36 2003
@@ -0,0 +1,64 @@
+/*
+ * FILE NAME
...
+++ linux/arch/mips/vr41xx/tanbac-tb0226/pci_fixup.c	Tue Apr 22 17:55:33 2003
@@ -0,0 +1,87 @@
+/*
+ * FILE NAME
...
+++ linux/arch/mips/vr41xx/tanbac-tb0226/setup.c	Tue Apr 22 17:55:33 2003
@@ -0,0 +1,113 @@
+/*
+ * FILE NAME
...
--- linux.orig/include/asm-mips/bootinfo.h	Mon Apr 14 10:48:22 2003
+++ linux/include/asm-mips/bootinfo.h	Tue Apr 22 17:55:33 2003
@@ -180,6 +180,7 @@
