Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 11 May 2012 08:20:23 +0200 (CEST)
Received: from home.bethel-hill.org ([63.228.164.32]:34344 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1903548Ab2EKGUM (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 11 May 2012 08:20:12 +0200
Received: by home.bethel-hill.org with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
        (Exim 4.72)
        (envelope-from <sjhill@mips.com>)
        id 1SSjCv-0001ub-2T; Fri, 11 May 2012 01:20:05 -0500
From:   "Steven J. Hill" <sjhill@mips.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     "Steven J. Hill" <sjhill@mips.com>
Subject: [PATCH v3,6/9] MIPS: Add support for microMIPS exception handling.
Date:   Fri, 11 May 2012 01:20:00 -0500
Message-Id: <1336717200-406-1-git-send-email-sjhill@mips.com>
X-Mailer: git-send-email 1.7.10
X-archive-position: 33249
...
---
 ...
 7 files changed, 413 insertions(+), 146 deletions(-)
...
@@ -1323,7 +1409,7 @@ asmlinkage void cache_parity_error(void)
...
@@ -1338,10 +1424,12 @@ void ejtag_exception_handler(struct pt_regs *regs)
 		 * calculation.
 		 */
 		old_epc = regs->cp0_epc;
+		old_ra = regs->regs[31];
...
+		regs->regs[31] = old_ra;
 		...
 		depc += 4;
 	write_c0_depc(depc);
@@ -1377,14 +1465,59 @@ unsigned long ebase;
...
@@ -1411,17 +1544,18 @@ static void *set_vi_srs_handler(int n, vi_handler_t addr, int srs)
...
@@ -1434,15 +1568,21 @@ static void *set_vi_srs_handler(int n, vi_handler_t addr, int srs)
...
@@ -1455,11 +1595,20 @@ static void *set_vi_srs_handler(int n, vi_handler_t addr, int srs)
...
+		const int handler_len = &except_vec_vi_end - vec_start;
 		...
 		if (handler_len > VECTORSPACING) {
 			/*
@@ -1469,30 +1618,44 @@ static void *set_vi_srs_handler(int n, vi_handler_t addr, int srs)
...
@@ -1607,7 +1770,11 @@ void __cpuinit per_cpu_trap_init(void)
 	if (cpu_has_mips_r2) {
...
@@ -1646,32 +1813,6 @@ void __cpuinit per_cpu_trap_init(void)
...
-
 ...
 {
@@ -1683,8 +1824,11 @@ __setup("rdhwr_noopt", set_rdhwr_noopt);
...
@@ -1812,13 +1956,16 @@ void __init trap_init(void)
...
index 100971f..48a0c3d 100644
--- a/arch/mips/mm/tlbex.c
+++ b/arch/mips/mm/tlbex.c
@@ -2019,6 +2019,13 @@ static void __cpuinit build_r4000_tlb_load_handler(void)
...
@@ -2066,6 +2073,13 @@ static void __cpuinit build_r4000_tlb_store_handler(void)
...
@@ -2114,6 +2128,13 @@ static void __cpuinit build_r4000_tlb_modify_handler(void)
