Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 15 Apr 2013 14:47:32 +0200 (CEST)
Received: from mail-pd0-f178.google.com ([209.85.192.178]:50518 "EHLO
        mail-pd0-f178.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6817408Ab3DOMraOIlEL (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 15 Apr 2013 14:47:30 +0200
Received: by mail-pd0-f178.google.com with SMTP id w11so2472024pde.9
        for <multiple recipients>; Mon, 15 Apr 2013 05:47:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=x-received:sender:from:to:cc:subject:date:message-id:x-mailer;
        bh=nyxmwzX286CJw3j+8aApXVEh4HCj8z0z64usuIqCX5s=;
        b=
X-Received: by 10.67.2.68 with SMTP id bm4mr29740238pad.9.1366030043120;
        Mon, 15 Apr 2013 05:47:23 -0700 (PDT)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id xz4sm20242580pbb.18.2013.04.15.05.47.18
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Mon, 15 Apr 2013 05:47:21 -0700 (PDT)
...
Subject: [PATCH V10 00/13] MIPS: Add Loongson-3 based machines support
Date:   Mon, 15 Apr 2013 20:46:55 +0800
Message-Id: <1366030028-5084-1-git-send-email-chenhc@lemote.com>
X-Mailer: git-send-email 1.7.7.3
Return-Path: <chenhuacai@gmail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 36181
...
---
 ...
 43 files changed, 1877 insertions(+), 58 deletions(-)
