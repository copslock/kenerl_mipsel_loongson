Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 12 Nov 2012 09:37:30 +0100 (CET)
Received: from mail-pa0-f49.google.com ([209.85.220.49]:58682 "EHLO
        mail-pa0-f49.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6823019Ab2KLIfVx-je4 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 12 Nov 2012 09:35:21 +0100
Received: by mail-pa0-f49.google.com with SMTP id bi5so3805949pad.36
        for <multiple recipients>; Mon, 12 Nov 2012 00:35:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=sender:from:to:cc:subject:date:message-id:x-mailer:in-reply-to
         :references;
        bh=jPusyiAcmNOxtMQEF5nHT9N7AIVez6v5Hlt40gpRA1U=;
        b=
Received: by 10.68.218.97 with SMTP id pf1mr55502651pbc.96.1352709320956;
        Mon, 12 Nov 2012 00:35:20 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id k4sm3967393pax.7.2012.11.12.00.35.10
...
Subject: [PATCH V8 12/13] MIPS: Loongson 3: Add CPU hotplug support
Date:   Mon, 12 Nov 2012 16:32:48 +0800
Message-Id: <1352709169-3481-13-git-send-email-chenhc@lemote.com>
...
index 2606c89..052374f 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -268,6 +268,7 @@ config LASAT
...
+	per_cpu(cpu_state, smp_processor_id()) = CPU_ONLINE;
 ...
 /*
@@ -266,6 +294,146 @@ void __init loongson3_cpus_done(void)
 {
 }
...
@@ -275,4 +443,8 @@ struct plat_smp_ops loongson3_smp_ops = {
