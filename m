...
Message-ID: <20180716152636.JxCaem8EfqYfKhzAYs8uX1aMFp4SdRcE-Ju3kPngr8g@z>
...
queue-4.14/binfmt_elf-respect-error-return-from-regset-active.patch
queue-4.14/mips-loongson64-cs5536-fix-pci_ohci_int_reg-reads.patch
queue-4.14/mips-ath79-fix-system-restart.patch
queue-4.14/mips-jz4740-bump-zload-address.patch
