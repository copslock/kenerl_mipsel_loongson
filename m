Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 08 Apr 2014 17:15:16 +0200 (CEST)
Received: from demumfd002.nsn-inter.net ([93.183.12.31]:39902 "EHLO
        demumfd002.nsn-inter.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6819445AbaDHPPMnHHdZ (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 8 Apr 2014 17:15:12 +0200
Received: from demuprx017.emea.nsn-intra.net ([10.150.129.56])
        by demumfd002.nsn-inter.net (8.14.3/8.14.3) with ESMTP id s38FF7dX030642
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=FAIL);
        Tue, 8 Apr 2014 15:15:07 GMT
Received: from ak-desktop.emea.nsn-net.net ([10.144.45.49])
        by demuprx017.emea.nsn-intra.net (8.12.11.20060308/8.12.11) with ESMTP id s38FF59D026428;
        Tue, 8 Apr 2014 17:15:06 +0200
From:   Aaro Koskinen <aaro.koskinen@nsn.com>
To:     Ralf Baechle <ralf@linux-mips.org>, linux-mips@linux-mips.org,
        linux-kernel@vger.kernel.org
Cc:     Aaro Koskinen <aaro.koskinen@nsn.com>
Subject: [PATCH] MIPS: Add __SANE_USERSPACE_TYPES__ to asm/types.h for LL64
Date:   Tue,  8 Apr 2014 18:13:06 +0300
Message-Id: <1396969986-6144-1-git-send-email-aaro.koskinen@nsn.com>
...
X-purgate-size: 1272
X-purgate-ID: 151667::1396970107-00001564-6B02441C/0/0
Return-Path: <aaro.koskinen@nsn.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 39728
