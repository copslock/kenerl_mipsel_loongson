Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 28 May 2016 11:47:42 +0200 (CEST)
Received: from mail-pa0-f68.google.com ([209.85.220.68]:34598 "EHLO
        mail-pa0-f68.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27037150AbcE1JrkTs42- (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sat, 28 May 2016 11:47:40 +0200
Received: by mail-pa0-f68.google.com with SMTP id yl2so15486762pac.1
        for <linux-mips@linux-mips.org>; Sat, 28 May 2016 02:47:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=from:to:cc:subject:date:message-id;
        bh=1KRfUsdUM37RIkF1TJwwp1/plygucviEnfzRgs32Lws=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20130820;
        h=x-gm-message-state:from:to:cc:subject:date:message-id;
        bh=1KRfUsdUM37RIkF1TJwwp1/plygucviEnfzRgs32Lws=;
        b=
X-Gm-Message-State: ALyK8tKm2v+WQn1EosoBPB1vjb1d8zlYLEOwxKAUROF6pT5ZhKgfKYtXj9EhyuPokjvCPQ==
X-Received: by 10.66.122.175 with SMTP id lt15mr29040731pab.51.1464428853717;
        Sat, 28 May 2016 02:47:33 -0700 (PDT)
Received: from localhost.localdomain ([175.111.195.49])
        by smtp.gmail.com with ESMTPSA id f24sm3594559pfd.62.2016.05.28.02.47.30
        (version=TLSv1/SSLv3 cipher=OTHER);
        Sat, 28 May 2016 02:47:32 -0700 (PDT)
From:   Keguang Zhang <keguang.zhang@gmail.com>
To:     dmaengine@vger.kernel.org, linux-mips@linux-mips.org,
        linux-kernel@vger.kernel.org
Cc:     Vinod Koul <vinod.koul@intel.com>,
        Dan Williams <dan.j.williams@intel.com>,
        Kelvin Cheung <keguang.zhang@gmail.com>
Subject: [PATCH V3] dmaengine: Loongson1: add Loongson1 dmaengine driver
Date:   Sat, 28 May 2016 17:47:13 +0800
Message-Id: <1464428833-27517-1-git-send-email-keguang.zhang@gmail.com>
X-Mailer: git-send-email 1.9.1
Return-Path: <keguang.zhang@gmail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 53682
