Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 19 Oct 2008 03:08:31 +0100 (BST)
Received: from sakura.staff.proxad.net ([213.228.1.107]:38356 "EHLO
	sakura.staff.proxad.net") by ftp.linux-mips.org with ESMTP
	id S21816153AbYJSCHD (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Sun, 19 Oct 2008 03:07:03 +0100
Received: by sakura.staff.proxad.net (Postfix, from userid 1000)
	id 979051124050; Sun, 19 Oct 2008 04:07:02 +0200 (CEST)
From:	Maxime Bizon <mbizon@freebox.fr>
To:	ralf@linux-mips.org
Cc:	linux-mips@linux-mips.org, Maxime Bizon <mbizon@freebox.fr>
Subject: [PATCH/RFC v1 02/12] [MIPS] BCM63XX: Add support for Broadcom 63xx CPUs.
Date:	Sun, 19 Oct 2008 04:07:02 +0200
Message-Id: <1224382022-24223-1-git-send-email-mbizon@freebox.fr>
X-Mailer: git-send-email 1.5.4.3
Return-Path: <max@sakura.staff.proxad.net>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 20800
...
---
 ...
 .../asm/mach-bcm63xx/cpu-feature-overrides.h       |   51 ++
...
index 7f39fd8..6cfa77f 100644
--- a/arch/mips/Makefile
+++ b/arch/mips/Makefile
@@ -533,6 +533,13 @@ cflags-$(CONFIG_BCM47XX)	+= -I$(srctree)/arch/mips/include/asm/mach-bcm47xx
