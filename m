Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 25 Oct 2006 16:06:13 +0100 (BST)
Received: from mba.ocn.ne.jp ([210.190.142.172]:46535 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S20037436AbWJYPGK (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Wed, 25 Oct 2006 16:06:10 +0100
Received: from localhost (p7104-ipad03funabasi.chiba.ocn.ne.jp [219.160.87.104])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 8DD5AB7AE; Thu, 26 Oct 2006 00:06:05 +0900 (JST)
Date:	Thu, 26 Oct 2006 00:08:31 +0900 (JST)
Message-Id: <20061026.000831.75185292.anemo@mba.ocn.ne.jp>
...
Just updated against current git tree.
...
+#endif
 ...
 L_LA(_vmalloc_done)
 L_LA(_tlbw_hazard)
@@ -686,6 +692,13 @@ static void __init il_bgezl(u32 **p, str
 	i_bgezl(p, reg, 0);
 }
...
+
 ...
 #define K0		26
 #define K1		27
@@ -970,7 +983,11 @@ build_get_pmde64(u32 **p, struct label *
...
+#endif
 ...
 #ifdef CONFIG_SMP
@@ -1023,8 +1040,46 @@ build_get_pgd_vmalloc64(u32 **p, struct 
 {
