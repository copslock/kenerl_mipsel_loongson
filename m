Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 21 Feb 2016 13:57:35 +0100 (CET)
Received: from hauke-m.de ([5.39.93.123]:51713 "EHLO hauke-m.de"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S27007423AbcBUM5daOjqF (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 21 Feb 2016 13:57:33 +0100
Received: from hauke-desktop.fritz.box (p5DE94359.dip0.t-ipconnect.de [93.233.67.89])
        by hauke-m.de (Postfix) with ESMTPSA id B88231001AC;
        Sun, 21 Feb 2016 13:57:32 +0100 (CET)
From:   Hauke Mehrtens <hauke@hauke-m.de>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     alex.smith@imgtec.com, Hauke Mehrtens <hauke@hauke-m.de>,
        "# v4 . 4+" <stable@vger.kernel.org>
Subject: [PATCH] MIPS: vdso: flush the vdso data page to update it on all processes
Date:   Sun, 21 Feb 2016 13:57:23 +0100
Message-Id: <1456059443-13889-1-git-send-email-hauke@hauke-m.de>
X-Mailer: git-send-email 2.7.0
Return-Path: <hauke@hauke-m.de>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 52147
