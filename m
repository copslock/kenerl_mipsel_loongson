Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 22 May 2006 17:33:50 +0200 (CEST)
Received: from mba.ocn.ne.jp ([210.190.142.172]:62424 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S8134004AbWEVPdj (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Mon, 22 May 2006 17:33:39 +0200
Received: from localhost (p3247-ipad208funabasi.chiba.ocn.ne.jp [60.43.104.247])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 067C6993B; Tue, 23 May 2006 00:33:35 +0900 (JST)
Date:	Tue, 23 May 2006 00:34:24 +0900 (JST)
Message-Id: <20060523.003424.104640954.anemo@mba.ocn.ne.jp>
...
On Tue, 14 Feb 2006 01:15:08 +0900 (JST), Atsushi Nemoto <anemo@mba.ocn.ne.jp> wrote:
...
I found a hole in the rewrite of copy_to_user_page.  flush_icache_page
does not flush data cache via user mapping.  Revised.
...
@@ -81,6 +85,135 @@ unsigned long setup_zero_pages(void)
 	return 1UL << order;
 }
...
index 0ec7bc6..b38e1b0 100644
--- a/mm/memory.c
+++ b/mm/memory.c
@@ -1394,7 +1394,7 @@ static inline pte_t maybe_mkwrite(pte_t 
 	return pte;
 }
...
@@ -1418,7 +1418,7 @@ static inline void cow_user_page(struct 
 		return;
