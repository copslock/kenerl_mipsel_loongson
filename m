Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 10 Jan 2005 01:13:17 +0000 (GMT)
Received: from alpha.total-knowledge.com ([IPv6:::ffff:209.157.135.102]:11481
	"EHLO alpha.total-knowledge.com") by linux-mips.org with ESMTP
	id <S8225264AbVAJBNL>; Mon, 10 Jan 2005 01:13:11 +0000
Received: (qmail 19229 invoked from network); 9 Jan 2005 07:56:02 -0800
Received: from c-24-6-216-150.client.comcast.net (HELO ?192.168.0.238?) (24.6.216.150)
  by alpha.total-knowledge.com with SMTP; 9 Jan 2005 07:56:02 -0800
Message-ID: <41E1D6A5.5030709@total-knowledge.com>
Date: Sun, 09 Jan 2005 17:13:09 -0800
...
Subject: Re: IP32 memory patch
References: <41E069BF.8040500@total-knowledge.com> <41E1CCC1.9060407@total-knowledge.com>
In-Reply-To: <41E1CCC1.9060407@total-knowledge.com>
X-Enigmail-Version: 0.89.6.0
X-Enigmail-Supports: pgp-inline, pgp-mime
Content-Type: multipart/mixed;
 boundary="------------050708050006070807040105"
Return-Path: <ilya@total-knowledge.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 6850
...
>> 2.  Seems that PCI support is messed up by this patch, so SCSI 
>> doesn't work.
>>
>> If someone can see something obvious regarding #2, I'll be glad to 
>> hear it.
>>
>>    Ilya.
>>
> So, I found the problem.
> Memory above 256M is mapped at 0x40000000+256M in IP32. However, PCI 
> sees whole 1G as contiguous chunk at
> offset 0. This means we have to translate dma addreses differently, 
> depending on wether they fall within first
> 256M or not.
>
...
+ * for more details.
+ *
+ * Copyright (C) 2004 Ilya A. Volynets-Evenbakh
+ */
