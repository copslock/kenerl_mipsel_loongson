Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Aug 2017 00:57:17 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:39021 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995175AbdHHWxeuGeEu (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 9 Aug 2017 00:53:34 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id 57280459BE;
        Wed,  9 Aug 2017 00:53:34 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter03.heinlein-hosting.de (spamfilter03.heinlein-hosting.de [80.241.56.117]) (amavisd-new, port 10030)
        with ESMTP id nPA4_GMAP5gh; Wed,  9 Aug 2017 00:53:33 +0200 (CEST)
...
Subject: [PATCH v9 11/16] MIPS: lantiq: remove old reset controller implementation
Date:   Wed,  9 Aug 2017 00:52:42 +0200
Message-Id: <20170808225247.32266-12-hauke@hauke-m.de>
