Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 16 Mar 2007 17:51:26 +0000 (GMT)
Received: from smtp110.sbc.mail.mud.yahoo.com ([68.142.198.209]:21363 "HELO
	smtp110.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S20022511AbXCPRvT (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 16 Mar 2007 17:51:19 +0000
Received: (qmail 21859 invoked from network); 16 Mar 2007 17:50:09 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@75.61.83.235 with login)
  by smtp110.sbc.mail.mud.yahoo.com with SMTP; 16 Mar 2007 17:50:08 -0000
X-YMail-OSG: 5K2FyVYVM1lBPuQw_XDf99tltcIg4H7z.4TxJtyk.3RA2BPJk5B0XLeoum4Sbuo.EUWBbLtFkMiFt7En1jpNEYIfO0YwO93kyJIEZaj6nAQqYesm2n2Bdw--
Received: by lucon.org (Postfix, from userid 500)
	id B4A7F46EEB1; Fri, 16 Mar 2007 10:50:07 -0700 (PDT)
Date:	Fri, 16 Mar 2007 10:50:07 -0700
...
Subject: The Linux binutils 2.17.50.0.13 is released
Message-ID: <20070316175007.GA456@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.13 to hjl@lucon.org
...
1. binutils-2.17.50.0.13.tar.bz2. Source code.
2. binutils-2.17.50.0.12-2.17.50.0.13.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.13-1.i386.rpm. IA-32 binary RPM for RedHat EL 4.
4. binutils-2.17.50.0.13-1.ia64.rpm. IA-64 binary RPM for RedHat EL 4.
5. binutils-2.17.50.0.13-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 4.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.17.50.0.13.tar.bz2
