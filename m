Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 14 Dec 2012 23:14:54 +0100 (CET)
Received: from home.bethel-hill.org ([63.228.164.32]:33270 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S6823017Ab2LNWOuEzWbj (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 14 Dec 2012 23:14:50 +0100
Received: by home.bethel-hill.org with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
        (Exim 4.72)
        (envelope-from <sjhill@mips.com>)
        id 1TjdWj-0006XV-8Z; Fri, 14 Dec 2012 16:14:41 -0600
From:   "Steven J. Hill" <sjhill@mips.com>
To:     linux-mips@linux-mips.org
Cc:     "Steven J. Hill" <sjhill@mips.com>, ralf@linux-mips.org
Subject: [PATCH v3] OF: MIPS: sead3: Implement OF support.
Date:   Fri, 14 Dec 2012 16:14:36 -0600
Message-Id: <1355523276-2989-1-git-send-email-sjhill@mips.com>
X-Mailer: git-send-email 1.7.9.5
X-archive-position: 35289
...
---
 ...
 arch/mips/mti-sead3/sead3-setup.c        |   28 ++++++
...
index 8fa6d7c..8bb9518 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -356,6 +356,7 @@ config MIPS_SEAD3
...
@@ -17,4 +22,27 @@ const char *get_system_type(void)
