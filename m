Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 24 Jun 2014 19:32:23 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.59.15.196]:36499 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S6862376AbaFXRbgLPYLW (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 24 Jun 2014 19:31:36 +0200
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id 455625F3B4632;
        Tue, 24 Jun 2014 18:31:22 +0100 (IST)
...
Received: from BAMAIL02.ba.imgtec.org (192.168.66.28) by
 ...
 14.3.181.6; Tue, 24 Jun 2014 18:31:25 +0100
...
Subject: [PATCH v3 1/9] MIPS: KVM: Reformat code and comments
Date:   Tue, 24 Jun 2014 10:31:02 -0700
Message-ID: <1403631071-6012-2-git-send-email-dengcheng.zhu@imgtec.com>
...
o Slight format adjustments are made.
 ...
 arch/mips/kvm/kvm_trap_emul.c     |  74 ++++----
...
+			cause, opc, badvaddr);
 		...
 		kvm_arch_vcpu_dump_regs(vcpu);
 		run->exit_reason = KVM_EXIT_INTERNAL_ERROR;
@@ -186,10 +185,12 @@ static int kvm_trap_emul_handle_tlb_ld_miss(struct kvm_vcpu *vcpu)
...
+		 *     into the shadow host TLB
 		...
 		er = kvm_mips_handle_tlbmiss(cause, opc, run, vcpu);
@@ -349,9 +350,9 @@ static int kvm_trap_emul_vcpu_setup(struct kvm_vcpu *vcpu)
 	uint32_t config1;
...
@@ -373,14 +374,15 @@ static int kvm_trap_emul_vcpu_setup(struct kvm_vcpu *vcpu)
