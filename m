Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 26 Nov 2015 11:01:43 +0100 (CET)
Received: from mxout51.expurgate.net ([194.37.255.51]:44923 "EHLO
        mxout51.expurgate.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27012633AbbKZKB1UV9OI convert rfc822-to-8bit
        (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 26 Nov 2015 11:01:27 +0100
Received: from [127.0.0.1] (helo=localhost)
        by relay.expurgate.net with smtp (Exim 4.80.1)
        (envelope-from <mschiller@tdt.de>)
        id 1a1tMf-00063I-Tu; Thu, 26 Nov 2015 11:01:21 +0100
Received: from [195.243.126.94] (helo=ms.tdt.de)
        by relay.expurgate.net with esmtp (Exim 4.80.1)
        (envelope-from <mschiller@tdt.de>)
        id 1a1tMe-0002ZO-Py; Thu, 26 Nov 2015 11:01:20 +0100
...
Subject: [PATCH v3 2/5] pinctrl/lantiq: introduce new dedicated devicetree bindings
Date:   Thu, 26 Nov 2015 11:00:07 +0100
Message-ID: <1448532010-30930-2-git-send-email-mschiller@tdt.de>
...
X-purgate-sourceid: 1a1tMe-0002ZO-Py
X-purgate-Ad: Checked for spam and viruses by eXpurgate(R), see www.eleven.de for details.
X-purgate-ID: 151534::1448532081-000033D1-F4288C44/0/0
X-purgate: clean
...
- use dedicated static entries instead of pointers to array elements for the
  match table
- mapped the deprecated "lantiq,pinctrl-xway" binding to the danube entry
