Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 01 Sep 2018 14:03:48 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:63138 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23990471AbeIAMDpf02zd (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sat, 1 Sep 2018 14:03:45 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id DF65A42716;
        Sat,  1 Sep 2018 14:03:39 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by hefe.heinlein-support.de (hefe.heinlein-support.de [91.198.250.172]) (amavisd-new, port 10030)
        with ESMTP id ot4qhyfaIS0V; Sat,  1 Sep 2018 14:03:38 +0200 (CEST)
...
Subject: [PATCH v2 net-next 3/7] net: dsa: Add Lantiq / Intel GSWIP tag support
Date:   Sat,  1 Sep 2018 14:03:32 +0200
Message-Id: <20180901120332.9792-1-hauke@hauke-m.de>
