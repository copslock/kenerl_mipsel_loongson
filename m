Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 18 Dec 2013 19:20:43 +0100 (CET)
Received: from smtp.outflux.net ([198.145.64.163]:56148 "EHLO smtp.outflux.net"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6826005Ab3LRSUiruAOx (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 18 Dec 2013 19:20:38 +0100
Received: from www.outflux.net (serenity-end.outflux.net [10.2.0.2])
        by vinyl.outflux.net (8.14.4/8.14.4/Debian-2ubuntu2.1) with ESMTP id rBIIJwsG028244;
...
Subject: [PATCH v4 1/2] create HAVE_CC_STACKPROTECTOR for centralized use
Date:   Wed, 18 Dec 2013 10:19:55 -0800
Message-Id: <1387390796-5860-2-git-send-email-keescook@chromium.org>
X-Mailer: git-send-email 1.7.9.5
In-Reply-To: <1387390796-5860-1-git-send-email-keescook@chromium.org>
...
index 858a147fd836..27ed3ff7cf4c 100644
--- a/Makefile
+++ b/Makefile
...
index 57d021507120..66d126ab9942 100644
--- a/arch/x86/Makefile
+++ b/arch/x86/Makefile
@@ -89,13 +89,11 @@ else
...
+# Make sure compiler does not have buggy stackprotector support.
 ifdef CONFIG_CC_STACKPROTECTOR
...
+                $(error stack protector enabled but compiler support is broken)
         endif
 endif
