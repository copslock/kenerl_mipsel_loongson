Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 20 Jun 2005 22:57:20 +0100 (BST)
Received: from coderock.org ([IPv6:::ffff:193.77.147.115]:57496 "EHLO
	trashy.coderock.org") by linux-mips.org with ESMTP
	id <S8225406AbVFTVyL>; Mon, 20 Jun 2005 22:54:11 +0100
Received: by trashy.coderock.org (Postfix, from userid 780)
	id AFDF21EF6C; Mon, 20 Jun 2005 23:54:07 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by trashy.coderock.org (Postfix) with ESMTP id 4AC441EF63;
	Mon, 20 Jun 2005 23:53:55 +0200 (CEST)
Received: from nd47.coderock.org (localhost [127.0.0.1])
	by trashy.coderock.org (Postfix) with ESMTP id A01881EDC4;
	Mon, 20 Jun 2005 23:49:57 +0200 (CEST)
Received: (from domen@localhost)
	by nd47.coderock.org (8.13.3/8.13.3/Submit) id j5KLnvph021758;
	Mon, 20 Jun 2005 23:49:57 +0200
Message-Id: <20050620214957.042411000@nd47.coderock.org>
Date:	Mon, 20 Jun 2005 23:49:57 +0200
From:	domen@coderock.org
To:	ralf@linux-mips.org
Cc:	linux-mips@linux-mips.org, domen@coderock.org
Subject: [patch 6/8] delete include/asm-mips/riscos-syscall.h
Content-Disposition: inline; filename=remove_file-include_asm_mips_riscos_syscall.h.patch
...
---
 riscos-syscall.h |  979 -------------------------------------------------------
 1 files changed, 979 deletions(-)

Index: quilt/include/asm-mips/riscos-syscall.h
===================================================================
--- quilt.orig/include/asm-mips/riscos-syscall.h
+++ /dev/null
@@ -1,979 +0,0 @@
-/*
