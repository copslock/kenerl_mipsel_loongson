Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 29 Jan 2015 18:19:14 +0100 (CET)
Received: from home.bethel-hill.org ([63.228.164.32]:50159 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27012214AbbA2RRrKE3-U (ORCPT
...
Received: by home.bethel-hill.org with esmtpsa (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        ...
        id 1YGsfG-00015a-OC; Thu, 29 Jan 2015 11:13:58 -0600
From:   "Steven J. Hill" <Steven.Hill@imgtec.com>
To:     linux-mips@linux-mips.org
Cc:     ralf@linux-mips.org
Subject: [PATCH V3 4/5] MIPS: Add support for XPA.
Date:   Thu, 29 Jan 2015 11:17:36 -0600
Message-Id: <1422551857-10981-5-git-send-email-Steven.Hill@imgtec.com>
...
---
 ...
 11 files changed, 175 insertions(+), 48 deletions(-)

diff --git a/arch/mips/Kconfig b/arch/mips/Kconfig
index 1fae6f1..21365d5 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -376,6 +376,7 @@ config MIPS_MALTA
...
@@ -1557,6 +1559,33 @@ config CPU_MIPS32_3_5_EVA
...
+
 ...
 config CPU_NOP_WORKAROUNDS
 	bool
@@ -1660,6 +1689,9 @@ config SYS_HAS_CPU_MIPS32_R2
...
@@ -1785,6 +1817,9 @@ config CPU_MIPSR2
 config EVA
 	bool
...
@@ -155,8 +153,8 @@ static inline void pte_clear(struct mm_struct *mm, unsigned long addr, pte_t *pt
 	pte_t null = __pte(0);
...
+		null.pte_high = _PAGE_GLOBAL;
 	...
 	htw_reset();
@@ -237,21 +235,21 @@ static inline int pte_file(pte_t pte)	{ return pte.pte_low & _PAGE_FILE; }
...
@@ -259,30 +257,24 @@ static inline pte_t pte_mkold(pte_t pte)
...
-	}
 ...
 #else
@@ -387,10 +379,10 @@ static inline pgprot_t pgprot_writecombine(pgprot_t _prot)
 #if defined(CONFIG_PHYS_ADDR_T_64BIT) && defined(CONFIG_CPU_MIPS32)
...
index da2a78d..3663ff6 100644
--- a/arch/mips/kernel/cpu-probe.c
+++ b/arch/mips/kernel/cpu-probe.c
@@ -506,6 +506,10 @@ static inline unsigned int decode_config5(struct cpuinfo_mips *c)
...
+		uasm_i_andi(p, t, t, 1);
 		...
 		if (pte == t)
 			/* You lose the SMP race :-(*/
@@ -2284,6 +2320,11 @@ static void config_htw_params(void)
...
@@ -2297,6 +2338,26 @@ static void config_htw_params(void)
 	print_htw_config();
 }
...
+
 ...
 {
 	/*
@@ -2361,8 +2422,9 @@ void build_tlb_refill_handler(void)
 		}
