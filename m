Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 15 Apr 2013 14:51:19 +0200 (CEST)
Received: from mail-pd0-f173.google.com ([209.85.192.173]:38257 "EHLO
        mail-pd0-f173.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6835141Ab3DOMsTaXbCA (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 15 Apr 2013 14:48:19 +0200
Received: by mail-pd0-f173.google.com with SMTP id v14so2484209pde.18
        for <multiple recipients>; Mon, 15 Apr 2013 05:48:13 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=x-received:sender:from:to:cc:subject:date:message-id:x-mailer
         :in-reply-to:references;
        bh=Fz3WT//za7k3x4U4iVBn+IZM1mnoK59Pc/eFpE9iel4=;
        b=
X-Received: by 10.66.227.104 with SMTP id rz8mr30222825pac.85.1366030092920;
        Mon, 15 Apr 2013 05:48:12 -0700 (PDT)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id xz4sm20242580pbb.18.2013.04.15.05.48.08
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Mon, 15 Apr 2013 05:48:11 -0700 (PDT)
...
Subject: [PATCH V10 12/13] MIPS: Loongson 3: Add CPU hotplug support
Date:   Mon, 15 Apr 2013 20:47:07 +0800
Message-Id: <1366030028-5084-13-git-send-email-chenhc@lemote.com>
...
---
 ...
 arch/mips/loongson/loongson-3/smp.c            |  176 +++++++++++++++++++++++-
 5 files changed, 189 insertions(+), 5 deletions(-)

diff --git a/arch/mips/Kconfig b/arch/mips/Kconfig
index da0bad2..7fe8a4e 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -272,6 +272,7 @@ config LASAT
...
+	per_cpu(cpu_state, smp_processor_id()) = CPU_ONLINE;
 ...
 /*
@@ -268,6 +296,146 @@ void __init loongson3_cpus_done(void)
 {
 }
...
@@ -277,4 +445,8 @@ struct plat_smp_ops loongson3_smp_ops = {
