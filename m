Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 19 Jan 2016 10:26:03 +0100 (CET)
Received: from resqmta-ch2-12v.sys.comcast.net ([69.252.207.44]:32978 "EHLO
        resqmta-ch2-12v.sys.comcast.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27006153AbcASJ0ANgZjv (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 19 Jan 2016 10:26:00 +0100
Received: from resomta-ch2-02v.sys.comcast.net ([69.252.207.98])
        by resqmta-ch2-12v.sys.comcast.net with comcast
        id 7lRt1s00727uzMh01lRtPu; Tue, 19 Jan 2016 09:25:53 +0000
Received: from [192.168.1.13] ([76.106.83.43])
        by resomta-ch2-02v.sys.comcast.net with comcast
        id 7lRr1s0070w5D3801lRsYs; Tue, 19 Jan 2016 09:25:53 +0000
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=comcast.net;
        s=q20140121; t=1453195553;
        bh=VpKFL/+qWiIQoUfX0XoMi7xEhZUPS4TXpGZPEbD/Ir0=;
        h=Received:Received:Subject:To:From:Message-ID:Date:MIME-Version:
         Content-Type;
        b=
Return-Path: <kumba@gentoo.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 51209
