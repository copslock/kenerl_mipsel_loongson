...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id B56CEC43381
	for <linux-mips@archiver.kernel.org>; Wed, 27 Mar 2019 23:18:25 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 6F94021738
	for <linux-mips@archiver.kernel.org>; Wed, 27 Mar 2019 23:18:25 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=crapouillou.net header.i=@crapouillou.net header.b="h3SUQIhs"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1733306AbfC0XST (ORCPT <rfc822;linux-mips@archiver.kernel.org>);
        Wed, 27 Mar 2019 19:18:19 -0400
Received: from outils.crapouillou.net ([89.234.176.41]:59770 "EHLO
        crapouillou.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729235AbfC0XSR (ORCPT
        <rfc822;linux-mips@vger.kernel.org>); Wed, 27 Mar 2019 19:18:17 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=crapouillou.net;
        s=mail; t=1553728694; h=from:from:sender:reply-to:subject:subject:date:date:
         message-id:message-id:to:to:cc:cc:mime-version:content-type:
         content-transfer-encoding:in-reply-to:in-reply-to:  references:references;
        bh=kFiu4oCKNBmynf8g6iCJQc/PgL5heWklR+ACmJIz+jA=;
        b=h3SUQIhsfUNKeXzXNEeu0TXqAWMUnzWFoz2yz7/SjkRzoeWreLidYkLuIcFNxrrkmebNuP
        C1czWP4cFlSFTnTg4pCUFaYjQ4TjyTeatX78OezL4rCt95PYRI/wgrZdNT7dNuJDbuUPKQ
        nxdb28lKyp22DM5zasrggFKn5Tqpjsg=
...
Subject: [PATCH v11 27/27] MIPS: jz4740: Drop obsolete code
Date:   Thu, 28 Mar 2019 00:16:31 +0100
Message-Id: <20190327231631.15708-28-paul@crapouillou.net>
...
index 7e63c54eb8d2..0bebd6172073 100644
...
@@ -107,3 +109,9 @@ void __init arch_init_irq(void)
 {
 	irqchip_init();
 }
+
