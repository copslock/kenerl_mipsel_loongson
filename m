Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 22 Feb 2015 07:37:36 +0100 (CET)
Received: from home.bethel-hill.org ([63.228.164.32]:60493 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27006756AbbBVGgnDy3FE (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sun, 22 Feb 2015 07:36:43 +0100
Received: by home.bethel-hill.org with esmtpsa (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.84)
        (envelope-from <Steven.Hill@imgtec.com>)
        id 1YPQ60-0000CY-Ng; Sun, 22 Feb 2015 00:32:52 -0600
From:   "Steven J. Hill" <Steven.Hill@imgtec.com>
To:     linux-mips@linux-mips.org
Cc:     ralf@linux-mips.org
Subject: [PATCH V5 2/3] MIPS: Add support for XPA.
Date:   Sun, 22 Feb 2015 00:36:27 -0600
Message-Id: <1424586988-21544-3-git-send-email-Steven.Hill@imgtec.com>
...
+		null.pte_high = _PAGE_GLOBAL;
 	...
 	htw_start();
@@ -244,21 +242,21 @@ static inline int pte_young(pte_t pte)	{ return pte.pte_low & _PAGE_ACCESSED; }
...
@@ -266,30 +264,24 @@ static inline pte_t pte_mkold(pte_t pte)
...
-	}
 ...
 #else
@@ -394,10 +386,10 @@ static inline pgprot_t pgprot_writecombine(pgprot_t _prot)
 #if defined(CONFIG_PHYS_ADDR_T_64BIT) && defined(CONFIG_CPU_MIPS32)
