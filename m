Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 02 Mar 2017 10:50:10 +0100 (CET)
Received: from mailapp01.imgtec.com ([195.59.15.196]:53561 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S23993902AbdCBJhqmrGVt (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 2 Mar 2017 10:37:46 +0100
Received: from hhmail02.hh.imgtec.org (unknown [10.100.10.20])
        by Forcepoint Email with ESMTPS id BCA3635154B37;
        Thu,  2 Mar 2017 09:37:37 +0000 (GMT)
Received: from jhogan-linux.le.imgtec.org (192.168.154.110) by
 hhmail02.hh.imgtec.org (10.100.10.21) with Microsoft SMTP Server (TLS) id
 14.3.294.0; Thu, 2 Mar 2017 09:37:39 +0000
...
Subject: [PATCH 28/32] KVM: MIPS/VZ: Support guest hardware page table walker
Date:   Thu, 2 Mar 2017 09:36:55 +0000
Message-ID: <effaa15b43a554d06534c38e0f6b9bcde64b3ef6.1488447004.git-series.james.hogan@imgtec.com>
...
index 1116becf8d6f..a0430186dbd4 100644
...
index f986907a7707..6b7d131565cd 100644
...
@@ -681,7 +685,11 @@ __BUILD_KVM_RW_HW(pagegrain,      32, MIPS_CP0_TLB_PG_MASK,  1)
...
index 373b954a9fd3..c7d15aa69259 100644
--- a/arch/mips/kvm/vz.c
+++ b/arch/mips/kvm/vz.c
@@ -1391,6 +1391,13 @@ static u64 kvm_vz_get_one_regs_segments[] = {
...
@@ -1415,6 +1422,8 @@ static unsigned long kvm_vz_num_regs(struct kvm_vcpu *vcpu)
...
+	}
 	for (i = 0; i < 6; ++i) {
 		if (!cpu_guest_has_kscr(i + 2))
 			continue;
@@ -1563,9 +1578,29 @@ static int kvm_vz_get_one_reg(struct kvm_vcpu *vcpu,
 			return -EINVAL;
 		*v = read_gc0_segctl2();
 		break;
...
+		break;
 	case KVM_REG_MIPS_CP0_HWRENA:
 		*v = (long)read_gc0_hwrena();
 		break;
@@ -1745,9 +1780,29 @@ static int kvm_vz_set_one_reg(struct kvm_vcpu *vcpu,
 			return -EINVAL;
 		write_gc0_segctl2(v);
 		break;
+	case KVM_REG_MIPS_CP0_PWBASE:
...
+		break;
 	case KVM_REG_MIPS_CP0_HWRENA:
 		write_gc0_hwrena(v);
 		break;
@@ -2178,6 +2233,14 @@ static int kvm_vz_vcpu_load(struct kvm_vcpu *vcpu, int cpu)
...
+
 	...
 	if (cpu_has_guestctl2)
 		write_c0_guestctl2(
@@ -2267,6 +2330,15 @@ static int kvm_vz_vcpu_put(struct kvm_vcpu *vcpu, int cpu)
...
@@ -2595,6 +2667,14 @@ static int kvm_vz_vcpu_setup(struct kvm_vcpu *vcpu)
