Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 19 Jul 2007 13:50:44 +0100 (BST)
Received: from pollux.ds.pg.gda.pl ([153.19.208.7]:49930 "EHLO
	pollux.ds.pg.gda.pl") by ftp.linux-mips.org with ESMTP
	id S20022588AbXGSMul (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Thu, 19 Jul 2007 13:50:41 +0100
Received: from localhost (localhost [127.0.0.1])
	by pollux.ds.pg.gda.pl (Postfix) with ESMTP id 852C3E1C77;
	Thu, 19 Jul 2007 14:50:06 +0200 (CEST)
X-Virus-Scanned: by amavisd-new at pollux.ds.pg.gda.pl
Received: from pollux.ds.pg.gda.pl ([127.0.0.1])
	by localhost (pollux.ds.pg.gda.pl [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id DkIsRj-xBa5e; Thu, 19 Jul 2007 14:50:06 +0200 (CEST)
Received: from piorun.ds.pg.gda.pl (piorun.ds.pg.gda.pl [153.19.208.8])
	by pollux.ds.pg.gda.pl (Postfix) with ESMTP id 71632E1C64;
	Thu, 19 Jul 2007 14:50:04 +0200 (CEST)
Received: from blysk.ds.pg.gda.pl (macro@blysk.ds.pg.gda.pl [153.19.208.6])
	by piorun.ds.pg.gda.pl (8.13.8/8.13.8) with ESMTP id l6JCoBXC019503;
	Thu, 19 Jul 2007 14:50:11 +0200
Date:	Thu, 19 Jul 2007 13:50:07 +0100 (BST)
From:	"Maciej W. Rozycki" <macro@linux-mips.org>
To:	Ralf Baechle <ralf@linux-mips.org>
cc:	linux-mips@linux-mips.org, sibyte-users@bitmover.com
Subject: [PATCH] drivers/char/sb1250_duart.c: Remove the old driver
Message-ID: <Pine.LNX.4.64N.0707191343530.1861@blysk.ds.pg.gda.pl>
MIME-Version: 1.0
Content-Type: TEXT/PLAIN; charset=US-ASCII
X-Virus-Scanned: ClamAV 0.91.1/3697/Thu Jul 19 02:18:47 2007 on piorun.ds.pg.gda.pl
X-Virus-Status:	Clean
Return-Path: <macro@linux-mips.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 15813
...
Ralf,
 ...
 It probably does not build anymore and has no suspected maintainer.  
Unless one steps in this is my vote for the driver to be removed.  It has 
never made its way upstream and is unlikely to regardless.  RIP.

 Please apply,

  Maciej

patch-mips-2.6.22-20070719-char-sb1250-duart-28
diff -up --recursive --new-file linux-mips-2.6.22-20070719.macro/drivers/char/Kconfig linux-mips-2.6.22-20070719/drivers/char/Kconfig
--- linux-mips-2.6.22-20070719.macro/drivers/char/Kconfig	2007-07-19 12:14:33.000000000 +0000
+++ linux-mips-2.6.22-20070719/drivers/char/Kconfig	2007-07-19 12:35:30.000000000 +0000
@@ -372,14 +372,6 @@ config ISTALLION
...
diff -up --recursive --new-file linux-mips-2.6.22-20070719.macro/drivers/char/Makefile linux-mips-2.6.22-20070719/drivers/char/Makefile
--- linux-mips-2.6.22-20070719.macro/drivers/char/Makefile	2007-07-19 12:14:33.000000000 +0000
+++ linux-mips-2.6.22-20070719/drivers/char/Makefile	2007-07-19 12:35:30.000000000 +0000
@@ -33,7 +33,6 @@ obj-$(CONFIG_A2232)		+= ser_a2232.o gene
...
diff -up --recursive --new-file linux-mips-2.6.22-20070719.macro/drivers/char/sb1250_duart.c linux-mips-2.6.22-20070719/drivers/char/sb1250_duart.c
--- linux-mips-2.6.22-20070719.macro/drivers/char/sb1250_duart.c	2007-07-19 12:14:33.000000000 +0000
+++ linux-mips-2.6.22-20070719/drivers/char/sb1250_duart.c	1970-01-01 00:00:00.000000000 +0000
@@ -1,979 +0,0 @@
-/*
...
diff -up --recursive --new-file linux-mips-2.6.22-20070719.macro/include/linux/serial.h linux-mips-2.6.22-20070719/include/linux/serial.h
--- linux-mips-2.6.22-20070719.macro/include/linux/serial.h	2007-07-19 12:14:34.000000000 +0000
+++ linux-mips-2.6.22-20070719/include/linux/serial.h	2007-07-19 12:35:30.000000000 +0000
