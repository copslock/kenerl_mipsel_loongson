Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 03 Aug 2017 01:02:01 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:56705 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994855AbdHBW7Eah17W (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 3 Aug 2017 00:59:04 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id 0EC4046147;
        Thu,  3 Aug 2017 00:58:59 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by hefe.heinlein-support.de (hefe.heinlein-support.de [91.198.250.172]) (amavisd-new, port 10030)
        with ESMTP id Fpfh8ht7It-b; Thu,  3 Aug 2017 00:58:57 +0200 (CEST)
...
Subject: [PATCH v8 07/16] Documentation: DT: MIPS: lantiq: Add docs for the RCU bindings
Date:   Thu,  3 Aug 2017 00:57:08 +0200
Message-Id: <20170802225717.24408-8-hauke@hauke-m.de>
