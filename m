Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 20 Aug 2017 00:27:36 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:33794 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995041AbdHSWU2BSdLi (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 20 Aug 2017 00:20:28 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id 4251D4905C;
        Sun, 20 Aug 2017 00:20:22 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter03.heinlein-hosting.de (spamfilter03.heinlein-hosting.de [80.241.56.117]) (amavisd-new, port 10030)
        with ESMTP id Kn_G3lybTTmm; Sun, 20 Aug 2017 00:20:18 +0200 (CEST)
...
Subject: [PATCH v10 16/16] MIPS: lantiq: Remove the arch/mips/lantiq/xway/reset.c implementation
Date:   Sun, 20 Aug 2017 00:18:23 +0200
Message-Id: <20170819221823.13850-17-hauke@hauke-m.de>
