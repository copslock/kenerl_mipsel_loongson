Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 05 Oct 2010 14:02:17 +0200 (CEST)
Received: from eu1sys200aog104.obsmtp.com ([207.126.144.117]:53043 "EHLO
        eu1sys200aog104.obsmtp.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491021Ab0JEMBi (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 5 Oct 2010 14:01:38 +0200
Received: from source ([138.198.100.35]) (using TLSv1) by eu1sys200aob104.postini.com ([207.126.147.11]) with SMTP
        ID DSNKTKsTionFQoAbLqOKL+2D05JtVN6aR4CN@postini.com; Tue, 05 Oct 2010 12:01:37 UTC
Received: from zeta.dmz-ap.st.com (ns6.st.com [138.198.234.13])
        by beta.dmz-ap.st.com (STMicroelectronics) with ESMTP id 899F011E;
        Tue,  5 Oct 2010 12:00:20 +0000 (GMT)
Received: from relay2.stm.gmessaging.net (unknown [10.230.100.18])
        by zeta.dmz-ap.st.com (STMicroelectronics) with ESMTP id 6278699C;
        Tue,  5 Oct 2010 12:00:19 +0000 (GMT)
Received: from exdcvycastm022.EQ1STM.local (alteon-source-exch [10.230.100.61])
        ...
        by relay2.stm.gmessaging.net (Postfix) with ESMTPS id C7C19A809D;
        Tue,  5 Oct 2010 14:00:12 +0200 (CEST)
...
Subject: [PATCHv2 4/7] pwm: Align existing pwm drivers with pwm-core driver
Date:   Tue, 5 Oct 2010 17:29:59 +0530
Message-ID: <1286280002-1636-5-git-send-email-arun.murthy@stericsson.com>
...
---
 ...
 10 files changed, 421 insertions(+), 436 deletions(-)
...
-
 struct pwm_dev_info {
 	struct pwm_device *pwm_dev;
 	struct list_head list;
@@ -44,11 +39,11 @@ int pwm_enable(struct pwm_device *pwm)
 }
 EXPORT_SYMBOL(pwm_enable);
...
@@ -33,7 +48,11 @@ int pwm_enable(struct pwm_device *pwm);
 /*
