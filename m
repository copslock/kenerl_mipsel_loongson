Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 29 Apr 2016 15:54:53 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.59.15.196]:31526 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27027791AbcD2Nx0L5fNi (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 29 Apr 2016 15:53:26 +0200
Received: from hhmail02.hh.imgtec.org (unknown [10.100.10.20])
        by Websense Email with ESMTPS id C0998C540F21D;
        Fri, 29 Apr 2016 14:53:15 +0100 (IST)
...
Subject: [PATCH 4/6] MIPS: Add probing & defs for VZ & guest features
Date:   Fri, 29 Apr 2016 14:53:06 +0100
Message-ID: <1461937988-13787-5-git-send-email-james.hogan@imgtec.com>
...
index 952a2388c22e..83f4c00c2c27 100644
...
index b090aa51d644..3322aa5a0aa9 100644
...
+
  ...
  * Flag definitions
  */
@@ -92,6 +101,11 @@ struct cpuinfo_mips {
...
index 36cf2a717a3d..48157492d7c5 100644
...
index 0ccec160e913..0c92a53f1432 100644
--- a/arch/mips/kernel/cpu-probe.c
+++ b/arch/mips/kernel/cpu-probe.c
@@ -900,6 +900,235 @@ static void decode_configs(struct cpuinfo_mips *c)
 #endif
 }
...
@@ -1802,6 +2031,9 @@ void cpu_probe(void)
