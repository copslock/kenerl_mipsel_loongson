Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 27 Aug 2018 16:51:39 +0200 (CEST)
Received: from bombadil.infradead.org ([IPv6:2607:7c80:54:e::133]:55552 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23994565AbeH0OvNATclR (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 27 Aug 2018 16:51:13 +0200
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        List-Help:List-Unsubscribe:List-Subscribe:List-Post:List-Owner:List-Archive;
         bh=j6+VMGyUHPCWwvtlMeTmhnM7v+uh3gHA6du5Rsaxt9E=; b=LYfVywLpV62VbpGf9RAy7tIeV
        ;
Received: from 089144202128.atnat0011.highway.a1.net ([89.144.202.128] helo=localhost)
        by bombadil.infradead.org with esmtpsa (Exim 4.90_1 #2 (Red Hat Linux))
        id 1fuIr9-0004YB-W8; Mon, 27 Aug 2018 14:51:07 +0000
...
Date:   Mon, 27 Aug 2018 16:50:31 +0200
Message-Id: <20180827145032.9522-5-hch@lst.de>
...
index 47f983a9c99a..ea39eafec873 100644
...
index 79497ae00779..3ca38d570a2b 100644
--- a/include/linux/dma-noncoherent.h
+++ b/include/linux/dma-noncoherent.h
@@ -26,9 +26,15 @@ void *arch_dma_alloc(struct device *dev, size_t size, dma_addr_t *dma_handle,
...
-
 ...
 {
@@ -301,7 +291,6 @@ int dma_direct_mapping_error(struct device *dev, dma_addr_t dma_addr)
...
index d2a92ddaac4d..9550c08ddab1 100644
