Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Aug 2017 00:53:27 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:53990 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994828AbdHHWxUKpBHu (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 9 Aug 2017 00:53:20 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id 62FF645F89;
        Wed,  9 Aug 2017 00:53:13 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by hefe.heinlein-support.de (hefe.heinlein-support.de [91.198.250.172]) (amavisd-new, port 10030)
        with ESMTP id 4lwO-ql2NNWL; Wed,  9 Aug 2017 00:53:11 +0200 (CEST)
...
Subject: [PATCH v9 00/16] MIPS: lantiq: handle RCU register by separate drivers
Date:   Wed,  9 Aug 2017 00:52:31 +0200
Message-Id: <20170808225247.32266-1-hauke@hauke-m.de>
Return-Path: <hauke@hauke-m.de>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 59432
