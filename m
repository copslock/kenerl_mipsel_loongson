Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 24 Jul 2010 19:16:53 +0200 (CEST)
Received: from mail3.caviumnetworks.com ([12.108.191.235]:3464 "EHLO
        mail3.caviumnetworks.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1492119Ab0GXRQr (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sat, 24 Jul 2010 19:16:47 +0200
Received: from caexch01.caveonetworks.com (Not Verified[192.168.16.9]) by mail3.caviumnetworks.com with MailMarshal (v6,7,2,8378)
        id <B4c4b20170002>; Sat, 24 Jul 2010 10:17:11 -0700
Received: from caexch01.caveonetworks.com ([192.168.16.9]) by caexch01.caveonetworks.com with Microsoft SMTPSVC(6.0.3790.4675);
         Sat, 24 Jul 2010 10:16:43 -0700
Received: from dd1.caveonetworks.com ([12.108.191.236]) by caexch01.caveonetworks.com over TLS secured channel with Microsoft SMTPSVC(6.0.3790.4675);
         Sat, 24 Jul 2010 10:16:43 -0700
Received: from dd1.caveonetworks.com (localhost.localdomain [127.0.0.1])
        by dd1.caveonetworks.com (8.14.4/8.14.3) with ESMTP id o6OHGZRG024004;
        Sat, 24 Jul 2010 10:16:35 -0700
Received: (from ddaney@localhost)
        by dd1.caveonetworks.com (8.14.4/8.14.4/Submit) id o6OHGTkD024002;
        Sat, 24 Jul 2010 10:16:29 -0700
...
Subject: [PATCH] watchdog: Add watchdog driver for OCTEON SOCs (v2).
Date:   Sat, 24 Jul 2010 10:16:05 -0700
Message-Id: <1279991765-23962-1-git-send-email-ddaney@caviumnetworks.com>
X-Mailer: git-send-email 1.7.1.1
In-Reply-To: <20100724035826.GA27516@merkur.ravnborg.org>
References: <20100724035826.GA27516@merkur.ravnborg.org>
X-OriginalArrivalTime: 24 Jul 2010 17:16:43.0825 (UTC) FILETIME=[FD117210:01CB2B53]
Return-Path: <David.Daney@caviumnetworks.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 27484
...
This version incorporates the changes suggested by Sam Ravnborg in his review.

I would also note that I believe this patch depends on a pending MIPS patch:

http://patchwork.linux-mips.org/patch/1317/

Which will export the proper __delay() function.

As Ralf noted up thread, once approved, we could merge this via the
mips-linux.org tree as it depends on several patches there and Octeon
is a MIPS based SOC.
