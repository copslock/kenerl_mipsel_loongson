Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 09 Aug 2007 23:55:49 +0100 (BST)
Received: from hall.aurel32.net ([88.191.38.19]:36750 "EHLO hall.aurel32.net")
	by ftp.linux-mips.org with ESMTP id S20024706AbXHIWzp (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Thu, 9 Aug 2007 23:55:45 +0100
Received: from aurel32 by hall.aurel32.net with local (Exim 4.63)
	(envelope-from <aurel32@hall.aurel32.net>)
	id 1IJGrl-00056a-RF
	for linux-mips@linux-mips.org; Fri, 10 Aug 2007 00:52:29 +0200
Date:	Fri, 10 Aug 2007 00:52:29 +0200
From:	Aurelien Jarno <aurelien@aurel32.net>
To:	linux-mips@linux-mips.org
Subject: [PATCH][MIPS] Move platform independent CFE code into arch/mips/cfe (v2)
Message-ID: <20070809225229.GA19505@hall.aurel32.net>
References: <20070809144505.GA1277@hall.aurel32.net>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-15
Content-Disposition: inline
In-Reply-To: <20070809144505.GA1277@hall.aurel32.net>
...
On Thu, Aug 09, 2007 at 04:45:05PM +0200, Aurelien Jarno wrote:
> The patch below against current git tree moves the platform independent
> part of the CFE code to arch/mips/cfe from arch/mips/sibyte/cfe. This way
> it can be used on other platforms.
> 

It seems I have to learn a bit more how to use git. The previous patch
was not complete, the patch below should be correct.
...
---
 ...
 arch/mips/cfe/cfe_api.c            |  502 ++++++++++++++++++++++++++++++++++++
 arch/mips/cfe/cfe_api_int.h        |  152 +++++++++++
 arch/mips/sibyte/Kconfig           |    1 +
 arch/mips/sibyte/cfe/Makefile      |    2 +-
 arch/mips/sibyte/cfe/cfe_api.c     |  502 ------------------------------------
 arch/mips/sibyte/cfe/cfe_api.h     |  185 -------------
 arch/mips/sibyte/cfe/cfe_api_int.h |  152 -----------
 arch/mips/sibyte/cfe/cfe_error.h   |   85 ------
 arch/mips/sibyte/cfe/console.c     |    4 +-
 arch/mips/sibyte/cfe/setup.c       |    4 +-
 arch/mips/sibyte/cfe/smp.c         |    4 +-
 include/asm-mips/cfe/cfe_api.h     |  185 +++++++++++++
 include/asm-mips/cfe/cfe_error.h   |   85 ++++++
 15 files changed, 936 insertions(+), 931 deletions(-)
