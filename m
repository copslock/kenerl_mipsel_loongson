Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 04 Oct 2012 17:21:27 +0200 (CEST)
Received: from zmc.proxad.net ([212.27.53.206]:43652 "EHLO zmc.proxad.net"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6870474Ab2JDPTnlpacC (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 4 Oct 2012 17:19:43 +0200
Received: from localhost (localhost [127.0.0.1])
        by zmc.proxad.net (Postfix) with ESMTP id 6587BA98D81;
        Thu,  4 Oct 2012 17:19:43 +0200 (CEST)
X-Virus-Scanned: amavisd-new at localhost
Received: from zmc.proxad.net ([127.0.0.1])
        by localhost (zmc.proxad.net [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id sVsiN56MFcWc; Thu,  4 Oct 2012 17:19:43 +0200 (CEST)
Received: from flexo.iliad.local (freebox.vlq16.iliad.fr [213.36.7.13])
        by zmc.proxad.net (Postfix) with ESMTPSA id 346A4A9A014;
        Thu,  4 Oct 2012 17:19:42 +0200 (CEST)
From:   Florian Fainelli <florian@openwrt.org>
To:     stern@rowland.harvard.edu
Cc:     linux-usb@vger.kernel.org, Florian Fainelli <florian@openwrt.org>,
        Ralf Baechle <ralf@linux-mips.org>, linux-mips@linux-mips.org,
        linux-kernel@vger.kernel.org
Subject: [PATCH 15/24 v2] MIPS: PNX8550: use OHCI platform driver
Date:   Thu,  4 Oct 2012 17:17:43 +0200
Message-Id: <1349363872-27004-16-git-send-email-florian@openwrt.org>
