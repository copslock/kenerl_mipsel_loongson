Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 23 Jul 2008 18:51:45 +0100 (BST)
Received: from fnoeppeil48.netpark.at ([217.175.205.176]:34283 "EHLO
	roarinelk.homelinux.net") by ftp.linux-mips.org with ESMTP
	id S28573978AbYGWRvn (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Wed, 23 Jul 2008 18:51:43 +0100
Received: (qmail 6206 invoked by uid 1000); 23 Jul 2008 19:51:42 +0200
Date:	Wed, 23 Jul 2008 19:51:42 +0200
From:	Manuel Lauss <mano@roarinelk.homelinux.net>
To:	linux-mips@linux-mips.org
Subject: [PATCH 4/8] Alchemy: RTC counter clocksource / clockevent support.
Message-ID: <20080723175142.GE5986@roarinelk.homelinux.net>
...
@@ -215,8 +94,59 @@ unsigned long calc_clock(void)
 	return cpu_speed;
 }
...
+	unsigned long t;
 	...
 	est_freq += 5000;    /* round */
@@ -225,41 +155,61 @@ void __init plat_time_init(void)
