Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 22 Aug 2012 03:26:03 +0200 (CEST)
Received: from [69.28.251.93] ([69.28.251.93]:37665 "EHLO b32.net"
        rhost-flags-FAIL-FAIL-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1903616Ab2HVBZo (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 22 Aug 2012 03:25:44 +0200
Received: (qmail 25964 invoked from network); 22 Aug 2012 01:25:39 -0000
Received: from unknown (HELO vps-1001064-677.cp.jvds.com) (127.0.0.1)
  by 127.0.0.1 with (DHE-RSA-AES128-SHA encrypted) SMTP; 22 Aug 2012 01:25:39 -0000
Received: by vps-1001064-677.cp.jvds.com (sSMTP sendmail emulation); Tue, 21 Aug 2012 18:25:39 -0700
...
Subject: [PATCH V3] usb: gadget: bcm63xx UDC driver
Date:   Tue, 21 Aug 2012 18:22:35 -0700
Message-Id: <5ff8f23aae05690ba89476c4924b9387@localhost>
User-Agent: vim 7.2
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
X-archive-position: 34336
...
---
 ...
 drivers/usb/gadget/bcm63xx_udc.c  | 2456 +++++++++++++++++++++++++++++++++++++
...
Fix dynamic linking verbiage in Kconfig help text
Abort gracefully if platform data is missing
Change ep0 logic to use a workqueue again
Rename update_* functions to bcm63xx_update_*
Fix handling of soft connect events sent from the wrong state
Add delays to prevent EMI warnings on host


diff --git a/drivers/usb/gadget/Kconfig b/drivers/usb/gadget/Kconfig
index 51ab5fd..663aae2 100644
--- a/drivers/usb/gadget/Kconfig
+++ b/drivers/usb/gadget/Kconfig
@@ -160,6 +160,18 @@ config USB_ATMEL_USBA
