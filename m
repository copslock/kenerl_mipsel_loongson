Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 07 Feb 2017 23:00:39 +0100 (CET)
Received: from smtp-out-no.shaw.ca ([64.59.134.13]:35183 "EHLO
        ...
        with ESMTP id S23992221AbdBGV7oYhQDC (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 7 Feb 2017 22:59:44 +0100
Received: from triton.mmayer.net ([70.71.160.251])
        by shaw.ca with SMTP
        id bDnZcMo5cVQuxbDnbcVsqL; Tue, 07 Feb 2017 14:59:43 -0700
...
Received: by triton.mmayer.net (Postfix, from userid 501)
        id B4C6333B35F9; Tue,  7 Feb 2017 13:59:41 -0800 (PST)
...
Subject: [PATCH v3 3/4] cpufreq: bmips-cpufreq: CPUfreq driver for Broadcom's BMIPS SoCs
Date:   Tue,  7 Feb 2017 13:58:55 -0800
Message-Id: <20170207215856.8999-4-code@mmayer.net>
X-Mailer: git-send-email 2.10.2
In-Reply-To: <20170207215856.8999-1-code@mmayer.net>
References: <20170207215856.8999-1-code@mmayer.net>
X-CMAE-Envelope: 
Return-Path: <mmayer@mmayer.net>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 56703
...
index 2078a0f..9f5a804 100644
--- a/drivers/cpufreq/Makefile
+++ b/drivers/cpufreq/Makefile
@@ -99,6 +99,7 @@ obj-$(CONFIG_POWERNV_CPUFREQ)		+= powernv-cpufreq.o
