Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 02 Nov 2017 17:23:37 +0100 (CET)
Received: from mx2.rt-rk.com ([89.216.37.149]:54727 "EHLO mail.rt-rk.com"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23993608AbdKBQXDii09t (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 2 Nov 2017 17:23:03 +0100
Received: from localhost (localhost [127.0.0.1])
        by mail.rt-rk.com (Postfix) with ESMTP id DA3F71A4AF5;
        Thu,  2 Nov 2017 17:22:56 +0100 (CET)
X-Virus-Scanned: amavisd-new at rt-rk.com
Received: from rtrkw774-lin.domain.local (rtrkw774-lin.domain.local [10.10.13.111])
        by mail.rt-rk.com (Postfix) with ESMTPSA id 56C441A4AD6;
        Thu,  2 Nov 2017 17:22:56 +0100 (CET)
...
Subject: [PATCH v7 2/5] irqchip/irq-goldfish-pic: Add Goldfish PIC driver
Date:   Thu,  2 Nov 2017 17:21:21 +0100
Message-Id: <1509639716-4787-3-git-send-email-aleksandar.markovic@rt-rk.com>
...
+	kfree(gfpic);
+out_err:
+	pr_err("Failed to initialize Goldfish PIC driver! errno = %d\n", ret);
+	return ret;
+}
+
