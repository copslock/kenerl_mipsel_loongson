Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 03 Aug 2008 18:42:04 +0100 (BST)
Received: from elvis.franken.de ([193.175.24.41]:18142 "EHLO elvis.franken.de")
	by ftp.linux-mips.org with ESMTP id S20038520AbYHCRl5 (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Sun, 3 Aug 2008 18:41:57 +0100
Received: from uucp (helo=solo.franken.de)
	by elvis.franken.de with local-bsmtp (Exim 3.36 #1)
	id 1KPhac-0004pW-00; Sun, 03 Aug 2008 19:41:54 +0200
Received: by solo.franken.de (Postfix, from userid 1000)
	id 985F61DA6F4; Sun,  3 Aug 2008 19:41:46 +0200 (CEST)
From:	Thomas Bogendoerfer <tsbogend@alpha.franken.de>
Subject: [PATCH] IP22/28: Switch over to RTC class driver
To:	linux-mips@linux-mips.org
cc:	ralf@linux-mips.org
Message-Id: <20080803174146.985F61DA6F4@solo.franken.de>
Date:	Sun,  3 Aug 2008 19:41:46 +0200 (CEST)
Return-Path: <tsbogend@alpha.franken.de>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 20078
...
+	res.end = res.start + sizeof(hpc3c0->rtcregs);
