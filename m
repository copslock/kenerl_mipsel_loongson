Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 04 Feb 2016 11:12:22 +0100 (CET)
Received: from down.free-electrons.com ([37.187.137.238]:37517 "EHLO
        mail.free-electrons.com" rhost-flags-OK-OK-OK-FAIL)
        by eddie.linux-mips.org with ESMTP id S27012046AbcBDKHeJXq0O (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 4 Feb 2016 11:07:34 +0100
Received: by mail.free-electrons.com (Postfix, from userid 110)
        id 411FF4208; Thu,  4 Feb 2016 11:07:34 +0100 (CET)
Received: from localhost.localdomain (AToulouse-657-1-20-139.w83-193.abo.wanadoo.fr [83.193.84.139])
        by mail.free-electrons.com (Postfix) with ESMTPSA id 026F51B68;
        Thu,  4 Feb 2016 11:07:29 +0100 (CET)
...
Subject: [PATCH v2 19/51] mtd: create an mtd_ooblayout_ops struct to ease ECC layout definition
Date:   Thu,  4 Feb 2016 11:06:42 +0100
Message-Id: <1454580434-32078-20-git-send-email-boris.brezillon@free-electrons.com>
...
index 14e46ca..dccd132 100644
--- a/drivers/mtd/mtdcore.c
+++ b/drivers/mtd/mtdcore.c
@@ -1016,52 +1016,15 @@ EXPORT_SYMBOL_GPL(mtd_read_oob);
...
@@ -1090,16 +1053,10 @@ int mtd_ooblayout_free(struct mtd_info *mtd, int section,
 	if (!mtd || section < 0)
 		return -EINVAL;
...
@@ -1398,6 +1355,126 @@ int mtd_ooblayout_count_eccbytes(struct mtd_info *mtd)
 }
