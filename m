Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 13 Sep 2007 15:53:01 +0100 (BST)
Received: from mo31.po.2iij.NET ([210.128.50.54]:48680 "EHLO mo31.po.2iij.net")
	by ftp.linux-mips.org with ESMTP id S20022250AbXIMOww (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Thu, 13 Sep 2007 15:52:52 +0100
Received: by mo.po.2iij.net (mo31) id l8DEpW5A001343; Thu, 13 Sep 2007 23:51:32 +0900 (JST)
Received: from localhost.localdomain (221.25.30.125.dy.iij4u.or.jp [125.30.25.221])
	by mbox.po.2iij.net (po-mbox301) id l8DEpQS5012705
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=NOT);
	Thu, 13 Sep 2007 23:51:27 +0900
Date:	Thu, 13 Sep 2007 23:51:26 +0900
From:	Yoichi Yuasa <yoichi_yuasa@tripeaks.co.jp>
To:	Ralf Baechle <ralf@linux-mips.org>
Cc:	yoichi_yuasa@tripeaks.co.jp, linux-mips@linux-mips.org
Subject: [PATCH][MIPS] add GT641xx IRQ routines
Message-Id: <20070913235126.65e142fb.yoichi_yuasa@tripeaks.co.jp>
In-Reply-To: <20070913122317.GB4961@linux-mips.org>
References: <20070912232750.645a980f.yoichi_yuasa@tripeaks.co.jp>
	<20070913122317.GB4961@linux-mips.org>
...
On Thu, 13 Sep 2007 13:23:17 +0100
...
--- mips-orig/arch/mips/Kconfig	2007-09-13 23:16:29.609438750 +0900
+++ mips/arch/mips/Kconfig	2007-09-13 23:13:39.810827000 +0900
@@ -50,6 +50,7 @@ config MIPS_COBALT
 	select HW_HAS_PCI
 	select I8259
 	select IRQ_CPU
+	select IRQ_GT641XX
...
@@ -775,6 +776,9 @@ config IRQ_MSP_CIC
 config IRQ_TXX9
 	bool
...
--- mips-orig/arch/mips/cobalt/irq.c	2007-09-13 23:16:29.717445500 +0900
+++ mips/arch/mips/cobalt/irq.c	2007-09-13 23:13:39.914833500 +0900
@@ -15,102 +15,48 @@
...
--- mips-orig/arch/mips/cobalt/rtc.c	2007-09-13 23:16:29.729446250 +0900
+++ mips/arch/mips/cobalt/rtc.c	2007-09-13 23:13:39.982837750 +0900
@@ -20,6 +20,7 @@
...
--- mips-orig/arch/mips/cobalt/serial.c	2007-09-13 23:16:29.741447000 +0900
+++ mips/arch/mips/cobalt/serial.c	2007-09-13 23:13:40.014839750 +0900
@@ -24,6 +24,7 @@
...
--- mips-orig/arch/mips/cobalt/setup.c	2007-09-13 23:16:29.753447750 +0900
+++ mips/arch/mips/cobalt/setup.c	2007-09-13 23:13:40.050842000 +0900
@@ -20,6 +20,7 @@
 #include <asm/gt64120.h>
...
--- mips-orig/arch/mips/kernel/Makefile	2007-09-13 23:16:29.765448500 +0900
+++ mips/arch/mips/kernel/Makefile	2007-09-13 23:13:40.082844000 +0900
...
+++ mips/arch/mips/kernel/irq-gt641xx.c	2007-09-13 23:23:35.592061000 +0900
@@ -0,0 +1,131 @@
+/*
...
--- mips-orig/arch/mips/pci/fixup-cobalt.c	2007-09-13 23:16:29.793450250 +0900
+++ mips/arch/mips/pci/fixup-cobalt.c	2007-09-13 23:13:40.214852250 +0900
@@ -18,6 +18,7 @@
 #include <asm/gt64120.h>
...
+++ mips/include/asm-mips/irq_gt641xx.h	2007-09-13 23:13:40.214852250 +0900
@@ -0,0 +1,60 @@
+/*
...
--- mips-orig/include/asm-mips/mach-cobalt/cobalt.h	2007-09-13 23:16:29.921458250 +0900
+++ mips/include/asm-mips/mach-cobalt/cobalt.h	2007-09-13 23:13:40.250854500 +0900
@@ -12,32 +12,6 @@
...
+++ mips/include/asm-mips/mach-cobalt/irq.h	2007-09-13 23:13:40.250854500 +0900
@@ -0,0 +1,58 @@
+/*
