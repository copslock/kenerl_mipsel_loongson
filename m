Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 02 May 2016 11:01:01 +0200 (CEST)
Received: from www.linutronix.de ([62.245.132.108]:36039 "EHLO
        Galois.linutronix.de" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27026721AbcEBJA6yhj1X (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 2 May 2016 11:00:58 +0200
Received: from p5492f9a0.dip0.t-ipconnect.de
        ([84.146.249.160] helo=nereus.tec.linutronix.de. ident=mdkuser)
        by Galois.linutronix.de with esmtpsa (TLS1.2:RSA_AES_128_CBC_SHA256:128)
        (Exim 4.80)
        (envelope-from <anna-maria@linutronix.de>)
        id 1ax9is-0001qr-6D; Mon, 02 May 2016 11:00:58 +0200
From:   Anna-Maria Gleixner <anna-maria@linutronix.de>
To:     linux-kernel@vger.kernel.org
Cc:     rt@linutronix.de, Anna-Maria Gleixner <anna-maria@linutronix.de>,
        Ralf Baechle <ralf@linux-mips.org>, linux-mips@linux-mips.org
Subject: [PATCH v2] MIPS: Remove no longer needed work_on_cpu() call
Date:   Mon,  2 May 2016 11:00:49 +0200
Message-Id: <1462179649-55112-1-git-send-email-anna-maria@linutronix.de>
