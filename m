Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 15 Nov 2017 04:13:33 +0100 (CET)
Received: from forward106j.mail.yandex.net ([5.45.198.249]:34785 "EHLO
        forward106j.mail.yandex.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23990405AbdKODNBJhMEf (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 15 Nov 2017 04:13:01 +0100
Received: from mxback1g.mail.yandex.net (mxback1g.mail.yandex.net [IPv6:2a02:6b8:0:1472:2741:0:8b7:162])
        by forward106j.mail.yandex.net (Yandex) with ESMTP id 4705018030BB;
        Wed, 15 Nov 2017 06:12:55 +0300 (MSK)
Received: from smtp1j.mail.yandex.net (smtp1j.mail.yandex.net [2a02:6b8:0:801::ab])
        by mxback1g.mail.yandex.net (nwsmtp/Yandex) with ESMTP id GTraFsx39e-CsmSAwPH;
        Wed, 15 Nov 2017 06:12:55 +0300
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=flygoat.com; s=mail; t=1510715575;
        bh=81yZVaZCiqiIne5KdHUeJC4qUcCTh7Y7Vcp2rgHgk90=;
        h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References;
        b=AeBGNUA/iWx7qBECtevgfB/PTVGudaMJ0RvCI2HsHd/r8ZPV0KpzwHylrFlI6qvO/
         mYvpS1tljkVR/0Vd0py3wrUT8FSRW4S+i4HA+sdgO0JgWgM8WZJwJXOYLklOvYPkCr
         sy/f3zaEQqljRZOYyPZip3bejESSLZtzdLZyHN2g=
Received: by smtp1j.mail.yandex.net (nwsmtp/Yandex) with ESMTPSA id sPMPJaqN4J-CpcGjnXg;
        Wed, 15 Nov 2017 06:12:53 +0300
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (Client certificate not present)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=flygoat.com; s=mail; t=1510715573;
        bh=81yZVaZCiqiIne5KdHUeJC4qUcCTh7Y7Vcp2rgHgk90=;
        h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References;
        b=Qhwv1MZdZG4/VjQgJOqDy3iModEFFecrIoNuJ1OREF0qPSoDSGe2eQhgCocWQszIU
         QRXppyvliVc+zoeY8CZM+FmLlNxoW07xcktHk8fOTy5gdFAVkVD4vMVDDfLVUUSMny
         s/hvqfQskivKb3F7Jr9rVZaWzC/rVFHUSz8xYVs4=
Authentication-Results: smtp1j.mail.yandex.net; dkim=pass header.i=@flygoat.com
From:   Jiaxun Yang <jiaxun.yang@flygoat.com>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, linux-kernel@vger.kernel.org,
        Jiaxun Yang <jiaxun.yang@flygoat.com>
Subject: [PATCH v3 2/4] MIPS: Loongson64: lemote-2f move ec_kb3310b.h to include dir and clean up
Date:   Wed, 15 Nov 2017 11:11:53 +0800
Message-Id: <20171115031155.643-2-jiaxun.yang@flygoat.com>
