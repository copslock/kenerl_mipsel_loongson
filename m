Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 13 Apr 2013 10:51:16 +0200 (CEST)
Received: from nbd.name ([46.4.11.11]:54268 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6819996Ab3DMIvLlExCi (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sat, 13 Apr 2013 10:51:11 +0200
From:   John Crispin <blogic@openwrt.org>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, John Crispin <blogic@openwrt.org>
Subject: [PATCH V2] MIPS: move mips_{set,get}_machine_name() to a more generic place
Date:   Sat, 13 Apr 2013 10:47:09 +0200
Message-Id: <1365842829-10768-1-git-send-email-blogic@openwrt.org>
X-Mailer: git-send-email 1.7.10.4
Return-Path: <blogic@openwrt.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 36121
