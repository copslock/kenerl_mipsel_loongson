Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 16 Jan 2015 04:47:43 +0100 (CET)
Received: from szxga03-in.huawei.com ([119.145.14.66]:24500 "EHLO
        szxga03-in.huawei.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27006154AbbAPDrlYMGtE (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 16 Jan 2015 04:47:41 +0100
Received: from 172.24.2.119 (EHLO szxeml407-hub.china.huawei.com) ([172.24.2.119])
        by szxrg03-dlp.huawei.com (MOS 4.4.3-GA FastPath queued)
        with ESMTP id BAL07399;
        Fri, 16 Jan 2015 11:47:11 +0800 (CST)
Received: from localhost.localdomain (10.175.100.166) by
 szxeml407-hub.china.huawei.com (10.82.67.94) with Microsoft SMTP Server id
 14.3.158.1; Fri, 16 Jan 2015 11:46:53 +0800
...
Date:   Fri, 16 Jan 2015 09:44:00 +0800
Message-ID: <1421372666-12288-3-git-send-email-wangyijing@huawei.com>
X-Mailer: git-send-email 1.7.1
In-Reply-To: <1421372666-12288-1-git-send-email-wangyijing@huawei.com>
References: <1421372666-12288-1-git-send-email-wangyijing@huawei.com>
MIME-Version: 1.0
Content-Type: text/plain
X-Originating-IP: [10.175.100.166]
X-CFilter-Loop: Reflected
X-Mirapoint-Virus-RAPID-Raw: score=unknown(0),
        refid=str=0001.0A020206.54B889C2.0138,ss=1,re=0.001,recu=0.000,reip=0.000,cl=1,cld=1,fgs=0,
        ip=0.0.0.0,
        so=2013-05-26 15:14:31,
        dmn=2013-03-21 17:37:32
X-Mirapoint-Loop-Id: 806736200eca051b9b2bdac3f130f77b
Return-Path: <wangyijing@huawei.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 45141
