Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 20 Feb 2006 16:28:06 +0000 (GMT)
Received: from mba.ocn.ne.jp ([210.190.142.172]:63200 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S8133566AbWBTQ1v (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Mon, 20 Feb 2006 16:27:51 +0000
Received: from localhost (p8134-ipad206funabasi.chiba.ocn.ne.jp [222.145.82.134])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 576738BEC; Tue, 21 Feb 2006 01:34:45 +0900 (JST)
Date:	Tue, 21 Feb 2006 01:34:35 +0900 (JST)
Message-Id: <20060221.013435.104641385.anemo@mba.ocn.ne.jp>
...
Note that there is still some sparse warnings with xlate_dirent().  It
would be better rewritten using __get_user/__put_user or filldir
callback scheme.

Signed-off-by: Atsushi Nemoto <anemo@mba.ocn.ne.jp>

diff --git a/arch/mips/kernel/linux32.c b/arch/mips/kernel/linux32.c
index 5f68b22..3ca30f3 100644
...
+asmlinkage int sys_truncate64(const char __user *path, unsigned int high,
 ...
 {
 	if ((int)high < 0)
@@ -189,12 +189,12 @@ xlate_dirent(void *dirent64, void *diren
 }
 
 asmlinkage long
-sys32_getdents(unsigned int fd, void * dirent32, unsigned int count)
+sys32_getdents(unsigned int fd, void __user * dirent32, unsigned int count)
 {
 	long n;
-	void *dirent64;
+	void __user *dirent64;
 
-	dirent64 = (void *)((unsigned long)(dirent32 + (sizeof(long) - 1)) & ~(sizeof(long) - 1));
+	dirent64 = (void __user *)((unsigned long)(dirent32 + (sizeof(long) - 1)) & ~(sizeof(long) - 1));
 	if ((n = sys_getdents(fd, dirent64, count - (dirent64 - dirent32))) < 0)
 		return(n);
 	xlate_dirent(dirent64, dirent32, n);
@@ -204,7 +204,7 @@ sys32_getdents(unsigned int fd, void * d
 asmlinkage int old_readdir(unsigned int fd, void * dirent, unsigned int count);
 
 asmlinkage int
-sys32_readdir(unsigned int fd, void * dirent32, unsigned int count)
+sys32_readdir(unsigned int fd, void __user * dirent32, unsigned int count)
 {
 	int n;
