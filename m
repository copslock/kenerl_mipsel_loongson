Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 05 Dec 2013 08:42:15 +0100 (CET)
Received: from mail-pd0-f169.google.com ([209.85.192.169]:60545 "EHLO
        mail-pd0-f169.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6831301Ab3LEHlOUUTsJ (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 5 Dec 2013 08:41:14 +0100
Received: by mail-pd0-f169.google.com with SMTP id v10so24126006pde.14
        for <multiple recipients>; Wed, 04 Dec 2013 23:41:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=sender:from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=baaJyzsII2aoP5VnvqeUZqODbFwsF325clzOMy5vrdU=;
        b=
X-Received: by 10.66.179.143 with SMTP id dg15mr87227450pac.52.1386229267829;
        Wed, 04 Dec 2013 23:41:07 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPSA id vk17sm9636837pab.5.2013.12.04.23.41.00
        for <multiple recipients>
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Wed, 04 Dec 2013 23:41:06 -0800 (PST)
...
Subject: [PATCH V14 04/12] MIPS: Loongson: Add UEFI-like firmware interface support
Date:   Thu,  5 Dec 2013 15:39:54 +0800
Message-Id: <1386229203-15129-5-git-send-email-chenhc@lemote.com>
