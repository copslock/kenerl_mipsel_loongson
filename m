Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 03 Aug 2017 01:02:56 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:50287 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994858AbdHBW7HmcYDW (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 3 Aug 2017 00:59:07 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id 45AB2461D7;
        Thu,  3 Aug 2017 00:59:02 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter02.heinlein-hosting.de (spamfilter02.heinlein-hosting.de [80.241.56.116]) (amavisd-new, port 10030)
        with ESMTP id LCuDyKykg0nH; Thu,  3 Aug 2017 00:59:00 +0200 (CEST)
...
Subject: [PATCH v8 09/16] MIPS: lantiq: remove ltq_reset_cause() and ltq_boot_select()
Date:   Thu,  3 Aug 2017 00:57:10 +0200
Message-Id: <20170802225717.24408-10-hauke@hauke-m.de>
