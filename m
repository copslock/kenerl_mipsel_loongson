Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 30 Sep 2010 11:11:30 +0200 (CEST)
Received: from mail-pw0-f49.google.com ([209.85.160.49]:63356 "EHLO
        mail-pw0-f49.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491192Ab0I3JKK (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 30 Sep 2010 11:10:10 +0200
Received: by pwi5 with SMTP id 5so597450pwi.36
        for <multiple recipients>; Thu, 30 Sep 2010 02:10:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=K8uU/KU+dWtbb5WGbU7jm/K1hro8Egrh1ccY4b0rdSg=;
        b=LfUP6GwTp+2oCyLrFndU01G5Y5PFn/gHJK+QtJD0eLkzbC7zteF0TS+iu5Q8mZBOC4
         1v9JfCTWe0urVSX3Zf4CmHmer7KO/8L37bh29mLahjw+Drb4CNTsXR5PjJ+JGisVspGd
         XusxMbvQZ7v7imkMspJSwkHe1zvC99vRg4TgE=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=R/YXV3X8LM/YVLBIYJW7++AHSEg43VXl2edRzxcxAxosb0EHD9Nv20c5u2ykz4C4t9
         sqjL7vLLjnUIpaaBI+YV+9aJbhOYrvnRkto8NultA9XvmSrSBQtMLRMnM9W5yp7HUa08
         hUfX470IeVjKofb12MP9RK3JI9701KKtG0JBw=
Received: by 10.114.12.15 with SMTP id 15mr3730219wal.134.1285837797186;
        Thu, 30 Sep 2010 02:09:57 -0700 (PDT)
Received: from localhost.localdomain ([210.13.118.102])
        by mx.google.com with ESMTPS id c10sm16210348wam.1.2010.09.30.02.09.45
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Thu, 30 Sep 2010 02:09:49 -0700 (PDT)
From:   Deng-Cheng Zhu <dengcheng.zhu@gmail.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     a.p.zijlstra@chello.nl, paulus@samba.org, mingo@elte.hu,
        acme@redhat.com, jamie.iles@picochip.com, dengcheng.zhu@gmail.com
Subject: [PATCH v7 6/6] MIPS: add support for hardware performance events (mipsxx)
Date:   Thu, 30 Sep 2010 17:09:20 +0800
Message-Id: <1285837760-10362-7-git-send-email-dengcheng.zhu@gmail.com>
...
---
 arch/mips/include/asm/pmu.h          |   13 +
 arch/mips/kernel/perf_event.c        |    7 +
 arch/mips/kernel/perf_event_mipsxx.c | 1020 ++++++++++++++++++++++++++++++++++
 3 files changed, 1040 insertions(+), 2 deletions(-)
...
@@ -410,6 +412,7 @@ static int validate_group(struct perf_event *event)
...
@@ -487,6 +490,8 @@ handle_associated_event(struct cpu_hw_events *cpuc,
