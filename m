Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 09 Apr 2009 18:49:56 +0100 (BST)
Received: from fnoeppeil48.netpark.at ([217.175.205.176]:55965 "EHLO
	roarinelk.homelinux.net") by ftp.linux-mips.org with ESMTP
	id S20025055AbZDIRtZ (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Thu, 9 Apr 2009 18:49:25 +0100
Received: (qmail 2409 invoked from network); 9 Apr 2009 19:49:24 +0200
Received: from flagship.roarinelk.net (HELO localhost.localdomain) (192.168.0.197)
  by 192.168.0.1 with SMTP; 9 Apr 2009 19:49:24 +0200
From:	Manuel Lauss <mano@roarinelk.homelinux.net>
To:	Linux-MIPS <linux-mips@linux-mips.org>
Cc:	Manuel Lauss <mano@roarinelk.homelinux.net>,
	Florian Fainelli <florian@openwrt.org>
Subject: [PATCH v3 1/2] Alchemy: rewrite GPIO support.
Date:	Thu,  9 Apr 2009 19:49:22 +0200
Message-Id: <1239299363-28762-1-git-send-email-mano@roarinelk.homelinux.net>
X-Mailer: git-send-email 1.6.2
Return-Path: <mano@roarinelk.homelinux.net>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 22317
