Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 18 May 2006 12:00:58 +0200 (CEST)
Received: from rtsoft3.corbina.net ([85.21.88.6]:31716 "EHLO
	buildserver.ru.mvista.com") by ftp.linux-mips.org with ESMTP
	id S8133864AbWERKA3 (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Thu, 18 May 2006 12:00:29 +0200
Received: from diimka-laptop.dev.rtsoft.ru ([10.150.0.9])
	by buildserver.ru.mvista.com (8.11.6/8.11.6) with ESMTP id k4IA0Qs01941;
	Thu, 18 May 2006 15:00:26 +0500
Subject: [PATCH] NEC EMMA2RH support
...
Date:	Thu, 18 May 2006 14:00:23 +0400
Message-Id: <1147946423.8223.4.camel@diimka-laptop>
Mime-Version: 1.0
...
Here is the patch against current linux-mips tree to support NEC's
EMMA2RH Mark-eins board (R5500-based). Please apply
...
Signed-off-by: dmitry pervushin  <dpervushin@ru.mvista.com>
 ...
 arch/mips/emma2rh/markeins/Makefile       |   14 
 arch/mips/emma2rh/markeins/int-handler.S  |   88 ++
 arch/mips/emma2rh/markeins/irq.c          |  112 ++
 ...
 arch/mips/emma2rh/markeins/setup.c        |  208 +++++
 arch/mips/pci/Makefile                    |    1 
 arch/mips/pci/fixup-emma2rh.c             |  101 ++
 ...
 24 files changed, 3136 insertions(+), 2 deletions(-)
	
Index: linux-malta/arch/mips/Kconfig
===================================================================
--- linux-malta.orig/arch/mips/Kconfig
+++ linux-malta/arch/mips/Kconfig
@@ -462,6 +462,19 @@ config PMC_YOSEMITE
...
+
 config SGI_IP22
 	...
 	select ARC
@@ -809,6 +822,11 @@ config SOC_AU1X00
...
Index: linux-malta/arch/mips/Makefile
===================================================================
...
+# Generate <asm/offset.h
 ...
 # own ...
Index: linux-malta/arch/mips/configs/emma2rh_defconfig
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/configs/emma2rh_defconfig
@@ -0,0 +1,1126 @@
+#
...
Index: linux-malta/arch/mips/emma2rh/common/Makefile
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/common/Makefile
@@ -0,0 +1,13 @@
+#
...
Index: linux-malta/arch/mips/emma2rh/common/irq.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/common/irq.c
@@ -0,0 +1,108 @@
+/*
...
+	}
+}
Index: linux-malta/arch/mips/emma2rh/common/irq_emma2rh.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/common/irq_emma2rh.c
@@ -0,0 +1,135 @@
+/*
...
+	emma2rh_out32(reg_index, reg_value & ~reg_bitmask);
+}
Index: linux-malta/arch/mips/emma2rh/common/prom.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/common/prom.c
@@ -0,0 +1,77 @@
+/*
...
+{
+}
Index: linux-malta/arch/mips/emma2rh/markeins/Makefile
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/markeins/Makefile
@@ -0,0 +1,14 @@
+#
...
+	jal	do_IRQ
+	j	ret_from_irq
Index: linux-malta/arch/mips/emma2rh/markeins/irq.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/markeins/irq.c
@@ -0,0 +1,112 @@
+/*
...
+}
Index: linux-malta/arch/mips/emma2rh/markeins/irq_markeins.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/markeins/irq_markeins.c
@@ -0,0 +1,198 @@
+/*
...
+	emma2rh_out32(EMMA2RH_GPIO_INT_MASK, reg);
+}
Index: linux-malta/arch/mips/emma2rh/markeins/led.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/markeins/led.c
@@ -0,0 +1,60 @@
+/*
...
+	markeins_led(str);
+}
Index: linux-malta/arch/mips/emma2rh/markeins/platform.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/emma2rh/markeins/platform.c
@@ -0,0 +1,170 @@
+/*
...
Index: linux-malta/arch/mips/pci/Makefile
===================================================================
--- linux-malta.orig/arch/mips/pci/Makefile
+++ linux-malta/arch/mips/pci/Makefile
...
Index: linux-malta/arch/mips/pci/fixup-emma2rh.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/pci/fixup-emma2rh.c
@@ -0,0 +1,101 @@
+/*
...
+	return 0;
+}
Index: linux-malta/arch/mips/pci/ops-emma2rh.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/pci/ops-emma2rh.c
@@ -0,0 +1,186 @@
+/*
...
+};
Index: linux-malta/arch/mips/pci/pci-emma2rh.c
===================================================================
--- /dev/null
+++ linux-malta/arch/mips/pci/pci-emma2rh.c
@@ -0,0 +1,90 @@
+/*
...
Index: linux-malta/drivers/pci/pci.ids
===================================================================
--- linux-malta.orig/drivers/pci/pci.ids
+++ linux-malta/drivers/pci/pci.ids
@@ -1667,6 +1667,7 @@
...
Index: linux-malta/include/asm-mips/bootinfo.h
===================================================================
--- linux-malta.orig/include/asm-mips/bootinfo.h
+++ linux-malta/include/asm-mips/bootinfo.h
@@ -215,6 +215,12 @@
...
+
 ...
 const char *get_system_type(void);
Index: linux-malta/include/asm-mips/emma2rh/emma2rh.h
===================================================================
--- /dev/null
+++ linux-malta/include/asm-mips/emma2rh/emma2rh.h
@@ -0,0 +1,332 @@
+/*
...
Index: linux-malta/include/asm-mips/emma2rh/markeins.h
===================================================================
--- /dev/null
+++ linux-malta/include/asm-mips/emma2rh/markeins.h
@@ -0,0 +1,76 @@
+/*
...
Index: linux-malta/include/asm-mips/mach-emma2rh/irq.h
===================================================================
--- /dev/null
+++ linux-malta/include/asm-mips/mach-emma2rh/irq.h
@@ -0,0 +1,13 @@
+/*
...
Index: linux-malta/include/linux/pci_ids.h
===================================================================
--- linux-malta.orig/include/linux/pci_ids.h
+++ linux-malta/include/linux/pci_ids.h
@@ -602,6 +602,7 @@
