Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 22 May 2009 21:27:17 +0100 (BST)
Received: from fg-out-1718.google.com ([72.14.220.155]:45212 "EHLO
	...
	with ESMTP id S20022517AbZEVUZ7 (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Fri, 22 May 2009 21:25:59 +0100
Received: by fg-out-1718.google.com with SMTP id d23so216876fga.9
        for <linux-mips@linux-mips.org>; Fri, 22 May 2009 13:25:58 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlemail.com; s=gamma;
        h=domainkey-signature:received:received:sender:from:to:cc:subject
         :date:message-id:x-mailer;
        bh=CT/G7rJO8PQOOq32eYzOXe4KkxE7UDokwSUISbhVqM0=;
        b=R2fawPBLfMnZ11b32qeW7o9rqImLVNJDp9RDL2lM7pnuyFNplRNVkRtH5l/Fw1jPUw
         cVOdmbYFrGS1K48exFY5KdFXxxCKGnV5HBk6/6MtdiPaMdY6p8faSbS8yEGxFCnr2T/B
         gNXXHfMw42ZpYL4ec/+lGe1ZTtzmldLrRsnOM=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=googlemail.com; s=gamma;
        h=sender:from:to:cc:subject:date:message-id:x-mailer;
        b=Z+3ZhGZpMoulHJEiwmzbL70dumxB2gwZxilB5kBGTHHFcQpSbJ338Pfk/cCWUMr8on
         iCqwiMBtQGnyrutWn6qhFr9gM8hgvsgiZz83+gRfWA4Yv1k8hAA/+022y/9Rx0yjFsJk
         AepdXoiUJiSdM1PWfTDVxEzpCPHvuwvgmAfjs=
Received: by 10.86.26.11 with SMTP id 11mr3434328fgz.45.1243023957844;
        Fri, 22 May 2009 13:25:57 -0700 (PDT)
Received: from localhost.localdomain (fnoeppeil48.netpark.at [217.175.205.176])
        by mx.google.com with ESMTPS id e20sm1522973fga.0.2009.05.22.13.25.55
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Fri, 22 May 2009 13:25:56 -0700 (PDT)
From:	Manuel Lauss <mano@roarinelk.homelinux.net>
To:	Linux-MIPS <linux-mips@linux-mips.org>
Cc:	Manuel Lauss <mano@roarinelk.homelinux.net>
Subject: [PATCH 1/4] Alchemy: extended DB1200 board support.
Date:	Fri, 22 May 2009 22:25:50 +0200
Message-Id: <1243023953-10401-1-git-send-email-mano@roarinelk.homelinux.net>
X-Mailer: git-send-email 1.6.3.1
Return-Path: <manuel.lauss@googlemail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 22934
...
---
 ...
 arch/mips/alchemy/devboards/db1200/platform.c    |  503 +++++++
 ...
 13 files changed, 1885 insertions(+), 829 deletions(-)
