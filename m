Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 28 Nov 2014 15:06:08 +0100 (CET)
Received: from mail-wg0-f43.google.com ([74.125.82.43]:54745 "EHLO
        mail-wg0-f43.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27007480AbaK1OGF4kP0q (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 28 Nov 2014 15:06:05 +0100
Received: by mail-wg0-f43.google.com with SMTP id l18so8997168wgh.16
        for <multiple recipients>; Fri, 28 Nov 2014 06:06:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=sender:from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=Jw8pB1KSqS7LBdDQZ+ohQueo3XkbX+SQWGLxM+1mVc4=;
        b=
X-Received: by 10.194.77.142 with SMTP id s14mr70718246wjw.94.1417183560758;
        Fri, 28 Nov 2014 06:06:00 -0800 (PST)
Received: from cizrna.lan (37-48-38-127.tmcz.cz. [37.48.38.127])
        by mx.google.com with ESMTPSA id gi5sm15151428wjd.26.2014.11.28.06.05.56
        for <multiple recipients>
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 28 Nov 2014 06:05:59 -0800 (PST)
...
Subject: [PATCH v6 7/7] clk: Add floor and ceiling constraints to clock rates
Date:   Fri, 28 Nov 2014 15:03:28 +0100
Message-Id: <1417183461-8210-8-git-send-email-tomeu.vizoso@collabora.com>
X-Mailer: git-send-email 1.9.3
In-Reply-To: <1417183461-8210-1-git-send-email-tomeu.vizoso@collabora.com>
References: <1417183461-8210-1-git-send-email-tomeu.vizoso@collabora.com>
Return-Path: <tomeu.vizoso@gmail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 44513
...
@@ -397,6 +398,7 @@ static long _freq_tbl_determine_rate(struct clk_hw *hw,
 }
...
@@ -405,6 +407,7 @@ static long clk_rcg_determine_rate(struct clk_hw *hw, unsigned long rate,
 }
...
@@ -413,6 +416,7 @@ static long clk_dyn_rcg_determine_rate(struct clk_hw *hw, unsigned long rate,
 }
