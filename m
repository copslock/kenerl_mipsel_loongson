Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Aug 2017 00:59:34 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:39094 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995179AbdHHWxq7CrKu (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 9 Aug 2017 00:53:46 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id C7BF945A36;
        Wed,  9 Aug 2017 00:53:40 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by hefe.heinlein-support.de (hefe.heinlein-support.de [91.198.250.172]) (amavisd-new, port 10030)
        with ESMTP id 00TF2HZ8rx-9; Wed,  9 Aug 2017 00:53:38 +0200 (CEST)
...
Subject: [PATCH v9 14/16] phy: Add an USB PHY driver for the Lantiq SoCs using the RCU module
Date:   Wed,  9 Aug 2017 00:52:45 +0200
Message-Id: <20170808225247.32266-15-hauke@hauke-m.de>
