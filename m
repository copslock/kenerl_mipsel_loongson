Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 14 Nov 2016 03:04:22 +0100 (CET)
Received: from shadbolt.e.decadent.org.uk ([88.96.1.126]:37512 "EHLO
        shadbolt.e.decadent.org.uk" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23990720AbcKNCEPTqNgO (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 14 Nov 2016 03:04:15 +0100
Received: from [2a02:8011:400e:2:6f00:88c8:c921:d332] (helo=deadeye)
        by shadbolt.decadent.org.uk with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.84_2)
        (envelope-from <ben@decadent.org.uk>)
        id 1c66d2-0005fG-J9; Mon, 14 Nov 2016 02:04:12 +0000
Received: from ben by deadeye with local (Exim 4.87)
        (envelope-from <ben@decadent.org.uk>)
        id 1c66d1-0000Oe-Lc; Mon, 14 Nov 2016 02:04:11 +0000
...
Message-ID: <lsq.1479082460.145186447@decadent.org.uk>
X-Mailer: LinuxStableQueue (scripts by bwh)
Subject: [PATCH 3.16 100/346] MIPS: RM7000: Double locking bug in
 rm7k_tc_disable()
