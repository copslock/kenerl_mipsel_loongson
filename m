Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 16 May 2008 17:30:00 +0100 (BST)
Received: from sj-iport-3.cisco.com ([171.71.176.72]:55363 "EHLO
	sj-iport-3.cisco.com") by ftp.linux-mips.org with ESMTP
	id S20034121AbYEPQ3x (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 16 May 2008 17:29:53 +0100
X-IronPort-AV: E=Sophos;i="4.27,498,1204531200"; 
   d="scan'208";a="68960552"
Received: from sj-dkim-2.cisco.com ([171.71.179.186])
  by sj-iport-3.cisco.com with ESMTP; 16 May 2008 09:29:33 -0700
Received: from sj-core-1.cisco.com (sj-core-1.cisco.com [171.71.177.237])
	by sj-dkim-2.cisco.com (8.12.11/8.12.11) with ESMTP id m4GGTXK5003668
	for <linux-mips@linux-mips.org>; Fri, 16 May 2008 09:29:33 -0700
Received: from cliff.cisco.com (cliff.cisco.com [171.69.11.141])
	by sj-core-1.cisco.com (8.13.8/8.13.8) with ESMTP id m4GGTXvO021308
	for <linux-mips@linux-mips.org>; Fri, 16 May 2008 16:29:33 GMT
Received: from cuplxvomd02.corp.sa.net ([64.101.20.155]) by cliff.cisco.com (8.6.12/8.6.5) with ESMTP id QAA07251 for <linux-mips@linux-mips.org>; Fri, 16 May 2008 16:29:30 GMT
Message-ID: <482DB65A.2050107@cisco.com>
Date:	Fri, 16 May 2008 09:29:14 -0700
From:	David VomLehn <dvomlehn@cisco.com>
Reply-To: dvomlehn@cisco.com
User-Agent: Thunderbird 2.0.0.12 (X11/20080226)
MIME-Version: 1.0
To:	linux-mips@linux-mips.org
Subject: [Patch 1/1][MIPS] Advanced kernel stack backtrace v2
Content-Type: text/plain; charset=ISO-8859-1; format=flowed
Content-Transfer-Encoding: 7bit
DKIM-Signature:	v=1; a=rsa-sha256; q=dns/txt; l=136544; t=1210955373; x=1211819373;
	c=relaxed/simple; s=sjdkim2002;
	h=Content-Type:From:Subject:Content-Transfer-Encoding:MIME-Version;
	d=cisco.com; i=dvomlehn@cisco.com;
	z=From:=20David=20VomLehn=20<dvomlehn@cisco.com>
	|Subject:=20[Patch=201/1][MIPS]=20Advanced=20kernel=20stack
	=20backtrace=20v2
	|Sender:=20;
	bh=nJYcdo57rQ4AM0a0FJC/VYDOrCYB06PZHdutupYU78Q=;
	b=ZeLFL36xq+sdKsxzZ2L+NP6r4c5MNTA+ic8Hj3SPByDmZCUi6a+0B9Uo5T
	yhWMr/nN/B08zlNPdKN9tPKf6+U98K6RNCD7NmdvraG/5UR87zl50HwWqdYn
	pGCgmHx+Wi;
...
+static int find_return_lookup_bounded(struct simple_bt *bt, unsigned long start,
+	unsigned long end);
+
...
+ *		errno value if not.
+ */
+static int back_up_from_sp_decrement(struct simple_bt *bt, unsigned long sp_dec)
+{
+	int		result = 0;
+	unsigned long		ip;
+	unsigned	i;
...
+
+/*
+ * Find the end of the function by o32 ABI rules. If the function was not found,
...
+	.globl	work_notifysig
 work_notifysig:				# deal with pending signals and
 	...
 	move	a0, sp
@@ -166,6 +172,7 @@ work_notifysig:				# deal with pending s
...
+ * which be treated as a normal termination, or a negative errno value. Negative
