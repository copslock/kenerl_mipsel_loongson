Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 04 Jan 2014 23:24:04 +0100 (CET)
Received: from [195.154.112.97] ([195.154.112.97]:39799 "EHLO hall.aurel32.net"
        rhost-flags-FAIL-FAIL-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6825887AbaADWXrXpx0L (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sat, 4 Jan 2014 23:23:47 +0100
Received: from aurel32 by hall.aurel32.net with local (Exim 4.80)
        (envelope-from <aurelien@aurel32.net>)
        id 1VzZdB-0007Zh-SV; Sat, 04 Jan 2014 23:23:45 +0100
Date:   Sat, 4 Jan 2014 23:23:45 +0100
...
Subject: Re: [PATCH V15 04/12] MIPS: Loongson: Add UEFI-like firmware
 interface support
Message-ID: <20140104222345.GA20706@hall.aurel32.net>
...
In-Reply-To: <1387109676-540-5-git-send-email-chenhc@lemote.com>
