Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 05 Oct 2016 19:24:55 +0200 (CEST)
Received: from mailapp02.imgtec.com ([217.156.133.132]:22500 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-FAIL)
        by eddie.linux-mips.org with ESMTP id S23992544AbcJERWaoSHUu (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 5 Oct 2016 19:22:30 +0200
Received: from HHMAIL03.hh.imgtec.org (unknown [10.44.0.21])
        by Forcepoint Email with ESMTPS id BF10C8F08FE7A;
        Wed,  5 Oct 2016 18:22:21 +0100 (IST)
...
Subject: [PATCH v3 14/18] MIPS: generic: Introduce generic DT-based board support
Date:   Wed, 5 Oct 2016 18:18:20 +0100
Message-ID: <20161005171824.18014-15-paul.burton@imgtec.com>
...
Changes in v2:
- Select MIPS_L1_CACHE_SHIFT_7 to be conservative.
- Don't warn about SMP init failure - register_up_smp_ops will always succeed for SMP kernels & we don't care if it fails on UP kernels.
- Improve generic_defconfig & 64 bit config fragments.
- Only probe CPU interrupt controller from code if not listed in DT. Some platforms include it in their DT & need to reference it. Others don't, but we still need the driver probed for the GIC to work as expected.
