Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 05 Sep 2007 07:58:44 +0100 (BST)
Received: from hall.aurel32.net ([88.191.38.19]:4794 "EHLO hall.aurel32.net")
	by ftp.linux-mips.org with ESMTP id S20022126AbXIEG6c (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Wed, 5 Sep 2007 07:58:32 +0100
Received: from aurel32 by hall.aurel32.net with local (Exim 4.63)
	(envelope-from <aurel32@hall.aurel32.net>)
	id 1ISoqI-0004Rb-A0
	for linux-mips@linux-mips.org; Wed, 05 Sep 2007 08:58:26 +0200
Date:	Wed, 5 Sep 2007 08:58:26 +0200
From:	Aurelien Jarno <aurelien@aurel32.net>
To:	linux-mips@linux-mips.org
Subject: [PATCH 1/2][MIPS] Move CFE code into arch/mips/fw/cfe
Message-ID: <20070905065826.GB16802@hall.aurel32.net>
...
---
 ...
 arch/mips/fw/cfe/cfe_api.c          |  502 +++++++++++++++++++++++++++++++++++
 arch/mips/fw/cfe/cfe_api_int.h      |  152 +++++++++++
 ...
 include/asm-mips/fw/cfe/cfe_api.h   |  185 +++++++++++++
 include/asm-mips/fw/cfe/cfe_error.h |   85 ++++++
 16 files changed, 941 insertions(+), 931 deletions(-)

diff --git a/arch/mips/Kconfig b/arch/mips/Kconfig
index d7d5153..6fe214c 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -687,6 +687,9 @@ config ARCH_MAY_HAVE_PC_FDC
 config BOOT_RAW
 	bool
