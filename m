Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 29 Nov 2018 09:45:17 +0100 (CET)
Received: from mail-pg1-x542.google.com ([IPv6:2607:f8b0:4864:20::542]:34355
        "EHLO mail-pg1-x542.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23994600AbeK2IpGMW71m (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 29 Nov 2018 09:45:06 +0100
Received: by mail-pg1-x542.google.com with SMTP id 17so624711pgg.1
        for <linux-mips@linux-mips.org>; Thu, 29 Nov 2018 00:45:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=PdWdoxrS5XmB62Urw6C8xUgVXwV8awHDbnhtNUEiP7o=;
        b=DAZPrLFH572+F3PG2qDG/ypr+arjWGcgrRV9K07zU7GPsPquWwyL6yyCPhDFCgOrHv
         +RmlwLFh7jlD03kUSEqXdAXZMfBTR4xlOCqEy6N0I0+RV42YqH6jKW7P1gBYwMAYWN+/
         oj+Kw20wZ/JO6rNyW8yWBjsTNd+nxc/lV5has=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=PdWdoxrS5XmB62Urw6C8xUgVXwV8awHDbnhtNUEiP7o=;
        b=
X-Gm-Message-State: AA+aEWaWrxFcYaIUKOpMGJ2f15q6aKBYB2mXpUvrptDeNDL7/hw9GX48
        bBgkQq9Xki9Malk/a7DkulbM0Rg/DvE=
X-Google-Smtp-Source: AFSGD/WyuzIW85QwylbBSwdn/rO6gKoPvV8AL8xlel8a1tA7lmklGi24U+wZLWRghN4SEuEI6q1GNA==
X-Received: by 2002:a63:dc0c:: with SMTP id s12mr496676pgg.398.1543481103434;
        Thu, 29 Nov 2018 00:45:03 -0800 (PST)
Received: from qualcomm-HP-ZBook-14-G2.qualcomm.com (blr-bdr-fw-01_globalnat_allzones-outside.qualcomm.com. [103.229.18.19])
        by smtp.gmail.com with ESMTPSA id 73-v6sm2322683pfl.142.2018.11.29.00.44.55
...
Subject: [PATCH v3 6/6] mips: generate uapi header and system call table files
Date:   Thu, 29 Nov 2018 14:13:36 +0530
Message-Id: <1543481016-18500-7-git-send-email-firoz.khan@linaro.org>
...
---
 ...
 11 files changed, 150 insertions(+), 2582 deletions(-)
...
index f32caaf..1e9353a 100644
--- a/arch/mips/kernel/ftrace.c
+++ b/arch/mips/kernel/ftrace.c
@@ -413,8 +413,8 @@ unsigned long __init arch_syscall_addr(int nr)
