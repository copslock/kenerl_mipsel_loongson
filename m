Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 12 Oct 2015 12:25:15 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.59.15.196]:62711 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S27009330AbbJLKZNTNhxf (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 12 Oct 2015 12:25:13 +0200
Received: from KLMAIL01.kl.imgtec.org (unknown [192.168.5.35])
        by Websense Email Security Gateway with ESMTPS id 9740ED88C222F;
        Mon, 12 Oct 2015 11:25:02 +0100 (IST)
Received: from LEMAIL01.le.imgtec.org (192.168.152.62) by
 KLMAIL01.kl.imgtec.org (192.168.5.35) with Microsoft SMTP Server (TLS) id
 14.3.195.1; Mon, 12 Oct 2015 11:25:05 +0100
Received: from mchandras-linux.le.imgtec.org (192.168.154.37) by
 LEMAIL01.le.imgtec.org (192.168.152.62) with Microsoft SMTP Server (TLS) id
 14.3.210.2; Mon, 12 Oct 2015 11:25:04 +0100
From:   Markos Chandras <markos.chandras@imgtec.com>
To:     <linux-mips@linux-mips.org>
CC:     Alex Smith <alex.smith@imgtec.com>, <linux-kernel@vger.kernel.org>,
        Markos Chandras <markos.chandras@imgtec.com>
Subject: [PATCH v2 3/3] MIPS: VDSO: Add implementations of gettimeofday() and clock_gettime()
Date:   Mon, 12 Oct 2015 11:24:56 +0100
Message-ID: <1444645496-32046-1-git-send-email-markos.chandras@imgtec.com>
X-Mailer: git-send-email 2.6.1
In-Reply-To: <1443435141-17197-1-git-send-email-markos.chandras@imgtec.com>
References: <1443435141-17197-1-git-send-email-markos.chandras@imgtec.com>
MIME-Version: 1.0
