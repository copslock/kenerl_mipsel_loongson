Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 20 Aug 2017 00:23:11 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:37883 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994961AbdHSWUIboA5i (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 20 Aug 2017 00:20:08 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id E491942953;
        Sun, 20 Aug 2017 00:20:02 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter02.heinlein-hosting.de (spamfilter02.heinlein-hosting.de [80.241.56.116]) (amavisd-new, port 10030)
        with ESMTP id gcuY_VEetgOL; Sun, 20 Aug 2017 00:20:00 +0200 (CEST)
...
Subject: [PATCH v10 08/16] MIPS: lantiq: Convert the fpi bus driver to a platform_driver
Date:   Sun, 20 Aug 2017 00:18:15 +0200
Message-Id: <20170819221823.13850-9-hauke@hauke-m.de>
