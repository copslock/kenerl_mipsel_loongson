Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 28 Mar 2011 17:08:22 +0200 (CEST)
Received: from www.linutronix.de ([62.245.132.108]:40406 "EHLO linutronix.de"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1491827Ab1C1PHB (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Mon, 28 Mar 2011 17:07:01 +0200
Received: from localhost ([127.0.0.1] helo=localhost6.localdomain6)
        by linutronix.de with esmtp (Exim 4.72)
        (envelope-from <tglx@linutronix.de>)
        id 1Q4E1v-0001Le-JA; Mon, 28 Mar 2011 17:06:55 +0200
Message-Id: <20110328150627.777498250@linutronix.de>
User-Agent: quilt/0.48-1
Date:   Mon, 28 Mar 2011 15:06:55 -0000
From:   Thomas Gleixner <tglx@linutronix.de>
To:     David Daney <ddaney@caviumnetworks.com>
Cc:     Ralf Baechle <ralf@linux-mips.org>, linux-mips@linux-mips.org
Subject: [patch 3/3] MIPS: Octeon: Simplify irq_cpu_on/offline irq chip
        functions
