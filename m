Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 18 Nov 2008 22:24:17 +0000 (GMT)
Received: from mail3.caviumnetworks.com ([12.108.191.235]:57133 "EHLO
	mail3.caviumnetworks.com") by ftp.linux-mips.org with ESMTP
	id S23754590AbYKRWXu (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Tue, 18 Nov 2008 22:23:50 +0000
Received: from exch4.caveonetworks.com (Not Verified[192.168.16.23]) by mail3.caviumnetworks.com with MailMarshal (v6,2,2,3503)
	id <B4923406e0000>; Tue, 18 Nov 2008 17:23:42 -0500
Received: from exch4.caveonetworks.com ([192.168.16.23]) by exch4.caveonetworks.com with Microsoft SMTPSVC(6.0.3790.3959);
	 Tue, 18 Nov 2008 14:23:39 -0800
Received: from dd1.caveonetworks.com ([64.169.86.201]) by exch4.caveonetworks.com over TLS secured channel with Microsoft SMTPSVC(6.0.3790.3959);
	 Tue, 18 Nov 2008 14:23:39 -0800
Received: from dd1.caveonetworks.com (localhost.localdomain [127.0.0.1])
	by dd1.caveonetworks.com (8.14.2/8.14.2) with ESMTP id mAIMNY9s004818;
	Tue, 18 Nov 2008 14:23:34 -0800
Received: (from ddaney@localhost)
	by dd1.caveonetworks.com (8.14.2/8.14.2/Submit) id mAIMNY2x004817;
	Tue, 18 Nov 2008 14:23:34 -0800
From:	David Daney <ddaney@caviumnetworks.com>
To:	linux-mips@linux-mips.org
Cc:	David Daney <ddaney@caviumnetworks.com>,
	Tomaso Paoletti <tpaoletti@caviumnetworks.com>
Subject: [PATCH 03/26] MIPS: Add Cavium OCTEON processor support files to arch/mips/cavium-octeon.
Date:	Tue, 18 Nov 2008 14:23:18 -0800
Message-Id: <1227047013-4785-3-git-send-email-ddaney@caviumnetworks.com>
X-Mailer: git-send-email 1.5.6.5
In-Reply-To: <49233FDE.3010404@caviumnetworks.com>
References: <49233FDE.3010404@caviumnetworks.com>
X-OriginalArrivalTime: 18 Nov 2008 22:23:39.0643 (UTC) FILETIME=[4E8784B0:01C949CC]
Return-Path: <David.Daney@caviumnetworks.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 21305
...
+	p->serial_in_fn = octeon_serial_in;
+	p->serial_out_fn = octeon_serial_out;
+}
+
...
+	mio_boot_reg_cfg.u64 = cvmx_read_csr(CVMX_MIO_BOOT_REG_CFGX(i + 1));
+	region_base = mio_boot_reg_cfg.s.base << 16;
+	region_size = (mio_boot_reg_cfg.s.size + 1) << 16;
+	if (region_base == 0)
+		goto out;
...
+		/*
+		 * Boot loader signals availability of DMA by setting
+		 * low order bits of base_ptr to zero.
+		 */
...
+
+	pd = platform_device_alloc("octeon-cf", -1);
+	if (!pd) {
+		ret = -ENOMEM;
+		goto out;
+	}
