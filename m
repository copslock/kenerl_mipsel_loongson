Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 23 Nov 2011 11:22:12 +0100 (CET)
Received: from mail-vx0-f177.google.com ([209.85.220.177]:46544 "EHLO
        mail-vx0-f177.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1903547Ab1KWKWG (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 23 Nov 2011 11:22:06 +0100
Received: by vcbfo13 with SMTP id fo13so1353299vcb.36
        for <multiple recipients>; Wed, 23 Nov 2011 02:21:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=mime-version:in-reply-to:references:date:message-id:subject:from:to
         :cc:content-type;
        bh=SVRp+lJUanTxyu8PWH6uUvMDd6NIswiuYezIO72I93Y=;
        b=QAZkXsoSrWU/itcG54MUpdmHHSf45l5ZsNeBY0onuLW6WFXdSys199b+eE2QQ/8S7e
         WsLNq+DgzVmy5jo9MVTUBkFlvDX3aSuOTpGX7FzHS+7vx4HUl4wtKVKSVIlpW+5Lkuta
         5dXmhzVoZzCnrtDC+oHCy4L580ugLoPDawwKA=
MIME-Version: 1.0
Received: by 10.52.20.207 with SMTP id p15mr24313751vde.87.1322043719690; Wed,
 23 Nov 2011 02:21:59 -0800 (PST)
Received: by 10.220.155.135 with HTTP; Wed, 23 Nov 2011 02:21:59 -0800 (PST)
In-Reply-To: <1321864492-1278-2-git-send-email-keguang.zhang@gmail.com>
References: <1321864492-1278-1-git-send-email-keguang.zhang@gmail.com>
        <1321864492-1278-2-git-send-email-keguang.zhang@gmail.com>
Date:   Wed, 23 Nov 2011 18:21:59 +0800
Message-ID: <CAJhJPsWXJft13MUgj8kB4DjQdO14S25ijiZuW7geBOHhMxpx4w@mail.gmail.com>
Subject: Re: [PATCH V4 2/4] MIPS: Add board support for Loongson1B
...
V4:
    1. Split the RTC patch, and merge the arch/mips bits into patch 2/4.
    2. Use 'KSEG1ADDR' instead of 'ioremap()' in registers definitions.

2011/11/21, Kelvin Cheung <keguang.zhang@gmail.com>:
