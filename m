Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 09 Apr 2009 05:53:47 +0100 (BST)
Received: from [222.92.8.141] ([222.92.8.141]:40352 "EHLO lemote.com")
	by ftp.linux-mips.org with ESMTP id S20023035AbZDIExf (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Thu, 9 Apr 2009 05:53:35 +0100
Received: from localhost (localhost [127.0.0.1])
	by lemote.com (Postfix) with ESMTP id F41023412F;
	Thu,  9 Apr 2009 12:50:34 +0800 (CST)
X-Virus-Scanned: Debian amavisd-new at lemote.com
Received: from lemote.com ([127.0.0.1])
	by localhost (www.lemote.com [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id jMDTiDM5PsHf; Thu,  9 Apr 2009 12:50:23 +0800 (CST)
Received: from [127.0.0.1] (unknown [222.92.8.142])
	by lemote.com (Postfix) with ESMTP id 31DBC34129;
	Thu,  9 Apr 2009 12:50:20 +0800 (CST)
Message-ID: <49DD7F39.6080401@lemote.com>
Date:	Thu, 09 Apr 2009 12:53:13 +0800
...
Subject: [PATCH 3/14] lemote: Add Siliconmotion 712 framebuffer driver
...
this graphic card is used in Yeeloong laptop
---
drivers/video/Kconfig | 23 +
drivers/video/Makefile | 1 +
drivers/video/smi/Makefile | 6 +
drivers/video/smi/sm501hw.h | 2160
+++++++++++++++++++++++++++++++++++++++++++
drivers/video/smi/sm7xxhw.h | 104 +++
drivers/video/smi/smtc2d.c | 1371 +++++++++++++++++++++++++++
drivers/video/smi/smtc2d.h | 580 ++++++++++++
drivers/video/smi/smtcfb.c | 1196 ++++++++++++++++++++++++
drivers/video/smi/smtcfb.h | 795 ++++++++++++++++
9 files changed, 6236 insertions(+), 0 deletions(-)
create mode 100755 drivers/video/smi/Makefile
create mode 100755 drivers/video/smi/sm501hw.h
create mode 100755 drivers/video/smi/sm7xxhw.h
create mode 100755 drivers/video/smi/smtc2d.c
create mode 100755 drivers/video/smi/smtc2d.h
create mode 100755 drivers/video/smi/smtcfb.c
create mode 100755 drivers/video/smi/smtcfb.h

diff --git a/drivers/video/Kconfig b/drivers/video/Kconfig
index fb19803..cd98d81 100644
...
+#define DISP_HVTOTAL_SCALEFACTOR 1.25 // Used in panelSetTiming,
crtSetTiming if
+ // nHTotal, nVTotal not specified by user
+
...
+ deWaitForNotBusy();
+
+ SMTC_write2Dreg(DE_WINDOW_DESTINATION_BASE, FIELD_VALUE(0,
DE_WINDOW_DESTINATION_BASE, ADDRESS, dst_base));
+
+ SMTC_write2Dreg(DE_PITCH,
...
+ *
+ * [out]
+ * pattern_dstaddr - Pointer to pre-allocated buffer containing rotated
pattern
+ *
+ *
+ **********************************************************************/
...
+ for (y = 0; y < 8; y++)
+ {
+ unsigned short* pjBuffer = (unsigned short*) pattern_dstaddr +
((patternY + y) & 7) * 8;
+ for (x = 0; x < 8; x++)
+ {
...
+ for (y = 0; y < 8; y++)
+ {
+ unsigned long* pjBuffer = (unsigned long*) pattern_dstaddr +
((patternY + y) & 7) * 8;
+ for (x = 0; x < 8; x++)
+ {
...
DE_WINDOW_DESTINATION_BASE, ADDRESS, dst_base));
+
+ SMTC_write2Dreg(DE_PITCH, FIELD_VALUE(0, DE_PITCH, DESTINATION,
dst_pitch) | FIELD_VALUE(0, DE_PITCH, SOURCE, dst_pitch));
+
+ SMTC_write2Dreg(DE_WINDOW_WIDTH,
+ FIELD_VALUE(0, DE_WINDOW_WIDTH, DESTINATION, dst_pitch) |
+ FIELD_VALUE(0, DE_WINDOW_WIDTH, SOURCE, dst_pitch));
...
+ {
+ SMTC_write2Ddataport(de_data_port_write_addr, ((unsigned long
*)ajPattern)[i]);
...
DE_WINDOW_DESTINATION_BASE, ADDRESS, dst_base));
+
+ SMTC_write2Dreg(DE_WINDOW_SOURCE_BASE, FIELD_VALUE(0,
DE_WINDOW_SOURCE_BASE, ADDRESS, src_base));
+
...
+
+ pSrcBuffer = (unsigned char*)(src_base + src_Y * src_stride + src_X *
(dst_BPP / 8));
+
...
+
+ SMTC_write2Dreg(DE_WINDOW_SOURCE_BASE, FIELD_VALUE(0,
DE_WINDOW_SOURCE_BASE, ADDRESS, 0));
+
+ SMTC_write2Dreg(DE_SOURCE,
+ FIELD_SET (0, DE_SOURCE, WRAP, DISABLE) |
...
+ SMTC_write2Ddataport(de_data_port_write_addr, *(unsigned
long*)(abyRemain + 4));
+ }
+
+ smtc_de_busy = 1;
...
+unsigned char *pSrcbuf, /* pointer to start of source buffer in system
memory */
+long srcDelta, /* Pitch value (in bytes) of the source buffer, +ive
means top down and -ive mean button up */
+unsigned long startBit, /* Mono data can start at any bit in a byte,
...
+unsigned long fColor, /* Foreground color (corresponding to a 1 in the
monochrome data */
+unsigned long bColor, /* Background color (corresponding to a 0 in the
monochrome data */
...
new file mode 100755
index 0000000..1bc69ab
--- /dev/null
+++ b/drivers/video/smi/smtcfb.c
@@ -0,0 +1,1196 @@
+/*
+ * linux/drivers/video/smtcfb.c -- Silicon Motion SM501 and SM7xx frame
buffer device
+ *
+ * Copyright (C) 2006 Silicon Motion Technology Corp.
+ * Ge Wang, gewang@siliconmotion.com
...
+
+
+static void sm712_set_timing(struct smtcfb_info *sfb,struct par_info
*ppar_info)
+{
+ int i=0,j=0;
+ u32 m_nScreenStride;
...
m_nScreenStride),ppar_info->m_pVPR+0x10);
+
+}
+
+
...
+#ifdef __BIG_ENDIAN
+ pal[regno] =( (red & 0xf800) >> 8) | ((green & 0xe000) >> 13) |((green
& 0x1c00) << 3) | ((blue & 0xf800) >> 3);
+#else
+ pal[regno] = val;
+#endif
+ }
...
+ deFillRect(p->BaseAddressInVRAM, 0, rect->dx*3, rect->dy*3,
rect->width*3, rect->height, rect->color);
+ else
+ deFillRect(p->BaseAddressInVRAM, 0, rect->dx, rect->dy, rect->width,
...
+ image->width/8, /* Pitch value (in bytes) of the source buffer, +ive
means top down and -ive mean button up */
+ 0, /* Mono data can start at any bit in a byte, this value should be 0
to 7 */
...
+ fg_col, /* Foreground color (corresponding to a 1 in the monochrome
data */
+ bg_col, /* Background color (corresponding to a 0 in the monochrome
data */
+ 0x0C) /* ROP value */;
+ }
+ else
...
+#ifdef __BIG_ENDIAN
+// hw.m_pLFB = smtc_VRAMBaseAddress = ioremap(pFramebufferPhysical,
0x00a00000);
+ hw.m_pLFB = smtc_VRAMBaseAddress = ioremap(pFramebufferPhysical,
0x00c00000);
+#else
...
+ smtc_2DBaseAddress = hw.m_pDPR = ioremap(pFramebufferPhysical,
0x00a00000);
...
+ }
+
+ printk("Silicon Motion SM%X Rev%X primary display mode %dx%d-%d Init
Complete.\n",
...
+ }
+
+ printk("Silicon Motion SM%X Rev%X secondary display mode %dx%d-%d Init
Complete.\n",
...
+
+ for (index = 0; index < (sizeof(vesa_mode) / sizeof(struct
vesa_mode_table)); index++)
+ {
...
new file mode 100755
index 0000000..01b74cb
--- /dev/null
+++ b/drivers/video/smi/smtcfb.h
@@ -0,0 +1,795 @@
+/*
+ * linux/drivers/video/smtcfb.h -- Silicon Motion SM501 and SM7xx frame
buffer device
+ *
+ * Copyright (C) 2006 Silicon Motion Technology Corp.
+ * Ge Wang, gewang@siliconmotion.com
...
+ },
+
+ { /* mode#4: 1024 x 600 16Bpp 60Hz We use 1024x768 table to light
1024x600 panel for lemote*/
+ 1024,600,16,60,
+ /* Init_MISC */
+ 0xEB,
+ { /* Init_SR0_SR4 */
