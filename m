Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 01 Sep 2018 14:05:30 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:8722 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23990471AbeIAMF01x-Ad (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sat, 1 Sep 2018 14:05:26 +0200
Received: from smtp2.mailbox.org (smtp2.mailbox.org [80.241.60.241])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id 122A940E62;
        Sat,  1 Sep 2018 14:05:21 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp2.mailbox.org ([80.241.60.241])
        by gerste.heinlein-support.de (gerste.heinlein-support.de [91.198.250.173]) (amavisd-new, port 10030)
        with ESMTP id noW-To8YazYO; Sat,  1 Sep 2018 14:05:16 +0200 (CEST)
...
Subject: [PATCH v2 net-next 7/7] net: dsa: Add Lantiq / Intel DSA driver for vrx200
Date:   Sat,  1 Sep 2018 14:05:11 +0200
Message-Id: <20180901120511.10112-1-hauke@hauke-m.de>
