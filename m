Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 28 Dec 2012 22:44:54 +0100 (CET)
Received: from localhost.localdomain ([127.0.0.1]:42031 "EHLO linux-mips.org"
        rhost-flags-OK-OK-OK-FAIL) by eddie.linux-mips.org with ESMTP
        id S6823072Ab2L1VoxqYtbn (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 28 Dec 2012 22:44:53 +0100
Received: from scotty.linux-mips.net (localhost.localdomain [127.0.0.1])
        by scotty.linux-mips.net (8.14.5/8.14.4) with ESMTP id qBSLipdT017231;
        Fri, 28 Dec 2012 22:44:51 +0100
Received: (from ralf@localhost)
        by scotty.linux-mips.net (8.14.5/8.14.5/Submit) id qBSLim95017230;
        Fri, 28 Dec 2012 22:44:48 +0100
Date:   Fri, 28 Dec 2012 22:44:48 +0100
From:   Ralf Baechle <ralf@linux-mips.org>
To:     Geert Uytterhoeven <geert@linux-m68k.org>
Cc:     linux-mips@linux-mips.org, linux-kernel@vger.kernel.org
Subject: Re: [PATCH] mips: Export min_low_pfn if CONFIG_FLATMEM
Message-ID: <20121228214448.GB6786@linux-mips.org>
References: <1356727256-3172-1-git-send-email-geert@linux-m68k.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <1356727256-3172-1-git-send-email-geert@linux-m68k.org>
User-Agent: Mutt/1.5.21 (2010-09-15)
X-archive-position: 35346
