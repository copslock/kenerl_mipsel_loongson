...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 4C58CC10F00
	for <linux-mips@archiver.kernel.org>; Fri, 15 Mar 2019 10:53:52 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id ECD91218B0
	for <linux-mips@archiver.kernel.org>; Fri, 15 Mar 2019 10:53:51 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b="ddB+Ykf1"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726559AbfCOKxu (ORCPT <rfc822;linux-mips@archiver.kernel.org>);
        Fri, 15 Mar 2019 06:53:50 -0400
Received: from mail-ed1-f68.google.com ([209.85.208.68]:35823 "EHLO
        mail-ed1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727553AbfCOKxt (ORCPT
        <rfc822;linux-mips@vger.kernel.org>); Fri, 15 Mar 2019 06:53:49 -0400
Received: by mail-ed1-f68.google.com with SMTP id d6so6642907eds.2
        for <linux-mips@vger.kernel.org>; Fri, 15 Mar 2019 03:53:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ffwll.ch; s=google;
        h=sender:date:from:to:cc:subject:message-id:mail-followup-to
         :references:mime-version:content-disposition
         :content-transfer-encoding:in-reply-to:user-agent;
        bh=OPRRh+3VLeOkvyRU2GKXLtC/Xl2JAOPg5onQ0knCn0o=;
        b=ddB+Ykf1gwppOnlEm4jDNW4lalSUaPoTLc9gLdG0o+gcfZniV5R1Ar3YTsNs1ME0OB
         eYg5lld0166mv43Ked7ic11vhM2C2LYa9vwxpGjR/x+1c7ILwwhvl96sDqUd/88oreEw
         vWiSbFYU9sW0DOllzqUC3mHvWzky7Ef86xC1A=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:sender:date:from:to:cc:subject:message-id
         ...
         :content-transfer-encoding:in-reply-to:user-agent;
        bh=OPRRh+3VLeOkvyRU2GKXLtC/Xl2JAOPg5onQ0knCn0o=;
        b=
X-Gm-Message-State: APjAAAUUfOMwUmo2E5dA8rLRO4gX0XIM8Od0T0MEgFXDVJZHLlrA6OkO
        WRcl1wqCGg9jCol5TwsnnRw6XA==
X-Google-Smtp-Source: APXvYqwjJ7zBjVg36kyRW0f701ZkO3JdfHt00dJji053sU3+iV+FRn4DmMGzJsu/SpD005vJDQ/8KA==
X-Received: by 2002:a50:a48f:: with SMTP id w15mr2297206edb.91.1552647225457;
        Fri, 15 Mar 2019 03:53:45 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:569e:0:3106:d637:d723:e855])
        by smtp.gmail.com with ESMTPSA id u47sm537119edm.37.2019.03.15.03.53.43
        (version=TLS1_2 cipher=ECDHE-RSA-CHACHA20-POLY1305 bits=256/256);
        Fri, 15 Mar 2019 03:53:44 -0700 (PDT)
Date:   Fri, 15 Mar 2019 11:53:42 +0100
...
Message-ID: <20190315105342.GV2665@phenom.ffwll.local>
...
References: <20190228220756.20262-1-paul@crapouillou.net>
 ...
 <1552567021.7520.0@crapouillou.net>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <1552567021.7520.0@crapouillou.net>
...
> Hi Daniel,
> 
> Le ven. 1 mars 2019 à 9:26, Daniel Vetter <daniel@ffwll.ch> a écrit :
...
> > >  +	struct device *dev;
> > 
> > Embedding is kinda the new thing, since it also prevents people from
> > using
> > devm_ for this, which is (strictly speaking, not that it matters much)
> > the
> > wrong lifetime for drm allocations. There's some patches from Noralf
> > that
...
Not sure why you need these? bridges also have callbacks to adjust state,
crtc code shouldn't really dig around in connectors.
-Daniel
...
> -Paul
> 
> > This should cover all the bigger items, details look already really
> > tidy.
> > 
> > Cheers, Daniel
> > 
...
> > >  +};
> > >  +
> > >  +static inline struct ingenic_drm *drm_crtc_get_priv(struct
> > > drm_crtc *crtc)
> > >  +{
...
> > >  +}
> > >  +
> > >  +static inline struct ingenic_drm *drm_conn_get_priv(struct
> > > drm_connector *conn)
> > >  +{
...
> > >  +}
> > >  +
> > >  +static void ingenic_drm_crtc_update_timings(struct ingenic_drm
> > > *priv,
