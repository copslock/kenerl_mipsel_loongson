Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 29 May 2009 19:32:11 +0100 (BST)
Received: from sj-iport-5.cisco.com ([171.68.10.87]:54534 "EHLO
	...
	with ESMTP id S20024746AbZE2Saw (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Fri, 29 May 2009 19:30:52 +0100
X-IronPort-AV: E=Sophos;i="4.41,272,1241395200"; 
   d="scan'208";a="78336858"
Received: from sj-dkim-4.cisco.com ([171.71.179.196])
  by sj-iport-5.cisco.com with ESMTP; 29 May 2009 18:30:43 +0000
Received: from sj-core-2.cisco.com (sj-core-2.cisco.com [171.71.177.254])
	by sj-dkim-4.cisco.com (8.12.11/8.12.11) with ESMTP id n4TIUgWx011074;
	Fri, 29 May 2009 11:30:42 -0700
Received: from cuplxvomd02.corp.sa.net ([64.101.20.155])
	by sj-core-2.cisco.com (8.13.8/8.13.8) with ESMTP id n4TIUgoj008158;
	Fri, 29 May 2009 18:30:42 GMT
Date:	Fri, 29 May 2009 11:30:42 -0700
From:	David VomLehn <dvomlehn@cisco.com>
To:	linux-mips@linux-mips.org
Cc:	ralf@linux-mips.org
Subject: [PATCH 3/3] mips:powertv: Integrate Cisco Powertv platform into
	MIPS architecture, v2
Message-ID: <20090529183042.GA12498@cuplxvomd02.corp.sa.net>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
User-Agent: Mutt/1.5.18 (2008-05-17)
DKIM-Signature:	v=1; a=rsa-sha256; q=dns/txt; l=43604; t=1243621842; x=1244485842;
	...
	=20v2
	|Sender:=20;
	bh=98Q/Hdt/jUvsmpdrvM6X05bswganbNE4tiDXa8AIbYo=;
	b=bd5sFHMnxBip50zAphZGfms0JJQKrf33P/9zj0ViYUN6ExtPxprkFrTanb
	XRG3gA3ZwVSBYPGsAxex8rCc17Hy95HoKs0Gwe6Qm7d688PjDgPH35vrnaET
	Q8yBYPaKwC;
...
History
v2	Moved CSRC_POWERTV and CEVT_POWERTV out of arch/mips/Kconfig
...
index 26947ab..d7cc241 100644
--- a/arch/mips/Makefile
+++ b/arch/mips/Makefile
@@ -427,6 +427,14 @@ core-$(CONFIG_NEC_MARKEINS)	+= arch/mips/emma/markeins/
