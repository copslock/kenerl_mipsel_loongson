Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 20 Mar 2006 04:26:24 +0000 (GMT)
Received: from sorrow.cyrius.com ([65.19.161.204]:34575 "EHLO
	sorrow.cyrius.com") by ftp.linux-mips.org with ESMTP
	id S8127231AbWCTEZw (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Mon, 20 Mar 2006 04:25:52 +0000
Received: by sorrow.cyrius.com (Postfix, from userid 10)
	id E343464D3D; Mon, 20 Mar 2006 04:35:29 +0000 (UTC)
Received: by deprecation.cyrius.com (Postfix, from userid 1000)
	id BB98766ED5; Mon, 20 Mar 2006 04:35:12 +0000 (GMT)
Date:	Mon, 20 Mar 2006 04:35:12 +0000
From:	Martin Michlmayr <tbm@cyrius.com>
To:	Ralf Baechle <ralf@linux-mips.org>
Cc:	linux-mips@linux-mips.org, akpm@osdl.org
Subject: [PATCH 1/6] [CHAR] Remove obsolete IBM z50 (vr41xx) keyboard map
Message-ID: <20060320043512.GA20200@deprecation.cyrius.com>
...
--- mips.git/drivers/char/Makefile	2006-03-05 18:51:14.000000000 +0000
+++ linux-2.6/drivers/char/Makefile	2006-03-13 19:12:31.000000000 +0000
@@ -121,8 +115,7 @@
...
+$(obj)/defkeymap.c $(obj)/qtronixmap.c: $(obj)/%.c: $(src)/%.map
 	...
 	sed -e 's/^static *//' $@.tmp > $@
 	rm $@.tmp
--- mips.git/drivers/char/ibm_workpad_keymap.map	2006-03-05 18:51:15.000000000 +0000
+++ linux-2.6/drivers/char/ibm_workpad_keymap.map	1970-01-01 01:00:00.000000000 +0100
@@ -1,343 +0,0 @@
