Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 30 Sep 2010 11:10:40 +0200 (CEST)
Received: from mail-pz0-f49.google.com ([209.85.210.49]:53347 "EHLO
        mail-pz0-f49.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491189Ab0I3JJi (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 30 Sep 2010 11:09:38 +0200
Received: by pzk32 with SMTP id 32so584834pzk.36
        for <multiple recipients>; Thu, 30 Sep 2010 02:09:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=3F3sLcQDSr8hZJ7cf1r5ZSUYNlS/KasCoSgZ4h+Paww=;
        b=AnGVja3c8VB2REe//Ka7nU/V10LILnShHiwBnlclp9E8IMhlyGNOopYx/RQrvfzBTS
         KwGWJ1Z07F+vQbtEV9lslvzuwHi6CBJi3d81oJG2kAriMcsPk+yIDepWPeGw4cA7OOkS
         G/G/KghTdqjKW2cvs6jjDeqLv4hDWbnvx3C1s=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=fzLEgK/2Z6pVQvFfvSkU6ykIBiKjxZeZ2cKzb8UenWDJ1PtvEvANXGoNYQ9aiiOoxN
         eWMQSkJr5d0aEuRPMMcunbrRZZX6GekWjgsIsRjhvf1YgXYsFH5RbBxWoevO9JD2GrVM
         tM6yOwxLzYNNC0fut2rNbwzl/ugn1xU++VYbw=
Received: by 10.114.109.18 with SMTP id h18mr1229083wac.66.1285837772041;
        Thu, 30 Sep 2010 02:09:32 -0700 (PDT)
Received: from localhost.localdomain ([210.13.118.102])
        by mx.google.com with ESMTPS id c10sm16210348wam.1.2010.09.30.02.09.23
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Thu, 30 Sep 2010 02:09:29 -0700 (PDT)
From:   Deng-Cheng Zhu <dengcheng.zhu@gmail.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     a.p.zijlstra@chello.nl, paulus@samba.org, mingo@elte.hu,
        acme@redhat.com, jamie.iles@picochip.com, dengcheng.zhu@gmail.com
Subject: [PATCH v7 4/6] MIPS: add support for hardware performance events (skeleton)
Date:   Thu, 30 Sep 2010 17:09:18 +0800
Message-Id: <1285837760-10362-5-git-send-email-dengcheng.zhu@gmail.com>
...
---
 ...
 arch/mips/include/asm/pmu.h        |    3 +
 arch/mips/kernel/Makefile          |    2 +
 arch/mips/kernel/perf_event.c      |  487 ++++++++++++++++++++++++++++++++++++
