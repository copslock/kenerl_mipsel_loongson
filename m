Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 09 Apr 2012 17:24:52 +0200 (CEST)
Received: from home.bethel-hill.org ([63.228.164.32]:39804 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1903692Ab2DIPW1 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 9 Apr 2012 17:22:27 +0200
Received: by home.bethel-hill.org with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
        (Exim 4.72)
        (envelope-from <sjhill@mips.com>)
        id 1SHGQ8-0005vf-W8; Mon, 09 Apr 2012 10:22:21 -0500
From:   "Steven J. Hill" <sjhill@mips.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     "Steven J. Hill" <sjhill@mips.com>
Subject: [PATCH 5/9] MIPS: Add support for microMIPS instructions.
Date:   Mon,  9 Apr 2012 10:21:59 -0500
Message-Id: <1333984923-445-6-git-send-email-sjhill@mips.com>
...
---
 ...
 3 files changed, 1134 insertions(+), 281 deletions(-)
...
@@ -101,8 +187,8 @@ static struct insn insn_table[] __uasminitdata = {
...
@@ -154,88 +240,112 @@ static struct insn insn_table[] __uasminitdata = {
...
@@ -263,9 +373,23 @@ static void __uasminit build_insn(u32 **buf, enum opcode opc, ...)
 	op = ip->match;
 	va_start(ap, opc);
 	if (ip->fields & RS)
+	{
...
+	}
 	...
 	if (ip->fields & RE)
@@ -286,7 +410,11 @@ static void __uasminit build_insn(u32 **buf, enum opcode opc, ...)
...
@@ -564,7 +692,11 @@ __resolve_relocs(struct uasm_reloc *rel, struct uasm_label *lab)
