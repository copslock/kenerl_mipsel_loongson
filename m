Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 13 Apr 2011 10:54:40 +0200 (CEST)
Received: from phoenix3.szarvasnet.hu ([87.101.127.16]:60089 "EHLO
        phoenix3.szarvasnet.hu" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491102Ab1DMIyg (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 13 Apr 2011 10:54:36 +0200
Received: from mail.szarvas.hu (localhost [127.0.0.1])
        by phoenix3.szarvasnet.hu (Postfix) with SMTP id 75D5F14014E;
        Wed, 13 Apr 2011 10:54:31 +0200 (CEST)
Received: from localhost.localdomain (catvpool-576570d8.szarvasnet.hu [87.101.112.216])
        by phoenix3.szarvasnet.hu (Postfix) with ESMTPA id EB13B140152;
        Wed, 13 Apr 2011 10:54:30 +0200 (CEST)
...
Subject: [PATCH v2 1/3] USB: ehci: add bus glue for the Atheros AR71XX/AR724X/AR91XX SoCs
Date:   Wed, 13 Apr 2011 10:54:22 +0200
Message-Id: <1302684864-12484-1-git-send-email-juhosg@openwrt.org>
X-Mailer: git-send-email 1.7.2.1
X-VBMS: A11A1E22549 | phoenix3 | 127.0.0.1 |  | <juhosg@openwrt.org> | 
Return-Path: <juhosg@openwrt.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 29746
...
---
Changes since v1:
* remove XXX from the subject line because:
    host vger.kernel.org[209.132.180.67] said: 550
    5.7.1 Content-Policy reject msg: The capital Triple-X in subject
    is way too often associated with junk email, please rephrase.
* fix a typo in the prompt of USB_EHCI_ATH79
* use (SOC_AR71XX || SOC_AR724X || SOC_AR913X) as a dependency
  instead of ATH79
* add 'default y'
