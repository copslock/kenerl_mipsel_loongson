Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 09 Aug 2015 07:23:27 +0200 (CEST)
Received: from a23-79-238-175.deploy.static.akamaitechnologies.com ([23.79.238.175]:51320
        "EHLO prod-mail-xrelay07.akamai.com" rhost-flags-OK-FAIL-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27009687AbbHIFXFNYhlD (ORCPT
...
Received: from prod-mail-xrelay07.akamai.com (localhost.localdomain [127.0.0.1])
        by postfix.imss70 (Postfix) with ESMTP id 5C74C43358B;
        Sun,  9 Aug 2015 05:22:59 +0000 (GMT)
Received: from prod-mail-relay07.akamai.com (prod-mail-relay07.akamai.com [172.17.121.112])
        by prod-mail-xrelay07.akamai.com (Postfix) with ESMTP id 398DE43358E;
        Sun,  9 Aug 2015 05:22:59 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=akamai.com; s=a1;
        t=1439097779; bh=RamAsQTElAwIoZa64ZF+f0Es+gyv6Enj8VMW9x/POpg=;
        l=3929; h=From:To:Cc:Date:In-Reply-To:References:From;
        b=aFG53U05k05K+2jmjv/BMcIkmK8lEvn7LVLgm42WO+sfJhvKF57TkSassbk9qmDRC
         N4c2j7qvRCRqNu4Sfy+KPvy1q7rLjJli771NToPD5FE2lDCJ+kKlT64LHDYS8squhw
         W1eae89Jy6xILazJCLjYbuskYfYXSfXCye/yIk00=
Received: from bos-lp6ds.kendall.corp.akamai.com (bos-lp6ds.kendall.corp.akamai.com [172.28.13.174])
        by prod-mail-relay07.akamai.com (Postfix) with ESMTP id 3303B800BA;
        Sun,  9 Aug 2015 05:22:59 +0000 (GMT)
