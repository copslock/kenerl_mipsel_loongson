Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 04 Nov 2014 07:19:12 +0100 (CET)
Received: from mail-pa0-f45.google.com ([209.85.220.45]:36585 "EHLO
        mail-pa0-f45.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27010958AbaKDGTKjneUX (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 4 Nov 2014 07:19:10 +0100
Received: by mail-pa0-f45.google.com with SMTP id lf10so13743460pab.18
        for <multiple recipients>; Mon, 03 Nov 2014 22:19:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=sender:from:to:cc:subject:date:message-id;
        bh=GLKBTTDk0w3y4rT2/M/jf3tR9IdnKUd32fe4FtJwBzk=;
        b=
X-Received: by 10.70.34.206 with SMTP id b14mr41880673pdj.10.1415081943817;
        Mon, 03 Nov 2014 22:19:03 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPSA id pw10sm18771180pbc.93.2014.11.03.22.18.57
        for <multiple recipients>
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Mon, 03 Nov 2014 22:19:02 -0800 (PST)
...
Subject: [PATCH V2 12/12] MIPS: Loongson: Make CPUFreq usable for Loongson-3
Date:   Tue,  4 Nov 2014 14:18:48 +0800
Message-Id: <1415081928-25899-1-git-send-email-chenhc@lemote.com>
X-Mailer: git-send-email 1.7.7.3
Return-Path: <chenhuacai@gmail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 43861
