...
Message-ID: <20180426232834.p7rqQhVZk_i-GD-WgCLYmE4DzQY-tJZJmT-BkduS-bs@z>
...
Patches currently in stable-queue which might be from neil@brown.name are

queue-4.16/mips-c-r4k-fix-data-corruption-related-to-cache-coherence.patch
