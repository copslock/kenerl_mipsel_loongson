Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 25 Jul 2008 14:34:32 +0100 (BST)
Received: from yw-out-1718.google.com ([74.125.46.153]:21256 "EHLO
	yw-out-1718.google.com") by ftp.linux-mips.org with ESMTP
	id S20031810AbYGYNe1 (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 25 Jul 2008 14:34:27 +0100
Received: by yw-out-1718.google.com with SMTP id 9so1241922ywk.24
        for <linux-mips@linux-mips.org>; Fri, 25 Jul 2008 06:34:24 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlemail.com; s=gamma;
        h=domainkey-signature:received:received:message-id:date:from:sender
         :to:subject:cc:mime-version:content-type:content-transfer-encoding
         :content-disposition:x-google-sender-auth;
        bh=cwmZk7/0xxOZP9pjEmqfVIt1Heu6161CALsFSA2n9As=;
        b=vZLLUQGYYnIfH13iHoJ8mMvRZlO+jh5K+xdyJJkTNJ6NYJ4BF1QMmVT52PFjpBm2cP
         Jbpalm4tPpx8befQurG/94p3tKY1T9m7Dc3FRe86/iXP5UHW2LskyEyHt1v9nlAv8hen
         G5QjlMWNg8rZyfx8ud0D2kRvBRN8D8uKLkdYs=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=googlemail.com; s=gamma;
        h=message-id:date:from:sender:to:subject:cc:mime-version:content-type
         :content-transfer-encoding:content-disposition:x-google-sender-auth;
        b=kjDi/CdYpQBxOXRcVZjesuWF0lBVif+oPR8Hy7d/3Z8NH2OyOuMpNT/udR7tKAvVAO
         chtwLcbhfm0OhxcHsR2JIe9z7Rck/EJo1CQ1rondVDYmjOW0vFC0+CXwfTHocMeHwNRV
         jz/3s9UJ+yGsQoJtiScdvB8hbkxwTzDPI//lA=
Received: by 10.142.170.6 with SMTP id s6mr547451wfe.228.1216992863939;
        Fri, 25 Jul 2008 06:34:23 -0700 (PDT)
Received: by 10.142.49.17 with HTTP; Fri, 25 Jul 2008 06:34:23 -0700 (PDT)
Message-ID: <64660ef00807250634g7351453di4ca7a10e2310922f@mail.gmail.com>
Date:	Fri, 25 Jul 2008 14:34:23 +0100
From:	"Daniel Laird" <daniel.j.laird@nxp.com>
To:	"Ralf Baechle" <ralf@linux-mips.org>
Subject: Updated PNX833X patch based on upstream.
Cc:	linux-mips@linux-mips.org
MIME-Version: 1.0
Content-Type: text/plain; charset=ISO-8859-1
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
X-Google-Sender-Auth: 7c8d3f212ae3ff1b
Return-Path: <daniel.j.laird@googlemail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 19953
...
the vectored interrupt issue.
 ...
 arch/mips/nxp/pnx833x/common/platform.c     |  318 +++++++
 ...
 16 files changed, 2789 insertions(+)

Signed-off-by: daniel.j.laird <daniel.j.laird@nxp.com>

diff -urN linux-2.6.26-rc4.orig/arch/mips/configs/pnx8335-stb225_defconfig
...
+CONFIG_HAS_IOPORT=y
+CONFIG_HAS_DMA=y
diff -urN linux-2.6.26-rc4.orig/arch/mips/Kconfig
...
diff -urN linux-2.6.26-rc4.orig/arch/mips/Makefile
...
+
 ...
 # Common NXP PNX8550
 #
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/common/interrupts.c
...
+}
+
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/common/Makefile
...
01:00:00.000000000 +0100
+++ linux-2.6.26-rc4/arch/mips/nxp/pnx833x/common/Makefile	2008-07-25
13:10:24.000000000 +0100
@@ -0,0 +1,3 @@
+obj-y := interrupts.o platform.o prom.o setup.o reset.o
+
+EXTRA_CFLAGS += -Werror
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/common/platform.c
...
01:00:00.000000000 +0100
+++ linux-2.6.26-rc4/arch/mips/nxp/pnx833x/common/platform.c	2008-07-25
13:11:22.000000000 +0100
@@ -0,0 +1,318 @@
+/*
...
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/common/prom.c
...
+}
+
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/common/reset.c
...
+}
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/common/setup.c
...
+	return 0;
+}
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/stb22x/board.c
...
+#endif
+}
diff -urN linux-2.6.26-rc4.orig/arch/mips/nxp/pnx833x/stb22x/Makefile
...
01:00:00.000000000 +0100
+++ linux-2.6.26-rc4/arch/mips/nxp/pnx833x/stb22x/Makefile	2008-07-24
08:11:36.000000000 +0100
@@ -0,0 +1,3 @@
+lib-y := board.o
+
+EXTRA_CFLAGS += -Werror

diff -urN linux-2.6.26-rc4.orig/include/asm-mips/mach-pnx833x/gpio.h
...
+
+#endif
diff -urN linux-2.6.26-rc4.orig/include/asm-mips/mach-pnx833x/irq.h
...
+
+#endif
diff -urN linux-2.6.26-rc4.orig/include/asm-mips/mach-pnx833x/irq-mapping.h
...
+#endif
+
diff -urN linux-2.6.26-rc4.orig/include/asm-mips/mach-pnx833x/pnx833x.h
...
diff -urN linux-2.6.26-rc4.orig/include/asm-mips/mach-pnx833x/war.h
