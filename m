Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 10 Jan 2005 00:31:12 +0000 (GMT)
Received: from alpha.total-knowledge.com ([IPv6:::ffff:209.157.135.102]:30167
	"EHLO alpha.total-knowledge.com") by linux-mips.org with ESMTP
	id <S8225264AbVAJAbD>; Mon, 10 Jan 2005 00:31:03 +0000
Received: (qmail 18235 invoked from network); 9 Jan 2005 07:13:55 -0800
Received: from c-24-6-216-150.client.comcast.net (HELO ?192.168.0.238?) (24.6.216.150)
  by alpha.total-knowledge.com with SMTP; 9 Jan 2005 07:13:55 -0800
Message-ID: <41E1CCC1.9060407@total-knowledge.com>
Date: Sun, 09 Jan 2005 16:30:57 -0800
...
References: <41E069BF.8040500@total-knowledge.com>
In-Reply-To: <41E069BF.8040500@total-knowledge.com>
...
> 2.  Seems that PCI support is messed up by this patch, so SCSI doesn't 
> work.
>
...
+#define CRIME_HI_MEM_BASE      0x40000000      /* this is where whole 
1G of RAM is mapped */
+
...
+
--- /dev/null   1969-12-31 16:00:00 -0800
+++ include/asm-mips/mach-ip32/cpu-feature-overrides.h  2005-01-08 
21:59:51 -0800
@@ -0,0 +1,22 @@
+/*
+ * This file is subject to the terms and conditions of the GNU General 
