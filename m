Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 09 Oct 2017 14:52:04 +0200 (CEST)
Received: from shadbolt.e.decadent.org.uk ([88.96.1.126]:52164 "EHLO
        shadbolt.e.decadent.org.uk" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23992533AbdJIMvf0nckY (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 9 Oct 2017 14:51:35 +0200
Received: from [2a02:8011:400e:2:6f00:88c8:c921:d332] (helo=deadeye)
        by shadbolt.decadent.org.uk with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.84_2)
        (envelope-from <ben@decadent.org.uk>)
        id 1e1XQk-0004ux-Ie; Mon, 09 Oct 2017 13:45:10 +0100
Received: from ben by deadeye with local (Exim 4.89)
        (envelope-from <ben@decadent.org.uk>)
        id 1e1XQP-00020c-UG; Mon, 09 Oct 2017 13:44:49 +0100
...
Message-ID: <lsq.1507553064.773060610@decadent.org.uk>
X-Mailer: LinuxStableQueue (scripts by bwh)
Subject: [PATCH 3.16 069/192] MIPS: math-emu: Prevent wrong ISA mode
