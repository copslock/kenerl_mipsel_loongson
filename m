Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 20 Nov 2008 15:26:51 +0000 (GMT)
Received: from mba.ocn.ne.jp ([122.1.235.107]:64999 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S23792138AbYKTP0r (ORCPT
...
Received: from localhost.localdomain (p2225-ipad206funabasi.chiba.ocn.ne.jp [222.145.76.225])
	...
	id 90DD7B40A; Fri, 21 Nov 2008 00:26:41 +0900 (JST)
From:	Atsushi Nemoto <anemo@mba.ocn.ne.jp>
To:	linux-mips@linux-mips.org
Cc:	ralf@linux-mips.org, linux-mtd@lists.infradead.org,
	dwmw2@infradead.org
Subject: [PATCH 2/4] MTD: TXx9 SoC NAND Flash Memory Controller driver
Date:	Fri, 21 Nov 2008 00:26:46 +0900
Message-Id: <1227194806-16175-2-git-send-email-anemo@mba.ocn.ne.jp>
X-Mailer: git-send-email 1.5.6.3
Return-Path: <anemo@mba.ocn.ne.jp>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 21340
...
+		} else {
+			txx9_priv->cs = -1;
+			strcpy(txx9_priv->mtdname, dev->dev.bus_id);
+		}
