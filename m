Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Aug 2017 00:55:06 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:38979 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995160AbdHHWx1NBuiu (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 9 Aug 2017 00:53:27 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id 6B9A04587B;
        Wed,  9 Aug 2017 00:53:21 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter02.heinlein-hosting.de (spamfilter02.heinlein-hosting.de [80.241.56.116]) (amavisd-new, port 10030)
        with ESMTP id pGrOIKtaydun; Wed,  9 Aug 2017 00:53:19 +0200 (CEST)
...
Subject: [PATCH v9 04/16] watchdog: lantiq: access boot cause register through regmap
Date:   Wed,  9 Aug 2017 00:52:35 +0200
Message-Id: <20170808225247.32266-5-hauke@hauke-m.de>
