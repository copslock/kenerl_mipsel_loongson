Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 19 Nov 2013 18:32:43 +0100 (CET)
Received: from multi.imgtec.com ([194.200.65.239]:2614 "EHLO multi.imgtec.com"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6817040Ab3KSRcRmG2VX (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Tue, 19 Nov 2013 18:32:17 +0100
From:   Paul Burton <paul.burton@imgtec.com>
To:     <linux-mips@linux-mips.org>
CC:     Paul Burton <paul.burton@imgtec.com>
Subject: [PATCH 1/6] mips: simplify FP context access
Date:   Tue, 19 Nov 2013 17:30:34 +0000
Message-ID: <1384882239-17965-2-git-send-email-paul.burton@imgtec.com>
...
index 683a3d6..622b2ba 100644
--- a/arch/mips/include/asm/processor.h
+++ b/arch/mips/include/asm/processor.h
@@ -97,8 +97,33 @@ extern unsigned int vced_count, vcei_count;
...
@@ -108,7 +133,7 @@ typedef __u64 fpureg_t;
  */
...
@@ -287,7 +312,7 @@ struct thread_struct {
...
index a0566c8..7f0a5ce 100644
--- a/arch/mips/math-emu/cp1emu.c
+++ b/arch/mips/math-emu/cp1emu.c
@@ -876,20 +876,30 @@ static inline int cop1_64bit(struct pt_regs *xcp)
 #endif
 }
