Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 03 Sep 2007 14:26:49 +0100 (BST)
Received: from wa-out-1112.google.com ([209.85.146.180]:64979 "EHLO
	wa-out-1112.google.com") by ftp.linux-mips.org with ESMTP
	id S20022445AbXICNZU (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Mon, 3 Sep 2007 14:25:20 +0100
Received: by wa-out-1112.google.com with SMTP id m16so1815553waf
        for <linux-mips@linux-mips.org>; Mon, 03 Sep 2007 06:25:18 -0700 (PDT)
DKIM-Signature:	a=rsa-sha1; c=relaxed/relaxed;
        d=gmail.com; s=beta;
        h=domainkey-signature:received:received:message-id:date:from:to:subject:mime-version:content-type:content-transfer-encoding:content-disposition;
        b=Aiq4h+k/U9E5/wVu1KnYzwO6RLLBr0Lj2HL55xvtS8lUWqIAU8G55xDwufIFhSbFhPMDgK6TVuguXziA076lJ9F+jiImFyNjXDu94XQBYdSfVF2cz9g7X1jpAEaPlQs9r+CYZb/9HWcpQGqaEG+u3RTbbPPIgPGCqBq3Hz7et5o=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=beta;
        h=received:message-id:date:from:to:subject:mime-version:content-type:content-transfer-encoding:content-disposition;
        b=iyBVsGPy4UoSgshckBqCVIXruH1LSLvp/6VFA3hV5I8tErixtbb+kaaB+N+uOsKgtrVPEaTnXknFvyVN+NEPDCgmJGlpGNRdSueXCm85TUHi6rFrYP8xDCySfG/MJv61rSxwu3CGjd0gMUVbX4MfTN+UojMd3cvS11NLhAln+ys=
Received: by 10.114.176.1 with SMTP id y1mr294wae.1188825917537;
        Mon, 03 Sep 2007 06:25:17 -0700 (PDT)
Received: by 10.115.111.13 with HTTP; Mon, 3 Sep 2007 06:25:16 -0700 (PDT)
Message-ID: <40101cc30709030625n49054e0fv83f53585cf793a0@mail.gmail.com>
Date:	Mon, 3 Sep 2007 15:25:16 +0200
From:	"Matteo Croce" <technoboy85@gmail.com>
To:	linux-mips@linux-mips.org
Subject: [PATCH 7/7] AR7: ethernet
MIME-Version: 1.0
...
+}
+
+static int cpmac_mdio_write(struct mii_bus *bus, int phy_id, int
regnum, u16 val)
+{
+	struct cpmac_mdio_regs *regs = (struct cpmac_mdio_regs *)bus->priv;
+	volatile u32 tmp;
