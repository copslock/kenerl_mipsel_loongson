Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Aug 2017 00:58:39 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:54177 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995178AbdHHWxmFKQCu (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 9 Aug 2017 00:53:42 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id 9CF2545FC8;
        Wed,  9 Aug 2017 00:53:36 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter03.heinlein-hosting.de (spamfilter03.heinlein-hosting.de [80.241.56.117]) (amavisd-new, port 10030)
        with ESMTP id DMEP-OsZxQDs; Wed,  9 Aug 2017 00:53:34 +0200 (CEST)
...
Subject: [PATCH v9 12/16] MIPS: lantiq: Add a GPHY driver which uses the RCU syscon-mfd
Date:   Wed,  9 Aug 2017 00:52:43 +0200
Message-Id: <20170808225247.32266-13-hauke@hauke-m.de>
