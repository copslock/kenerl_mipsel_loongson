Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 12 Nov 2017 07:37:31 +0100 (CET)
Received: from forward103p.mail.yandex.net ([77.88.28.106]:47197 "EHLO
        forward103p.mail.yandex.net" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23990434AbdKLGhB4CftX (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sun, 12 Nov 2017 07:37:01 +0100
Received: from mxback11j.mail.yandex.net (mxback11j.mail.yandex.net [IPv6:2a02:6b8:0:1619::84])
        by forward103p.mail.yandex.net (Yandex) with ESMTP id 463FB21815BB;
        Sun, 12 Nov 2017 09:36:56 +0300 (MSK)
Received: from smtp1p.mail.yandex.net (smtp1p.mail.yandex.net [2a02:6b8:0:1472:2741:0:8b6:6])
        by mxback11j.mail.yandex.net (nwsmtp/Yandex) with ESMTP id gCjTXtCdc8-atLe3V71;
        Sun, 12 Nov 2017 09:36:56 +0300
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=flygoat.com; s=mail; t=1510468616;
        bh=gaLOZJaNV9q9uZeBMYryemfM0PoXiUJRylI+rI29fX0=;
        h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References;
        b=IJyr5zc/T2phNbiYasqyGg4twzEmt4bmCT4fFZ//4lHwVnicLsDCJpns7t5+pPYC1
         NNBUAxCxy+tqXguHn+vJO/hUMYVftvYD22TKNzBsPAh7Gkdz5UVgtx+GeoPWk3X0GZ
         ZJlqRsxFP3kT/JX6PB99i0Ug5rQihdy6+r1yBiHg=
Received: by smtp1p.mail.yandex.net (nwsmtp/Yandex) with ESMTPSA id 0pMwdlaAMA-aqZWsFZq;
        Sun, 12 Nov 2017 09:36:54 +0300
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (Client certificate not present)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=flygoat.com; s=mail; t=1510468615;
        bh=gaLOZJaNV9q9uZeBMYryemfM0PoXiUJRylI+rI29fX0=;
        h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References;
        b=DdFJCva2xgBDD4IRiFtXMLUFtFrXI2mREmQEhclfdYfVjIPbGzIbJFqX2TvEmCsoM
         N+r0Ud8bvimQuQKMhmGvpFuEt32pkI4D7dgEPIrEHOTBM1T0uYx1TfW6EUh/5FZpNi
         UI42sx9TpIe0klojZ748UcSjQhUNU/IsHlZzBDyw=
...
Subject: [PATCH 2/4] MIPS: Loongson64: lemote-2f move ec_kb3310b.h to include dir and clean up To operate EC from platform driver, this head file need able to be include from anywhere. This patch just move ec_kb3310b.h to include dir and clean up ec_kb3310b.h.
Date:   Sun, 12 Nov 2017 14:36:15 +0800
Message-Id: <20171112063617.26546-2-jiaxun.yang@flygoat.com>
