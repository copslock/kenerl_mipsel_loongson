Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 18 Jun 2007 22:01:28 +0100 (BST)
Received: from smtp110.sbc.mail.mud.yahoo.com ([68.142.198.209]:60277 "HELO
	smtp110.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S20023304AbXFRVBY (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Mon, 18 Jun 2007 22:01:24 +0100
Received: (qmail 14611 invoked from network); 18 Jun 2007 21:00:16 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@76.202.77.159 with login)
  by smtp110.sbc.mail.mud.yahoo.com with SMTP; 18 Jun 2007 21:00:15 -0000
X-YMail-OSG: AWglXJcVM1mZEjTUVtD9yCGWy0M5BJBfaiwtdO9TUaOanEJfkLs4ojXTTvwvG7aX5as1Y20zaqU_SkLU4MGJ3qJPcQ--
Received: by lucon.org (Postfix, from userid 500)
	id C0A0246EEA9; Mon, 18 Jun 2007 14:00:13 -0700 (PDT)
Date:	Mon, 18 Jun 2007 14:00:13 -0700
...
Subject: The Linux binutils 2.17.50.0.17 is released
Message-ID: <20070618210013.GA26404@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.17.50.0.17 to hjl@lucon.org
...
1. binutils-2.17.50.0.17.tar.bz2. Source code.
2. binutils-2.17.50.0.16-2.17.50.0.17.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.17.50.0.17.i686.tar.bz2. IA-32 binary tar ball for RedHat
   EL 4.
4. binutils-2.17.50.0.17.ia64.tar.bz2. IA-64 binary tar ball for RedHat
   EL 4.
5. binutils-2.17.50.0.17.x86_64.tar.bz2. X64_64 binary tar ball for RedHat
   EL 4.
