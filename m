Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 10 Dec 2008 23:40:54 +0000 (GMT)
Received: from mail3.caviumnetworks.com ([12.108.191.235]:48203 "EHLO
	mail3.caviumnetworks.com") by ftp.linux-mips.org with ESMTP
	id S24207737AbYLJXj4 (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Wed, 10 Dec 2008 23:39:56 +0000
Received: from exch4.caveonetworks.com (Not Verified[192.168.16.23]) by mail3.caviumnetworks.com with MailMarshal (v6,2,2,3503)
	id <B494053400003>; Wed, 10 Dec 2008 18:39:44 -0500
Received: from exch4.caveonetworks.com ([192.168.16.23]) by exch4.caveonetworks.com with Microsoft SMTPSVC(6.0.3790.3959);
	 Wed, 10 Dec 2008 15:39:24 -0800
Received: from dd1.caveonetworks.com ([64.169.86.201]) by exch4.caveonetworks.com over TLS secured channel with Microsoft SMTPSVC(6.0.3790.3959);
	 Wed, 10 Dec 2008 15:39:24 -0800
Received: from dd1.caveonetworks.com (localhost.localdomain [127.0.0.1])
	by dd1.caveonetworks.com (8.14.2/8.14.2) with ESMTP id mBANdJ9c012355;
	Wed, 10 Dec 2008 15:39:19 -0800
Received: (from ddaney@localhost)
	by dd1.caveonetworks.com (8.14.2/8.14.2/Submit) id mBANdJrJ012354;
	Wed, 10 Dec 2008 15:39:19 -0800
From:	David Daney <ddaney@caviumnetworks.com>
To:	linux-ide@vger.kernel.org
Cc:	linux-mips@linux-mips.org, David Daney <ddaney@caviumnetworks.com>
Subject: [PATCH 3/3] libata: New driver for OCTEON SOC Compact Flash interface (v5).
Date:	Wed, 10 Dec 2008 15:39:13 -0800
Message-Id: <1228952353-12323-3-git-send-email-ddaney@caviumnetworks.com>
X-Mailer: git-send-email 1.5.6.5
In-Reply-To: <494052D1.10208@caviumnetworks.com>
References: <494052D1.10208@caviumnetworks.com>
X-OriginalArrivalTime: 10 Dec 2008 23:39:24.0301 (UTC) FILETIME=[8871CBD0:01C95B20]
Return-Path: <David.Daney@caviumnetworks.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 21577
...
In this fifth version, I have tried to address Sergei Shtylyov's
comments regarding the various timing parameters. Several timing
parameters were adjusted based on testing with a logic analyzer.

The status polling tasklet was changed to a workqueue as the polling
with a tasklet was using 100% of one CPU for extended periods.
