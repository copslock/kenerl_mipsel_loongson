Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Dec 2015 19:01:37 +0100 (CET)
Received: from mail-pa0-f66.google.com ([209.85.220.66]:34949 "EHLO
        mail-pa0-f66.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S27013556AbbLISA1Z0OIm (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 9 Dec 2015 19:00:27 +0100
Received: by padhk6 with SMTP id hk6so3455829pad.2
        for <linux-mips@linux-mips.org>; Wed, 09 Dec 2015 10:00:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=jhdgalLjudlUzMIYaRCqlq6s79ya0duf+wzq4mymln4=;
        b=
X-Received: by 10.66.224.165 with SMTP id rd5mr9764984pac.73.1449684021415;
        Wed, 09 Dec 2015 10:00:21 -0800 (PST)
Received: from decotigny.mtv.corp.google.com ([172.18.64.159])
        by smtp.gmail.com with ESMTPSA id 82sm13056535pfn.76.2015.12.09.10.00.20
...
Subject: [PATCH net-next v4 05/19] net: ethtool: add new ETHTOOL_GSETTINGS/SSETTINGS API
Date:   Wed,  9 Dec 2015 09:59:15 -0800
Message-Id: <1449683969-7305-6-git-send-email-ddecotig@gmail.com>
...
@@ -1438,4 +1509,121 @@ enum ethtool_reset_flags {
 };
...
index 29edf74..4865031 100644
--- a/net/core/ethtool.c
+++ b/net/core/ethtool.c
@@ -352,6 +352,317 @@ static int __ethtool_set_flags(struct net_device *dev, u32 data)
 	return 0;
 }
...
+ */
 ...
 {
 	ASSERT_RTNL();
@@ -365,30 +676,108 @@ int __ethtool_get_settings(struct net_device *dev, struct ethtool_cmd *cmd)
 }
...
@@ -1991,6 +2380,12 @@ int dev_ethtool(struct net *net, struct ifreq *ifr)
