Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 14 Oct 2009 12:28:02 +0200 (CEST)
Received: from localhost.localdomain ([127.0.0.1]:48880 "EHLO h5.dl5rb.org.uk"
	rhost-flags-OK-OK-OK-FAIL) by ftp.linux-mips.org with ESMTP
	id S1492673AbZJNK1z (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Wed, 14 Oct 2009 12:27:55 +0200
Received: from h5.dl5rb.org.uk (localhost.localdomain [127.0.0.1])
	by h5.dl5rb.org.uk (8.14.3/8.14.3) with ESMTP id n9EATCOM027115
	for <linux-mips@linux-mips.org>; Wed, 14 Oct 2009 12:29:12 +0200
Received: (from ralf@localhost)
	by h5.dl5rb.org.uk (8.14.3/8.14.3/Submit) id n9EATCiR027113
	for linux-mips@linux-mips.org; Wed, 14 Oct 2009 12:29:12 +0200
Resent-From: ralf@linux-mips.org
Resent-Date: Wed, 14 Oct 2009 12:29:12 +0200
Resent-Message-ID: <20091014102912.GA27092@linux-mips.org>
Resent-To: linux-mips@linux-mips.org
Received: from mail-px0-f187.google.com ([209.85.216.187]:39687 "EHLO
	mail-px0-f187.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S1492582AbZJNKMf (ORCPT
	<rfc822;ralf@linux-mips.org>); Wed, 14 Oct 2009 12:12:35 +0200
Received: by pxi17 with SMTP id 17so1190220pxi.21
        for <ralf@linux-mips.org>; Wed, 14 Oct 2009 03:12:26 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer;
        bh=oGB8nFVDTVP8gHYNjumSNcMvQQxnzTmi9R+0DXOCmc0=;
        b=l9gBT4FxP/USOBFpuC5Mh1GlXtIpRUEj6F992uzQnQlIg4O/xzlji4cVboR8s0ZV8l
         UFSsgjqEmAH0+ZfdlkijW2lutr0efG31YbohdB7Zx/61xI04tgrVZPFCetrKrZn6GikX
         MaxBCCSe+GGAkrd1xSJBHo4+yKIfj9030Yyzc=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer;
        b=q1Nn6mYdd+Ef6saSJQSz5nLlyyJdhRHSVZf4nC9SpVLQMd3XJhgpxGXYgfQtiQO5Vo
         IutdQgpo0j3aaGldUbSbdNu86iqi++Yf9OB66zA14+ZnZ8GLMYoB1yrWIS7bO5cidN1k
         3Hv7xjr/+8v0NoQBmYqsQGpWkl50JVrvW7vuw=
Received: by 10.115.80.7 with SMTP id h7mr460787wal.60.1255515146043;
        Wed, 14 Oct 2009 03:12:26 -0700 (PDT)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id 21sm676252pxi.11.2009.10.14.03.12.23
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Wed, 14 Oct 2009 03:12:25 -0700 (PDT)
From:	Wu Zhangjin <wuzhangjin@gmail.com>
To:	Ralf Baechle <ralf@linux-mips.org>
Cc:	Wu Zhangjin <wuzhangjin@gmail.com>
Subject: [PATCH-latest] MIPS: add support for gzip/bzip2/lzma compressed kernel images
Date:	Wed, 14 Oct 2009 18:12:16 +0800
Message-Id: <1255515136-11215-1-git-send-email-wuzhangjin@gmail.com>
X-Mailer: git-send-email 1.6.2.1
Return-Path: <ralf@linux-mips.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 24298
