Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 30 Apr 2015 17:31:15 +0200 (CEST)
Received: from down.free-electrons.com ([37.187.137.238]:37512 "EHLO
        mail.free-electrons.com" rhost-flags-OK-OK-OK-FAIL)
        by eddie.linux-mips.org with ESMTP id S27026361AbbD3Paa0pUmU (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 30 Apr 2015 17:30:30 +0200
Received: by mail.free-electrons.com (Postfix, from userid 106)
        id 686F76A3; Thu, 30 Apr 2015 17:30:19 +0200 (CEST)
Received: from localhost.localdomain (col31-4-88-188-83-94.fbx.proxad.net [88.188.83.94])
        by mail.free-electrons.com (Postfix) with ESMTPSA id 0E1093C6;
        Thu, 30 Apr 2015 17:30:18 +0200 (CEST)
...
Subject: [PATCH v2 2/2] clk: change clk_ops' ->determine_rate() prototype
Date:   Thu, 30 Apr 2015 17:30:09 +0200
Message-Id: <1430407809-31147-3-git-send-email-boris.brezillon@free-electrons.com>
...
CC: linux-mips@linux-mips.org
 ...
 19 files changed, 282 insertions(+), 224 deletions(-)
...
index 08a2ee2..3cb5c3d 100644
--- a/drivers/clk/at91/clk-usb.c
+++ b/drivers/clk/at91/clk-usb.c
@@ -56,12 +56,12 @@ static unsigned long at91sam9x5_clk_usb_recalc_rate(struct clk_hw *hw,
...
+					     struct clk_hw **best_parent_hw)
 {
 	struct clk *parent = NULL;
 	long best_rate = -EINVAL;
@@ -80,14 +80,14 @@ static long at91sam9x5_clk_usb_determine_rate(struct clk_hw *hw,
...
+				tmp_diff = tmp_rate - *rate;
 			...
 			if (best_diff < 0 || best_diff > tmp_diff) {
 				best_rate = tmp_rate;
@@ -96,7 +96,7 @@ static long at91sam9x5_clk_usb_determine_rate(struct clk_hw *hw,
 				*best_parent_hw = __clk_get_hw(parent);
 			}
...
@@ -104,7 +104,9 @@ static long at91sam9x5_clk_usb_determine_rate(struct clk_hw *hw,
 			break;
 	}
...
@@ -1637,7 +1643,7 @@ static struct clk_core *clk_calc_new_rates(struct clk_core *clk,
...
index 245d506..627293a 100644
--- a/drivers/clk/qcom/clk-pll.c
+++ b/drivers/clk/qcom/clk-pll.c
@@ -135,19 +135,21 @@ struct pll_freq_tbl *find_freq(const struct pll_freq_tbl *f, unsigned long rate)
 	return NULL;
 }
...
index 7b3d626..8d15a86 100644
--- a/drivers/clk/qcom/clk-rcg.c
+++ b/drivers/clk/qcom/clk-rcg.c
@@ -404,17 +404,17 @@ clk_dyn_rcg_recalc_rate(struct clk_hw *hw, unsigned long parent_rate)
...
@@ -425,23 +425,24 @@ static long _freq_tbl_determine_rate(struct clk_hw *hw,
...
+static int clk_rcg_determine_rate(struct clk_hw *hw, unsigned long *rate,
 		...
 		unsigned long *p_rate, struct clk_hw **p)
 {
@@ -451,7 +452,7 @@ static long clk_rcg_determine_rate(struct clk_hw *hw, unsigned long rate,
...
+static int clk_dyn_rcg_determine_rate(struct clk_hw *hw, unsigned long *rate,
 		...
 		unsigned long *p_rate, struct clk_hw **p)
 {
@@ -468,7 +469,7 @@ static long clk_dyn_rcg_determine_rate(struct clk_hw *hw, unsigned long rate,
...
+static int clk_rcg_bypass_determine_rate(struct clk_hw *hw, unsigned long *rate,
 		...
 		unsigned long *p_rate, struct clk_hw **p_hw)
 {
@@ -479,9 +480,10 @@ static long clk_rcg_bypass_determine_rate(struct clk_hw *hw, unsigned long rate,
...
index b95d17f..db1f1c9 100644
--- a/drivers/clk/qcom/clk-rcg2.c
+++ b/drivers/clk/qcom/clk-rcg2.c
@@ -176,16 +176,16 @@ clk_rcg2_recalc_rate(struct clk_hw *hw, unsigned long parent_rate)
...
@@ -197,26 +197,27 @@ static long _freq_tbl_determine_rate(struct clk_hw *hw,
 	p = clk_get_parent_by_index(hw->clk, index);
 	if (clk_flags & CLK_SET_RATE_PARENT) {
 		if (f->pre_div) {
-			rate /= 2;
...
+static long clk_rcg2_determine_rate(struct clk_hw *hw, unsigned long *rate,
 		...
 		unsigned long *p_rate, struct clk_hw **p)
 {
@@ -374,7 +375,7 @@ static int clk_edp_pixel_set_rate_and_parent(struct clk_hw *hw,
...
+static int clk_edp_pixel_determine_rate(struct clk_hw *hw, unsigned long *rate,
 				 ...
 				 unsigned long max_rate,
 				 unsigned long *p_rate, struct clk_hw **p)
@@ -398,7 +399,7 @@ static long clk_edp_pixel_determine_rate(struct clk_hw *hw, unsigned long rate,
...
@@ -410,8 +411,10 @@ static long clk_edp_pixel_determine_rate(struct clk_hw *hw, unsigned long rate,
...
+		return 0;
 	...
 	return -EINVAL;
@@ -428,7 +431,7 @@ const struct clk_ops clk_edp_pixel_ops = {
 };
...
+static int clk_byte_determine_rate(struct clk_hw *hw, unsigned long *rate,
 			 ...
 			 unsigned long *p_rate, struct clk_hw **p_hw)
 {
@@ -439,17 +442,18 @@ static long clk_byte_determine_rate(struct clk_hw *hw, unsigned long rate,
...
@@ -494,7 +498,7 @@ static const struct frac_entry frac_table_pixel[] = {
 	{ }
 };
...
+static int clk_pixel_determine_rate(struct clk_hw *hw, unsigned long *rate,
 				 ...
 				 unsigned long max_rate,
 				 unsigned long *p_rate, struct clk_hw **p)
@@ -510,7 +514,7 @@ static long clk_pixel_determine_rate(struct clk_hw *hw, unsigned long rate,
...
+		request = (*rate * frac->den) / frac->num;
 		...
 		if ((src_rate < (request - delta)) ||
@@ -518,7 +522,9 @@ static long clk_pixel_determine_rate(struct clk_hw *hw, unsigned long rate,
 			continue;
