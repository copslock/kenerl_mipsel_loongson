Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 24 Mar 2013 14:49:08 +0100 (CET)
Received: from mail-pa0-f42.google.com ([209.85.220.42]:45753 "EHLO
        mail-pa0-f42.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6824729Ab3CXNs7pangX (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sun, 24 Mar 2013 14:48:59 +0100
Received: by mail-pa0-f42.google.com with SMTP id kq12so607566pab.1
        for <linux-mips@linux-mips.org>; Sun, 24 Mar 2013 06:48:52 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20120113;
        h=x-received:from:to:cc:subject:date:message-id:x-mailer
         :x-gm-message-state;
        bh=3I2SexdBP9C83HgwBtJq+SGS3d5vMawBCQT2Eb9K/io=;
        b=
X-Received: by 10.66.163.132 with SMTP id yi4mr13034970pab.104.1364132932429;
        Sun, 24 Mar 2013 06:48:52 -0700 (PDT)
Received: from localhost ([122.166.179.164])
        by mx.google.com with ESMTPS id fc8sm10813663pad.21.2013.03.24.06.48.39
        (version=TLSv1.2 cipher=RC4-SHA bits=128/128);
        Sun, 24 Mar 2013 06:48:51 -0700 (PDT)
...
Date:   Sun, 24 Mar 2013 19:18:31 +0530
Message-Id: <981c23bd4b2a14c346820685e1203ab7054378f8.1364132845.git.viresh.kumar@linaro.org>
X-Mailer: git-send-email 1.7.12.rc2.18.g61b472e
X-Gm-Message-State: ALoCoQnZSnmeo5gA2IKpcBvr0JSxENdUXdYEtqGaTDuChpGEZ1qrapiOloNO0x0qOXdieBwMBRuO
X-archive-position: 35965
...
index e3d6e15..3b441d6 100644
--- a/arch/arm/mach-tegra/cpu-tegra.c
+++ b/arch/arm/mach-tegra/cpu-tegra.c
@@ -128,8 +128,7 @@ static int tegra_update_cpu_speed(unsigned long rate)
 	else
...
@@ -143,8 +142,7 @@ static int tegra_update_cpu_speed(unsigned long rate)
 		return ret;
 	}
...
@@ -65,10 +65,7 @@ static int cpu0_set_target(struct cpufreq_policy *policy,
 	if (freqs.old == freqs.new)
 		return 0;
...
+	cpufreq_notify_transition(policy, &freqs, CPUFREQ_PRECHANGE);
 	...
 	if (cpu_reg) {
 		rcu_read_lock();
@@ -117,10 +114,7 @@ static int cpu0_set_target(struct cpufreq_policy *policy,
 		}
 	}
...
index b02824d..2cc6bc4 100644
--- a/drivers/cpufreq/cpufreq.c
+++ b/drivers/cpufreq/cpufreq.c
@@ -244,19 +244,9 @@ static inline void adjust_jiffies(unsigned long val, struct cpufreq_freqs *ci)
 #endif
...
-
 	...
 	if (cpufreq_disabled())
@@ -266,10 +256,6 @@ void cpufreq_notify_transition(struct cpufreq_freqs *freqs, unsigned int state)
...
@@ -303,6 +289,20 @@ void cpufreq_notify_transition(struct cpufreq_freqs *freqs, unsigned int state)
 		break;
 	}
 }
+/**
...
@@ -1134,16 +1134,23 @@ static void handle_update(struct work_struct *work)
...
index a22944c..47be364 100644
--- a/include/linux/cpufreq.h
+++ b/include/linux/cpufreq.h
@@ -268,8 +268,8 @@ int cpufreq_register_driver(struct cpufreq_driver *driver_data);
