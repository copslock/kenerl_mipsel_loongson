Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 28 Jun 2010 03:24:58 +0200 (CEST)
Received: from smtp-out-143.synserver.de ([212.40.180.143]:1048 "HELO
        smtp-out-143.synserver.de" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with SMTP id S1492238Ab0F1BYw (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 28 Jun 2010 03:24:52 +0200
Received: (qmail 12810 invoked by uid 0); 28 Jun 2010 01:24:49 -0000
X-SynServer-TrustedSrc: 1
X-SynServer-AuthUser: lars@laprican.de
X-SynServer-PPID: 12743
Received: from port-13405.pppoe.wtnet.de (HELO localhost.localdomain) [84.46.52.145]
  by 217.119.54.77 with SMTP; 28 Jun 2010 01:24:48 -0000
From:   Lars-Peter Clausen <lars@metafoo.de>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, linux-kernel@vger.kernel.org,
        Lars-Peter Clausen <lars@metafoo.de>
Subject: [PATCH v3 03/26] MIPS: JZ4740: Add clock API support.
Date:   Mon, 28 Jun 2010 03:24:23 +0200
Message-Id: <1277688263-28005-1-git-send-email-lars@metafoo.de>
X-Mailer: git-send-email 1.5.6.5
In-Reply-To: <1276924111-11158-4-git-send-email-lars@metafoo.de>
References: <1276924111-11158-4-git-send-email-lars@metafoo.de>
X-archive-position: 27264
