Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 13 Feb 2014 13:11:34 +0100 (CET)
Received: from mail-pb0-f42.google.com ([209.85.160.42]:39329 "EHLO
        mail-pb0-f42.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6867080AbaBMMKjUfOXE (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 13 Feb 2014 13:10:39 +0100
Received: by mail-pb0-f42.google.com with SMTP id jt11so10722457pbb.15
        for <multiple recipients>; Thu, 13 Feb 2014 04:10:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=sender:from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=zLC+TxuXZ6MaBg2c7oBIIJLpZduCT+w4BHuXnVMcOtc=;
        b=
X-Received: by 10.68.197.8 with SMTP id iq8mr1326230pbc.124.1392293432265;
        Thu, 13 Feb 2014 04:10:32 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPSA id f5sm13421356pat.11.2014.02.13.04.10.22
        for <multiple recipients>
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Thu, 13 Feb 2014 04:10:31 -0800 (PST)
...
Subject: [PATCH V18 05/13] MIPS: Loongson: Add UEFI-like firmware interface (LEFI) support
Date:   Thu, 13 Feb 2014 20:08:55 +0800
Message-Id: <1392293343-5453-6-git-send-email-chenhc@lemote.com>
...
@@ -57,8 +57,43 @@ void __init prom_init_env(void)
 	}
 	if (memsize == 0)
 		memsize = 256;
-	if (bus_clock == 0)
...
@@ -68,12 +103,13 @@ void __init prom_init_env(void)
