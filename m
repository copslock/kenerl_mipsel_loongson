Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 10 Mar 2007 14:55:41 +0000 (GMT)
Received: from mba.ocn.ne.jp ([122.1.175.29]:45273 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S20021834AbXCJOzg (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Sat, 10 Mar 2007 14:55:36 +0000
Received: from localhost (p5205-ipad211funabasi.chiba.ocn.ne.jp [58.91.161.205])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 33AC8A64F; Sat, 10 Mar 2007 23:54:14 +0900 (JST)
Date:	Sat, 10 Mar 2007 23:54:14 +0900 (JST)
Message-Id: <20070310.235414.93019736.anemo@mba.ocn.ne.jp>
To:	linux-mips@linux-mips.org
Cc:	ralf@linux-mips.org
Subject: Re: [PATCH] Cleanup FPU ownership management (alternative version)
From:	Atsushi Nemoto <anemo@mba.ocn.ne.jp>
In-Reply-To: <20070310.013248.45177878.anemo@mba.ocn.ne.jp>
References: <20070310.013248.45177878.anemo@mba.ocn.ne.jp>
...
On Sat, 10 Mar 2007 01:32:48 +0900 (JST), Atsushi Nemoto <anemo@mba.ocn.ne.jp> wrote:
...
Sorry, I had broken this patch when updating.  Here is a correct one.
...
index c4ef270..5b50569 100644
--- a/arch/mips/kernel/signal.c
+++ b/arch/mips/kernel/signal.c
@@ -111,14 +111,7 @@ int setup_sigcontext(struct pt_regs *reg
...
@@ -190,20 +183,16 @@ int restore_sigcontext(struct pt_regs *r
