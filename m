Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 24 Oct 2010 20:37:45 +0200 (CEST)
Received: from mail-wy0-f177.google.com ([74.125.82.177]:63768 "EHLO
        mail-wy0-f177.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491151Ab0JXSgu (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sun, 24 Oct 2010 20:36:50 +0200
Received: by wyf22 with SMTP id 22so2735580wyf.36
        for <linux-mips@linux-mips.org>; Sun, 24 Oct 2010 11:36:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlemail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=FwxzxflrDar9v0sz4SAWQJLnMsWVjKchOyWZmHjLLVI=;
        b=n2Oy6gY5HdOcSV+cw/FTZ0Y+dIcVkGy5Alnjniv0nt2R6YF80HlBh4I/qmKF1u92IP
         +roBL818ZH17nB76yrDiU5jLYT87cIY52jgOj4rkLvOVe7kOxfnjjNo6H6SkaXyl6pOn
         ujTocEcTIb6w049SpLJq803Ko0oi88essyBrk=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=googlemail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=d6Bgv41p8LUfFPJpjgvO1tUEJiUjN5U7Ij1cONSIQK9y/pUeIIk3v0/Wm/ifyblAv3
         AdP09Q9qsRGGaiN0q5CLZZd9sy9GhYyPDz8KjK5iyKt8DOdhWpEWANvP165U4R/gJwwv
         s5+SImDm88art8cJCPZ3YvOJKB9oZ7QuKSzMQ=
Received: by 10.227.147.149 with SMTP id l21mr4210431wbv.171.1287945405361;
        Sun, 24 Oct 2010 11:36:45 -0700 (PDT)
Received: from localhost.localdomain (188-22-0-103.adsl.highway.telekom.at [188.22.0.103])
        by mx.google.com with ESMTPS id i19sm4836481wbe.11.2010.10.24.11.36.42
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Sun, 24 Oct 2010 11:36:44 -0700 (PDT)
From:   Manuel Lauss <manuel.lauss@googlemail.com>
To:     Linux-MIPS <linux-mips@linux-mips.org>
Cc:     Manuel Lauss <manuel.lauss@googlemail.com>
Subject: [PATCH RESEND 2/2] MIPS: Alchemy: DB1300 support
Date:   Sun, 24 Oct 2010 20:36:33 +0200
Message-Id: <1287945393-10080-3-git-send-email-manuel.lauss@googlemail.com>
...
---
What works:
- Ethernet (NFSroot), PCMCIA, serial ports, IDE (no DMA, booting broken)
  NOR/NAND flashes, the 5-way switch, RTC, I2C.
- Audio works as well but depends on ASoC merge and another bug to
  be fixed.
- other stuff is in the works and will come as time permits.
 ...
 14 files changed, 1296 insertions(+), 11 deletions(-)
...
+	__raw_writel(0, addr + UART_MOD_CNTRL);
+	wmb();
+	__raw_writel(1, addr + UART_MOD_CNTRL);
+	wmb();
+	__raw_writel(3, addr + UART_MOD_CNTRL);
+	wmb();
+}
+
...
+
+	/* set Config_OD bit to disable overlapping bus transactions,
+	 * which gets rid of a LOT (but not all) spurious interrupts
+	 * from the CPLD.
+	 */
+	set_c0_config(1 << 19);
+
...
+#else	/* Au1550/Au1200/Au1300-based develboards */
