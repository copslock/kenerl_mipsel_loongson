...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id B8178C43381
	for <linux-mips@archiver.kernel.org>; Fri,  1 Mar 2019 16:21:45 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 68D132083D
	for <linux-mips@archiver.kernel.org>; Fri,  1 Mar 2019 16:21:45 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=crapouillou.net header.i=@crapouillou.net header.b="a3JEali/"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389010AbfCAQVp (ORCPT <rfc822;linux-mips@archiver.kernel.org>);
        Fri, 1 Mar 2019 11:21:45 -0500
Received: from outils.crapouillou.net ([89.234.176.41]:57550 "EHLO
        crapouillou.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725966AbfCAQVo (ORCPT
        <rfc822;linux-mips@vger.kernel.org>); Fri, 1 Mar 2019 11:21:44 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=crapouillou.net;
        s=mail; t=1551457300; h=from:from:sender:reply-to:subject:subject:date:date:
         message-id:message-id:to:to:cc:cc:mime-version:mime-version:
         content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=z2lax6+ZOC0mwc8ZYDmSSD2EPIS5kJo5fPsPNWaa3Fc=;
        b=a3JEali/omVk0mhszk45YeEoQUERg4j3CrSQM5xYkGFgTbntirSpuRNzmTzHZ3nNJSb01o
        FrB65T7HqW4sN7Hej/lBx9lVOWmy8eLIq/OH/sEKrsQFYFwXB+kWJRLidP6vQsolpHfNJL
        kIQD5YaSRmp1OnrNK1SnQiKtXmgsD/E=
Date:   Fri, 01 Mar 2019 13:21:26 -0300
...
Message-Id: <1551457286.1821.0@crapouillou.net>
...
Le ven. 1 mars 2019 =E0 5:26, Daniel Vetter <daniel@ffwll.ch> a =E9crit :
...
Sorry I didn't quite understand what you wrote here. What do you mean by
"embedding"?
...
Yes, the reason is that I will then add support for newer SoCs that can
deal with overlay planes, have an integrated IPU for scaling and=20
colorspace
conversion, and have different possible outputs (LCD panel, TV-out,=20
HDMI).
