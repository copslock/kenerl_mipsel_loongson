Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 23 Apr 2009 01:15:04 +0100 (BST)
Received: from mba.ocn.ne.jp ([122.1.235.107]:6129 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S29051800AbZDVPk1 (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Wed, 22 Apr 2009 16:40:27 +0100
Received: from localhost.localdomain (p2187-ipad213funabasi.chiba.ocn.ne.jp [124.85.67.187])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id 45FD69D75; Thu, 23 Apr 2009 00:40:18 +0900 (JST)
From:	Atsushi Nemoto <anemo@mba.ocn.ne.jp>
To:	linux-mips@linux-mips.org
Cc:	ralf@linux-mips.org, dan.j.williams@intel.com,
	linux-kernel@vger.kernel.org
Subject: [PATCH] DMA: TXx9 Soc DMA Controller driver (v3)
Date:	Thu, 23 Apr 2009 00:40:30 +0900
Message-Id: <1240414831-20429-1-git-send-email-anemo@mba.ocn.ne.jp>
X-Mailer: git-send-email 1.5.6.3
Return-Path: <anemo@mba.ocn.ne.jp>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 22421
...
---
Changes since v2:
* move some definitions and ifdef magics into txx9dmac.h
* auto detect IRQ_PER_CHAN
* add a comment for tx_list management

 arch/mips/include/asm/txx9/dmac.h |   48 ++
 drivers/dma/Kconfig               |    8 +
 drivers/dma/Makefile              |    1 +
 drivers/dma/txx9dmac.c            | 1344 +++++++++++++++++++++++++++++++++++++
 drivers/dma/txx9dmac.h            |  307 +++++++++
 ...
 create mode 100644 drivers/dma/txx9dmac.h
