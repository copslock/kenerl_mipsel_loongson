Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 09 Aug 2017 00:54:39 +0200 (CEST)
Received: from mx1.mailbox.org ([80.241.60.212]:54060 "EHLO mx1.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995158AbdHHWxZErfDu (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Wed, 9 Aug 2017 00:53:25 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx1.mailbox.org (Postfix) with ESMTPS id 997D545FC3;
        Wed,  9 Aug 2017 00:53:19 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by hefe.heinlein-support.de (hefe.heinlein-support.de [91.198.250.172]) (amavisd-new, port 10030)
        with ESMTP id h_PvLK1E4s0n; Wed,  9 Aug 2017 00:53:17 +0200 (CEST)
...
Subject: [PATCH v9 03/16] mtd: spi-falcon: drop check of boot select
Date:   Wed,  9 Aug 2017 00:52:34 +0200
