Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 12 Oct 2010 13:36:47 +0200 (CEST)
Received: from mail-px0-f177.google.com ([209.85.212.177]:64491 "EHLO
        mail-px0-f177.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491084Ab0JLLfU (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 12 Oct 2010 13:35:20 +0200
Received: by mail-px0-f177.google.com with SMTP id 12so1155536pxi.36
        for <multiple recipients>; Tue, 12 Oct 2010 04:35:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=lHR3WKrEVUaXHfP5l3y5jmaYv8RBzxzGVdlaIHNLvC4=;
        b=dsWifFpXYk9p+oTbb2R1vvHDfIsUngclO4gtIy2a0hxvu01wrVT7UBLFKXDTtnDO68
         JkUc7Zd0HAST/zJg6Io07df3i+des4khJeYfmUVWDktX0CS/rbY5o+IoulsBiiQSXrW+
         cAtx5e08ukl3IcJwiwqYULtQvNeOPkThZxpXo=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=q9MAlcsXWSTE/p2v4vEDSXbbh8C7u7H4BbfPhQVfqzKZdTdD85VaEtotTByy3bMOXQ
         XStq1qAXG0Lsx62foWYYqnjidfeFXpEMBPbjg2PL30EsD3DOvSyGP3aCmnMCyl2A0Mm2
         mzQHZ+/BDrTFPp9KYd//4sMunOqEXLexwAlvM=
Received: by 10.114.75.17 with SMTP id x17mr8354624waa.177.1286883319356;
        Tue, 12 Oct 2010 04:35:19 -0700 (PDT)
Received: from localhost.localdomain ([210.13.118.102])
        by mx.google.com with ESMTPS id p6sm10434885wal.19.2010.10.12.04.35.14
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Tue, 12 Oct 2010 04:35:18 -0700 (PDT)
...
Subject: [PATCH v8 5/5] MIPS: add support for hardware performance events (mipsxx)
Date:   Tue, 12 Oct 2010 19:37:24 +0800
Message-Id: <1286883444-31913-6-git-send-email-dengcheng.zhu@gmail.com>
