Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 15 Nov 2018 07:16:43 +0100 (CET)
Received: from mail-pg1-x542.google.com ([IPv6:2607:f8b0:4864:20::542]:45487
        "EHLO mail-pg1-x542.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S23992811AbeKOGPVB1MP4 (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 15 Nov 2018 07:15:21 +0100
Received: by mail-pg1-x542.google.com with SMTP id y4so8514571pgc.12
        for <linux-mips@linux-mips.org>; Wed, 14 Nov 2018 22:15:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=p1KkTLPrlOdIU56PsFOmeGzbbU1+4/R/L+/AcN3a9K4=;
        b=dYb9yHGIBYzHbQIaGSvt0PQmbjgYw/9daHnmBajsy0D5Ufsap/D39ICfFq/YAhZnRj
         9sJEzL43YH4u4JuLKe32yM8eO8fbvG3hcOUE8rCTN4AC6bMVGCkD4kWbe1QWjRCfHntD
         /JGwBgn9ol1lVy3CL18XhwR8f2f/0tT9SODE0=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=p1KkTLPrlOdIU56PsFOmeGzbbU1+4/R/L+/AcN3a9K4=;
        b=
X-Gm-Message-State: AGRZ1gIVrodFKaToXLKMAW+xusAfdT4w6cSh0IMO4JivuYLKKqIFb4dA
        ukrkoU6qukUhvJuVmR9IIpqTww==
X-Google-Smtp-Source: AJdET5efyoBKUvQfBH6BLmiQEqTzbbz72do/7o4IYELtOSnvnJqqCyzKhU3A/NI3Ngh/JFbenH6fQA==
X-Received: by 2002:a63:5d14:: with SMTP id r20mr4665579pgb.329.1542262518362;
        Wed, 14 Nov 2018 22:15:18 -0800 (PST)
Received: from qualcomm-HP-ZBook-14-G2.qualcomm.com (blr-bdr-fw-01_globalnat_allzones-outside.qualcomm.com. [103.229.18.19])
        by smtp.gmail.com with ESMTPSA id 34sm39861931pgp.90.2018.11.14.22.15.12
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
        Wed, 14 Nov 2018 22:15:17 -0800 (PST)
...
Subject: [PATCH v2 5/5] mips: generate uapi header and system call table files
Date:   Thu, 15 Nov 2018 11:44:21 +0530
Message-Id: <1542262461-29024-6-git-send-email-firoz.khan@linaro.org>
...
---
 ...
 arch/mips/include/uapi/asm/unistd.h | 1056 +----------------------------------
 arch/mips/kernel/scall32-o32.S      |  372 +-----------
 arch/mips/kernel/scall64-64.S       |  333 +----------
 arch/mips/kernel/scall64-n32.S      |  337 +----------
 arch/mips/kernel/scall64-o32.S      |  373 +------------
 8 files changed, 25 insertions(+), 2456 deletions(-)
...
index 4eee437..c98ffd7 100644
--- a/arch/mips/kernel/scall32-o32.S
+++ b/arch/mips/kernel/scall32-o32.S
@@ -220,375 +220,9 @@ einval: li	v0, -ENOSYS
