Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 08 Aug 2017 01:02:19 +0200 (CEST)
Received: from mailapp01.imgtec.com ([195.59.15.196]:26650 "EHLO
        mailapp01.imgtec.com" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S23994854AbdHGXCBhSQQI (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 8 Aug 2017 01:02:01 +0200
Received: from HHMAIL01.hh.imgtec.org (unknown [10.100.10.19])
        by Forcepoint Email with ESMTPS id D65535FF0716C;
        Tue,  8 Aug 2017 00:01:49 +0100 (IST)
Received: from localhost (10.20.1.88) by HHMAIL01.hh.imgtec.org (10.100.10.21)
 with Microsoft SMTP Server (TLS) id 14.3.294.0; Tue, 8 Aug 2017 00:01:54
 +0100
From:   Paul Burton <paul.burton@imgtec.com>
To:     <linux-mips@linux-mips.org>
CC:     Ralf Baechle <ralf@linux-mips.org>,
        Paul Burton <paul.burton@imgtec.com>
Subject: [PATCH 1/7] MIPS: generic: Allow filtering enabled boards by requirements
Date:   Mon, 7 Aug 2017 16:01:12 -0700
Message-ID: <20170807230119.10629-2-paul.burton@imgtec.com>
...
index 876394554274..a715888179b3 100644
--- a/arch/mips/Makefile
+++ b/arch/mips/Makefile
@@ -486,8 +486,14 @@ $(eval $(call gen_generic_defconfigs,micro32,r2,eb el))
