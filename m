Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 20 Aug 2017 00:25:13 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:33690 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23995035AbdHSWUQL5eNi (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Sun, 20 Aug 2017 00:20:16 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id 8857648E84;
        Sun, 20 Aug 2017 00:20:15 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter01.heinlein-hosting.de (spamfilter01.heinlein-hosting.de [80.241.56.115]) (amavisd-new, port 10030)
        with ESMTP id VicDPBWBGJau; Sun, 20 Aug 2017 00:20:03 +0200 (CEST)
...
Subject: [PATCH v10 09/16] MIPS: lantiq: remove ltq_reset_cause() and ltq_boot_select()
Date:   Sun, 20 Aug 2017 00:18:16 +0200
Message-Id: <20170819221823.13850-10-hauke@hauke-m.de>
