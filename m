Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 10 Jul 2008 19:30:23 +0100 (BST)
Received: from elvis.franken.de ([193.175.24.41]:63201 "EHLO elvis.franken.de")
	by ftp.linux-mips.org with ESMTP id S20022673AbYGJSaB (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Thu, 10 Jul 2008 19:30:01 +0100
Received: from uucp (helo=solo.franken.de)
	by elvis.franken.de with local-bsmtp (Exim 3.36 #1)
	id 1KH0tz-0003lZ-01; Thu, 10 Jul 2008 20:29:59 +0200
Received: by solo.franken.de (Postfix, from userid 1000)
	id 1EF58C2AE3; Thu, 10 Jul 2008 20:29:58 +0200 (CEST)
From:	Thomas Bogendoerfer <tsbogend@alpha.franken.de>
Subject: [PATCH] ALSA driver for SGI HAL2 audio device
To:	alsa-devel@alsa-project.org, linux-mips@linux-mips.org
cc:	perex@perex.cz
Message-Id: <20080710182958.1EF58C2AE3@solo.franken.de>
Date:	Thu, 10 Jul 2008 20:29:58 +0200 (CEST)
Return-Path: <tsbogend@alpha.franken.de>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 19769
...
index 531f8ba..39e371d 100644
--- a/sound/mips/Kconfig
+++ b/sound/mips/Kconfig
@@ -11,5 +11,12 @@ config SND_AU1X00
 	help
