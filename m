Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 31 Mar 2015 16:11:47 +0200 (CEST)
Received: from kiutl.biot.com ([31.172.244.210]:43751 "EHLO kiutl.biot.com"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S27009525AbbCaOLqC8P4Z (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Tue, 31 Mar 2015 16:11:46 +0200
Received: from spamd by kiutl.biot.com with sa-checked (Exim 4.83)
        (envelope-from <bert@biot.com>)
        id 1YcwtO-0003pD-5y
        for linux-mips@linux-mips.org; Tue, 31 Mar 2015 16:11:46 +0200
Received: from [2a02:578:4a04:2a00::5] (helo=sumner.biot.com)
        by kiutl.biot.com with esmtps (TLSv1.2:DHE-RSA-AES128-SHA:128)
        (Exim 4.83)
        (envelope-from <bert@biot.com>)
        id 1YcwtH-0003oc-AD; Tue, 31 Mar 2015 16:11:39 +0200
Received: from bert by sumner.biot.com with local (Exim 4.82)
        (envelope-from <bert@biot.com>)
        id 1YcwtH-0004VH-0f; Tue, 31 Mar 2015 16:11:39 +0200
From:   Bert Vermeulen <bert@biot.com>
To:     ralf@linux-mips.org, broonie@kernel.org, linux-mips@linux-mips.org,
        linux-kernel@vger.kernel.org, linux-spi@vger.kernel.org,
        andy.shevchenko@gmail.com
Cc:     Bert Vermeulen <bert@biot.com>
Subject: [PATCH v3] spi: Add SPI driver for Mikrotik RB4xx series boards
Date:   Tue, 31 Mar 2015 16:11:30 +0200
Message-Id: <1427811090-17276-1-git-send-email-bert@biot.com>
X-Mailer: git-send-email 1.9.1
Return-Path: <bert@biot.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 46650
