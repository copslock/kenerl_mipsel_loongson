Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 18 Mar 2006 01:33:56 +0000 (GMT)
Received: from smtp106.sbc.mail.mud.yahoo.com ([68.142.198.205]:41082 "HELO
	smtp106.sbc.mail.mud.yahoo.com") by ftp.linux-mips.org with SMTP
	id S8133580AbWCRBdn (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Sat, 18 Mar 2006 01:33:43 +0000
Received: (qmail 18122 invoked from network); 18 Mar 2006 01:43:02 -0000
Received: from unknown (HELO lucon.org) (hjjean@sbcglobal.net@71.146.85.242 with login)
  by smtp106.sbc.mail.mud.yahoo.com with SMTP; 18 Mar 2006 01:43:01 -0000
Received: by lucon.org (Postfix, from userid 1000)
	id 85E2C63F33; Fri, 17 Mar 2006 17:42:59 -0800 (PST)
Date:	Fri, 17 Mar 2006 17:42:59 -0800
...
Subject: The Linux binutils 2.16.91.0.7 is released
Message-ID: <20060318014259.GA23067@lucon.org>
Mime-Version: 1.0
...
Please report any bugs related to binutils 2.16.91.0.7 to hjl@lucon.org
...
1. binutils-2.16.91.0.7.tar.bz2. Source code.
2. binutils-2.16.91.0.6-2.16.91.0.7.diff.bz2. Patch against the
   previous beta source code.
3. binutils-2.16.91.0.7-1.i386.rpm. IA-32 binary RPM for RedHat EL 3.
4. binutils-2.16.91.0.7-1.ia64.rpm. IA-64 binary RPM for RedHat EL 3.
5. binutils-2.16.91.0.7-1.x86_64.rpm. X64_64 binary RPM for RedHat
   EL 3.

There is no separate source rpm. You can do

# rpmbuild -ta binutils-2.16.91.0.7.tar.bz2
