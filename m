Received: with ECARTIS (v1.0.0; list linux-mips); Sat, 15 May 2010 17:38:07 +0200 (CEST)
Received: from mail-pw0-f49.google.com ([209.85.160.49]:52735 "EHLO
        mail-pw0-f49.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1491205Ab0EOPhs (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Sat, 15 May 2010 17:37:48 +0200
Received: by pwi3 with SMTP id 3so708651pwi.36
        for <multiple recipients>; Sat, 15 May 2010 08:37:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=3DfMfZGXmQYJ1/sf2yuiTCoYpPhYTQK2ik4pXyei3tg=;
        b=rL3fZPcSrIs76xYo/Low9bUTBruQKgznORT72n8zmoZlQgrmjFixRE6UK8nqM9kxhO
         ZZChqDK10T2GnhKyG0kbEPct2nERrevCfgaVNWJypG6GvffzabpvoeEp0YA6TRv1rHBX
         5JLAFvV3Is/w+2/MJvpxuUVfmhwkDuKdJRqOA=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=ouCFYiY/fnyiL+KzFttX17sl9njSiqZdLIZtfNeIqP4sVhArfenc5JI6fAvbHPAXgO
         HZxAe/pB1O/ou/bTTmzIBZJefMa0lJS+gcEbxI0f0esIhHCJrl+olSjxd2wYAY3VXCxg
         VVLBB9h4FX+Pbc4LRu+KBTSsL63Ttwgvzln3s=
Received: by 10.115.117.38 with SMTP id u38mr2122370wam.168.1273937861305;
        Sat, 15 May 2010 08:37:41 -0700 (PDT)
Received: from localhost.localdomain ([114.84.90.117])
        by mx.google.com with ESMTPS id n32sm30648683wae.10.2010.05.15.08.37.28
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Sat, 15 May 2010 08:37:40 -0700 (PDT)
From:   Deng-Cheng Zhu <dengcheng.zhu@gmail.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     a.p.zijlstra@chello.nl, paulus@samba.org, mingo@elte.hu,
        acme@redhat.com, jamie.iles@picochip.com, will.deacon@arm.com,
        Deng-Cheng Zhu <dengcheng.zhu@gmail.com>
Subject: [PATCH v4 1/9] MIPS/Oprofile: extract PMU defines/helper functions for sharing
Date:   Sat, 15 May 2010 23:36:47 +0800
Message-Id: <1273937815-4781-2-git-send-email-dengcheng.zhu@gmail.com>
