Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 23 Oct 2007 14:16:52 +0100 (BST)
Received: from mba.ocn.ne.jp ([122.1.235.107]:45251 "HELO smtp.mba.ocn.ne.jp")
	by ftp.linux-mips.org with SMTP id S20030740AbXJWNQn (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Tue, 23 Oct 2007 14:16:43 +0100
Received: from localhost (p3228-ipad307funabasi.chiba.ocn.ne.jp [123.217.181.228])
	by smtp.mba.ocn.ne.jp (Postfix) with ESMTP
	id B1BBCA418; Tue, 23 Oct 2007 22:15:21 +0900 (JST)
Date:	Tue, 23 Oct 2007 22:17:15 +0900 (JST)
Message-Id: <20071023.221715.130851823.anemo@mba.ocn.ne.jp>
To:	linux-mips@linux-mips.org
Cc:	ralf@linux-mips.org
Subject: [PATCH] txx9tmr clockevent/clocksource driver
...
---
 ...
 arch/mips/kernel/cevt-txx9.c                       |  177 ++++++++++++++++++++
...
+	.rating		= 200,
+	.read		= txx9_cs_read,
+	.mask		= CLOCKSOURCE_MASK((TXX9_TIMER_BITS - 1)),
...
+	__raw_writel(1 << (TXX9_TIMER_BITS - 1), &tmrptr->cpra);
+	__raw_writel(TCR_BASE | TXx9_TMTCR_TCE, &tmrptr->tcr);
+	txx9_cs_tmrptr = tmrptr;
+}
+#else /* CONFIG_CPU_TX39XX */
+
+#define TXX9_TIMER_BITS	32
+
+#endif /* CONFIG_CPU_TX39XX */
+
