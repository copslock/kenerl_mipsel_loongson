Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 11 May 2012 07:27:54 +0200 (CEST)
Received: from home.bethel-hill.org ([63.228.164.32]:34167 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1903543Ab2EKF1k (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 11 May 2012 07:27:40 +0200
Received: by home.bethel-hill.org with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
        (Exim 4.72)
        (envelope-from <sjhill@mips.com>)
        id 1SSiO4-0001oC-L3; Fri, 11 May 2012 00:27:32 -0500
From:   "Steven J. Hill" <sjhill@mips.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     "Steven J. Hill" <sjhill@mips.com>
Subject: [PATCH v2,1/9] MIPS: Add microMIPS configuration option.
Date:   Fri, 11 May 2012 00:27:26 -0500
Message-Id: <1336714046-31239-1-git-send-email-sjhill@mips.com>
X-Mailer: git-send-email 1.7.10
X-archive-position: 33243
...
---
 ...
 arch/mips/configs/sead3micro_defconfig | 1770 ++++++++++++++++++++++++++++++++
 4 files changed, 1782 insertions(+), 1 deletion(-)
 create mode 100644 arch/mips/configs/sead3micro_defconfig

diff --git a/arch/mips/Kconfig b/arch/mips/Kconfig
index a2ade2f..d0570f4 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -2056,6 +2056,13 @@ config CPU_HAS_SMARTMIPS
...
@@ -2121,6 +2128,9 @@ config SYS_SUPPORTS_HIGHMEM
