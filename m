Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 15 Aug 2013 11:21:22 +0200 (CEST)
Received: from nbd.name ([46.4.11.11]:56417 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6865278Ab3HOJUaXS3AQ (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 15 Aug 2013 11:20:30 +0200
Received: by nf.lan (Postfix, from userid 501)
        id A2AD84FF3E12; Thu, 15 Aug 2013 11:20:27 +0200 (CEST)
From:   Felix Fietkau <nbd@openwrt.org>
To:     linux-mips@linux-mips.org
Subject: [PATCH v2 3/3] MIPS: partially inline dma ops
Date:   Thu, 15 Aug 2013 11:20:27 +0200
Message-Id: <1376558427-26033-3-git-send-email-nbd@openwrt.org>
X-Mailer: git-send-email 1.8.0.2
In-Reply-To: <1376558427-26033-1-git-send-email-nbd@openwrt.org>
References: <1376558427-26033-1-git-send-email-nbd@openwrt.org>
Return-Path: <nbd@nbd.name>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 37555
...
index 9b258f5..5a3007c 100644
--- a/arch/mips/Kconfig
+++ b/arch/mips/Kconfig
@@ -1397,6 +1397,7 @@ config CPU_CAVIUM_OCTEON
 	select LIBFDT
 	select USE_OF
...
@@ -1617,6 +1618,9 @@ config SYS_HAS_CPU_XLR
...
@@ -44,26 +44,6 @@ static int __init setnocoherentio(char *str)
...
-
 ...
 {
 	gfp_t dma_flag;
@@ -119,8 +99,9 @@ void *dma_alloc_noncoherent(struct device *dev, size_t size,
 }
...
@@ -144,6 +125,7 @@ static void *mips_dma_alloc_coherent(struct device *dev, size_t size,
...
@@ -154,8 +136,8 @@ void dma_free_noncoherent(struct device *dev, size_t size, void *vaddr,
 }
...
@@ -170,6 +152,7 @@ static void mips_dma_free_coherent(struct device *dev, size_t size, void *vaddr,
...
+EXPORT_SYMBOL(mips_dma_free_coherent);
 ...
 static inline void __dma_sync_virtual(void *addr, size_t size,
 	enum dma_data_direction direction)
@@ -198,8 +181,8 @@ static inline void __dma_sync_virtual(void *addr, size_t size,
...
@@ -228,112 +211,7 @@ static inline void __dma_sync(struct page *page,
 		left -= len;
 	} while (left);
 }
-
...
+EXPORT_SYMBOL(__dma_sync);
 ...
 void dma_cache_sync(struct device *dev, void *vaddr, size_t size,
 			 enum dma_data_direction direction)
@@ -346,23 +224,10 @@ void dma_cache_sync(struct device *dev, void *vaddr, size_t size,
