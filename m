Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 24 May 2012 23:04:17 +0200 (CEST)
Received: from home.bethel-hill.org ([63.228.164.32]:42881 "EHLO
        home.bethel-hill.org" rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org
        with ESMTP id S1903738Ab2EXVDi (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Thu, 24 May 2012 23:03:38 +0200
Received: by home.bethel-hill.org with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
        (Exim 4.72)
        (envelope-from <sjhill@mips.com>)
        id 1SXfBw-0003tK-CI; Thu, 24 May 2012 16:03:28 -0500
From:   "Steven J. Hill" <sjhill@mips.com>
To:     linux-mips@linux-mips.org, ralf@linux-mips.org
Cc:     "Steven J. Hill" <sjhill@mips.com>
Subject: [PATCH v2] Update all configuration files for new features.
Date:   Thu, 24 May 2012 16:03:23 -0500
Message-Id: <1337893403-24696-1-git-send-email-sjhill@mips.com>
X-Mailer: git-send-email 1.7.10
X-archive-position: 33465
...
@@ -60,60 +467,129 @@ CONFIG_IPV6_OPTIMISTIC_DAD=y
 CONFIG_INET6_AH=m
 CONFIG_INET6_ESP=m
...
@@ -121,12 +597,25 @@ CONFIG_NETFILTER_XT_MATCH_STRING=m
...
+#
 ...
 CONFIG_IP_VS_WRR=m
 CONFIG_IP_VS_LC=m
@@ -137,23 +626,50 @@ CONFIG_IP_VS_DH=m
 CONFIG_IP_VS_SH=m
 CONFIG_IP_VS_SED=m
 CONFIG_IP_VS_NQ=m
+
...
@@ -162,8 +678,12 @@ CONFIG_IP_NF_RAW=m
...
@@ -172,9 +692,9 @@ CONFIG_IP6_NF_MATCH_OPTS=m
...
@@ -201,37 +721,80 @@ CONFIG_BRIDGE_EBT_SNAT=m
...
@@ -242,66 +805,375 @@ CONFIG_NET_ACT_NAT=m
...
+# CONFIG_ATA is not set
 ...
 CONFIG_BLK_DEV_MD=m
 CONFIG_MD_LINEAR=m
@@ -309,22 +1181,190 @@ CONFIG_MD_RAID0=m
 CONFIG_MD_RAID1=m
 CONFIG_MD_RAID10=m
 CONFIG_MD_RAID456=m
...
+# CONFIG_AMD_PHY is not set
 ...
 CONFIG_QSEMI_PHY=m
@@ -335,17 +1375,27 @@ CONFIG_SMSC_PHY=m
...
@@ -353,40 +1403,393 @@ CONFIG_HOSTAP_PLX=m
 CONFIG_HOSTAP_PCI=m
 CONFIG_IPW2100=m
...
@@ -394,42 +1797,141 @@ CONFIG_REISERFS_FS_SECURITY=y
 CONFIG_JFS_FS=m
...
@@ -467,27 +1969,254 @@ CONFIG_NLS_ISO8859_14=m
