Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 30 Mar 2011 09:26:59 +0200 (CEST)
Received: from nbd.name ([46.4.11.11]:45645 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1491067Ab1C3H0w (ORCPT <rfc822;linux-mips@linux-mips.org>);
...
Subject: [PATCH V5 02/10] MIPS: lantiq: add SoC specific code for XWAY family
Date:   Wed, 30 Mar 2011 09:27:48 +0200
Message-Id: <1301470076-17279-3-git-send-email-blogic@openwrt.org>
...
* make watchdog memory window smaller
* remove old prototype of ltq_gpio_setconfig()
