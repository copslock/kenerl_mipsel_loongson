Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 04 Jun 2009 14:08:50 +0100 (WEST)
Received: from mail-px0-f186.google.com ([209.85.216.186]:34980 "EHLO
	mail-px0-f186.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S20022611AbZFDNHi (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Thu, 4 Jun 2009 14:07:38 +0100
Received: by mail-px0-f186.google.com with SMTP id 16so749871pxi.22
        for <multiple recipients>; Thu, 04 Jun 2009 06:07:37 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=Yu8iELL2/qzXCBLN4fwYY9K9KtdewVrLOspLEORKlEQ=;
        b=MS/TVPYERrC3ps2NdTvnHKyJU9Xjn/xHYp72ekcTSOsKzFjNwDWnXJYKjiOlJyPKx6
         0oke0FfStUsr94gYop9g2OMI7qO47KYzNlg1MDaZnfGgGqFZsSylY5lXHiS5qFoTgvu1
         RLOfT3S7IEtZGau6sgeGeIemerLfGf1UJHE4s=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=gmail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=G0Iqsv9ZJPCFWRDAR6c89vos8TohI0pWN6CTZEYT0IfvFx7JDnF4pXdPvrMvQXE0Zn
         6gXt/MPalnB53/j01qpOK3NXS1rptRALL5CQJ07QbBn6ENQWCPPMaRuw/czwUMxoBhoF
         YMIkdx24schYmSrDG15VAXoxU+Hfr6HF19koc=
Received: by 10.114.151.4 with SMTP id y4mr3580768wad.27.1244120857577;
        Thu, 04 Jun 2009 06:07:37 -0700 (PDT)
Received: from localhost.localdomain ([202.201.14.140])
        by mx.google.com with ESMTPS id m28sm11150700waf.37.2009.06.04.06.07.31
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Thu, 04 Jun 2009 06:07:36 -0700 (PDT)
...
Subject: [loongson-PATCH-v3 15/25] add basic yeeloong(2f) laptop support
Date:	Thu,  4 Jun 2009 21:07:23 +0800
Message-Id: <438a70c6864380344960719a0a2fe0f32de9ff45.1244120575.git.wuzj@lemote.com>
...
Signed-off-by: Yan Hua <wuzj@lemote.com>
---
...
+#include <cmdline.h>
 ...
 #include <loongson.h>
 #include <cmdline.h>
@@ -47,6 +49,9 @@ void __init prom_init_cmdline(void)
 		strcat(arcs_cmdline, " ");
 	}
