Received: with ECARTIS (v1.0.0; list linux-mips); Sun, 28 Oct 2007 20:03:56 +0000 (GMT)
Received: from relay01.mx.bawue.net ([193.7.176.67]:4068 "EHLO
	relay01.mx.bawue.net") by ftp.linux-mips.org with ESMTP
	id S20023500AbXJ1UDq (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Sun, 28 Oct 2007 20:03:46 +0000
Received: from lagash (88-106-176-50.dynamic.dsl.as9105.com [88.106.176.50])
	(using TLSv1 with cipher AES256-SHA (256/256 bits))
	(No client certificate requested)
	by relay01.mx.bawue.net (Postfix) with ESMTP id 5859C48FB4;
	Sun, 28 Oct 2007 20:15:24 +0100 (CET)
Received: from ths by lagash with local (Exim 4.68)
	(envelope-from <ths@networkno.de>)
	id 1ImELk-0008SW-Ek; Sun, 28 Oct 2007 20:03:08 +0000
Date:	Sun, 28 Oct 2007 20:03:08 +0000
From:	Thiemo Seufer <ths@networkno.de>
To:	Ralf Baechle <ralf@linux-mips.org>
Cc:	linux-mips@linux-mips.org, netdev@vger.kernel.org
Subject: Re: [PATCH] Fix/Rewrite of the mipsnet driver
Message-ID: <20071028200308.GB22287@networkno.de>
References: <20071028043846.GM29176@networkno.de> <20071029002517.GB16913@linux-mips.org>
MIME-Version: 1.0
