Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 22 Aug 2013 19:47:46 +0200 (CEST)
Received: from arrakis.dune.hu ([78.24.191.176]:42535 "EHLO arrakis.dune.hu"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S6853183Ab3HVRqpTeMiq (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 22 Aug 2013 19:46:45 +0200
Received: from arrakis.dune.hu (localhost [127.0.0.1])
        by arrakis.dune.hu (Postfix) with ESMTP id 47F672807AB;
        Thu, 22 Aug 2013 19:46:16 +0200 (CEST)
...
Subject: [PATCH 1/3] MIPS: ralink: mt7620: improve clock frequency detection
Date:   Thu, 22 Aug 2013 19:46:39 +0200
Message-Id: <1377193601-18677-1-git-send-email-juhosg@openwrt.org>
X-Mailer: git-send-email 1.7.10
Return-Path: <juhosg@openwrt.org>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 37647
...
-
 static struct ralink_pinmux_grp mode_mux[] = {
 	{
 		.name = "i2c",
@@ -145,34 +142,187 @@ void ralink_usb_platform(void)
