Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 18 Jul 2014 23:19:25 +0200 (CEST)
Received: from mail-pd0-f178.google.com ([209.85.192.178]:40500 "EHLO
        mail-pd0-f178.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6861406AbaGRVS55V9q- (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Fri, 18 Jul 2014 23:18:57 +0200
Received: by mail-pd0-f178.google.com with SMTP id w10so5675422pde.37
        for <linux-mips@linux-mips.org>; Fri, 18 Jul 2014 14:18:51 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20130820;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:in-reply-to:references;
        bh=RmmuRrlfyXRM72CYMXEAYMIiUBbnAZddKlt6Rr6pQTc=;
        b=
X-Gm-Message-State: ALoCoQklTT1A5Xhamh3MMdarlXuY5AovJQ2gNE1hPvztcZQgkklttEMxyVt1YokTxGwj0xgVNIn4
X-Received: by 10.66.184.79 with SMTP id es15mr8127321pac.57.1405718331391;
        Fri, 18 Jul 2014 14:18:51 -0700 (PDT)
Received: from localhost (50-76-60-73-ip-static.hfc.comcastbusiness.net. [50.76.60.73])
        by mx.google.com with ESMTPSA id n2sm4627538pdo.32.2014.07.18.14.18.48
        for <multiple recipients>
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 18 Jul 2014 14:18:49 -0700 (PDT)
...
Subject: [PATCH v2 2/7] seccomp: Refactor the filter callback and the API
Date:   Fri, 18 Jul 2014 14:18:10 -0700
Message-Id: <5a5425206adc443e9f56d35fdf8e2a1875927ada.1405717901.git.luto@amacapital.net>
