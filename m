Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 25 Nov 2011 13:02:39 +0100 (CET)
Received: from nbd.name ([46.4.11.11]:59445 "EHLO nbd.name"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S1904619Ab1KYMC3 (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Fri, 25 Nov 2011 13:02:29 +0100
From:   John Crispin <blogic@openwrt.org>
To:     Ralf Baechle <ralf@linux-mips.org>
Cc:     linux-mips@linux-mips.org, John Crispin <blogic@openwrt.org>,
        Thomas Langer <thomas.langer@lantiq.com>
Subject: [PATCH V3 4/6] MIPS: lantiq: add basic support for FALC-ON
Date:   Fri, 25 Nov 2011 14:01:46 +0100
Message-Id: <1322226106-21847-1-git-send-email-blogic@openwrt.org>
X-Mailer: git-send-email 1.7.7.1
X-archive-position: 31996
...
Changes in V3:
* use a while loop instead of unreachable(); when doing a soc reset
