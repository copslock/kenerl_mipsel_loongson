Received: with ECARTIS (v1.0.0; list linux-mips); Mon, 26 Sep 2011 11:00:51 +0200 (CEST)
Received: from mail-vx0-f177.google.com ([209.85.220.177]:35100 "EHLO
        mail-vx0-f177.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S1492000Ab1IZJAp (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Mon, 26 Sep 2011 11:00:45 +0200
Received: by vcbfo1 with SMTP id fo1so3751042vcb.36
        for <multiple recipients>; Mon, 26 Sep 2011 02:00:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=gamma;
        h=mime-version:in-reply-to:references:date:message-id:subject:from:to
         :cc:content-type;
        bh=Y3UP40JhpFqOa1dhBOEmT3JaPbqRcEPnAdBwVY/mOZY=;
        b=KvYZEkvCHi5dmYfTO1YL0dFUgL4rQbSVIKVEkndXqAsTr1AIjGo/OYsx3mclunl3Sz
         mvvv3/xREx7WmE0E4pcM7iXQoF2eSdyV9lNmi7MlY9GrxuMhyTe+q4VMuErSIF3k+5gs
         qzgQnH5Z7p/vMtdtlJN9hEE3NHhYcaQuQaPRI=
MIME-Version: 1.0
Received: by 10.220.120.12 with SMTP id b12mr1758962vcr.111.1317027638245;
 Mon, 26 Sep 2011 02:00:38 -0700 (PDT)
Received: by 10.220.169.131 with HTTP; Mon, 26 Sep 2011 02:00:38 -0700 (PDT)
...
Date:   Mon, 26 Sep 2011 17:00:38 +0800
Message-ID: <CAJhJPsXa1FiOSRSKerkdUk_EBvzJfQytk05uM1fidipeMX45Jw@mail.gmail.com>
...
>
> Are you using TAB above?

Yes.
The mail did not show it correctly.
...
>
> The above exist format violation, SPACE, TAB?
...
>
> parenthesis may be not required for the scenes.
...
>> +
>> +#define LS1_INTC_REG(x)                ((void __iomem
>> *)(LOONGSON1_INTC_BASE \
>> +                               + n * 0x18 + x))
>
>
...
>         ((volatile void __iomem *)(LOONGSON1_INTC_BASE  + (n * 0x18) + x))
...
>> +
>> +#define LS1_WDT_REG(x)         ((void __iomem *)(LOONGSON1_WDT_BASE +
>> (x)))
>> +
...
>>                break;
>>
>> @@ -636,6 +639,18 @@ static inline void cpu_probe_legacy(struct
