Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 03 Jun 2009 18:05:12 +0100 (WEST)
Received: from mail-bw0-f225.google.com ([209.85.218.225]:56059 "EHLO
	mail-bw0-f225.google.com" rhost-flags-OK-OK-OK-OK)
	by ftp.linux-mips.org with ESMTP id S20022417AbZFCRDI (ORCPT
	<rfc822;linux-mips@linux-mips.org>); Wed, 3 Jun 2009 18:03:08 +0100
Received: by bwz25 with SMTP id 25so145444bwz.0
        for <multiple recipients>; Wed, 03 Jun 2009 10:03:01 -0700 (PDT)
DKIM-Signature:	v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlemail.com; s=gamma;
        h=domainkey-signature:received:received:from:to:cc:subject:date
         :message-id:x-mailer:in-reply-to:references;
        bh=cTfxWDJTpmdotc49If9x1+O9TlD/zOA/YYYSw+fqpPM=;
        b=wYg90osvTHdXRPrTKex8Sk1YSitJKFfdoxR5Q3qeoRKsvzF3yiki7YcJ2kwP0PABRF
         BbHwpZNlWhX+9a1+J31Ei0JCDhgwZYWe9DFtgU6zck5e92Mc8NOsWlIL4hD6yUyNqv7r
         fZOEi+Q2LF2XxF2z9Y2cHPcY7wb9rMG17V9as=
DomainKey-Signature: a=rsa-sha1; c=nofws;
        d=googlemail.com; s=gamma;
        h=from:to:cc:subject:date:message-id:x-mailer:in-reply-to:references;
        b=e9VpXt7Lzs4bcKtCvbNhdTHOGZ/lw0yF9iRo579fT0v59/PuKIaiO4VbjWL50vIDgF
         XOjbGOWAsiNYEOWVkIc3XOYj1+vqirH8/l/+/kwbR9bmb1uxHwBhrK36MaLymEJkOKjB
         QSrkbPnQwHDzh9GqjRoGgbzdmmE6RTnOwYsAk=
Received: by 10.204.121.131 with SMTP id h3mr1067696bkr.172.1244048581713;
        Wed, 03 Jun 2009 10:03:01 -0700 (PDT)
Received: from localhost.localdomain (p5496DB58.dip.t-dialin.net [84.150.219.88])
        by mx.google.com with ESMTPS id 18sm2452543fks.10.2009.06.03.10.02.58
        (version=TLSv1/SSLv3 cipher=RC4-MD5);
        Wed, 03 Jun 2009 10:03:00 -0700 (PDT)
From:	Manuel Lauss <manuel.lauss@googlemail.com>
To:	Linux-MIPS <linux-mips@linux-mips.org>,
	Ralf Baechle <ralf@linux-mips.org>
Cc:	Manuel Lauss <manuel.lauss@gmail.com>
Subject: [PATCH 3/5] Alchemy: extended DB1200 board support.
Date:	Wed,  3 Jun 2009 19:02:46 +0200
Message-Id: <1244048568-18006-4-git-send-email-manuel.lauss@gmail.com>
X-Mailer: git-send-email 1.6.3.1
In-Reply-To: <1244048568-18006-3-git-send-email-manuel.lauss@gmail.com>
References: <1244048568-18006-1-git-send-email-manuel.lauss@gmail.com>
 ...
 <1244048568-18006-3-git-send-email-manuel.lauss@gmail.com>
Return-Path: <manuel.lauss@googlemail.com>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 23232
...
---
 ...
 arch/mips/alchemy/devboards/db1200/platform.c    |  505 +++++++
 ...
 14 files changed, 1887 insertions(+), 832 deletions(-)
...
@@ -120,168 +141,188 @@ CONFIG_GENERIC_HARDIRQS=y
...
@@ -292,107 +333,24 @@ CONFIG_IP_FIB_HASH=y
...
@@ -402,21 +360,23 @@ CONFIG_NF_CONNTRACK_PROC_COMPAT=y
...
+# CONFIG_NET_9P is not set
 ...
 #
 # Device Drivers
@@ -425,25 +385,24 @@ CONFIG_NET_CLS_ROUTE=y
 #
...
@@ -456,6 +415,7 @@ CONFIG_MTD_BLOCK=y
...
@@ -481,19 +441,22 @@ CONFIG_MTD_CFI_UTIL=y
...
@@ -505,224 +468,139 @@ CONFIG_MTD_ALCHEMY=y
...
@@ -749,28 +624,34 @@ CONFIG_INPUT_EVDEV=y
...
-# CONFIG_AU1X00_GPIO is not set
 ...
 #
 # Serial drivers
@@ -778,33 +659,22 @@ CONFIG_VT_HW_CONSOLE_BINDING=y
...
-# CONFIG_DTLK is not set
 ...
 #
@@ -813,223 +683,596 @@ CONFIG_LEGACY_PTY_COUNT=256
...
@@ -1040,16 +1283,13 @@ CONFIG_FAT_DEFAULT_IOCHARSET="iso8859-1"
 CONFIG_PROC_FS=y
 CONFIG_PROC_KCORE=y
...
@@ -1061,119 +1301,190 @@ CONFIG_CONFIGFS_FS=m
 CONFIG_JFFS2_FS=y
...
+CONFIG_CMDLINE="console=ttyS0,115200 video=au1200fb:panel:bs fastboot"
+# CONFIG_DEBUG_STACK_USAGE is not set
+# CONFIG_RUNTIME_DEBUG is not set
 
 #
 # Security options
@@ -1181,67 +1492,123 @@ CONFIG_CMDLINE="mem=48M"
 CONFIG_KEYS=y
