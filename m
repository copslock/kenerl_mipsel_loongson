Received: with ECARTIS (v1.0.0; list linux-mips); Fri, 10 Apr 2009 11:12:15 +0100 (BST)
Received: from fnoeppeil48.netpark.at ([217.175.205.176]:35540 "EHLO
	roarinelk.homelinux.net") by ftp.linux-mips.org with ESMTP
	id S28586463AbZDJKJC (ORCPT <rfc822;linux-mips@linux-mips.org>);
	Fri, 10 Apr 2009 11:09:02 +0100
Received: (qmail 8990 invoked from network); 10 Apr 2009 12:09:00 +0200
Received: from scarran.roarinelk.net (HELO localhost.localdomain) (192.168.0.242)
  by 192.168.0.1 with SMTP; 10 Apr 2009 12:09:00 +0200
From:	Manuel Lauss <mano@roarinelk.homelinux.net>
To:	Linux-MIPS <linux-mips@linux-mips.org>
Cc:	Manuel Lauss <mano@roarinelk.homelinux.net>,
	Florian Fainelli <florian@openwrt.org>
Subject: [PATCH v4 1/2] Alchemy: rewrite GPIO support.
Date:	Fri, 10 Apr 2009 12:08:59 +0200
Message-Id: <1239358140-20923-1-git-send-email-mano@roarinelk.homelinux.net>
X-Mailer: git-send-email 1.6.2
Return-Path: <mano@roarinelk.homelinux.net>
X-Envelope-To: <"|/home/ecartis/ecartis -s linux-mips"> (uid 0)
X-Orcpt: rfc822;linux-mips@linux-mips.org
Original-Recipient: rfc822;linux-mips@linux-mips.org
X-archive-position: 22324
...
---
This is the final version! Honestly!
