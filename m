Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 22 Jul 2014 03:54:42 +0200 (CEST)
Received: from mail-pa0-f45.google.com ([209.85.220.45]:55598 "EHLO
        mail-pa0-f45.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6842316AbaGVByIItGed (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 22 Jul 2014 03:54:08 +0200
Received: by mail-pa0-f45.google.com with SMTP id eu11so10939452pac.4
        for <linux-mips@linux-mips.org>; Mon, 21 Jul 2014 18:54:02 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20130820;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:in-reply-to:references;
        bh=R24X5DTmBYCve1IwdsK+Ivj9CvLPvwCO1JfBJs8kxbI=;
        b=
X-Gm-Message-State: ALoCoQkfc35LPkEErBwJcVaaV3j3EcKd0Jfmd/Dia3JWS3rrJyraIUA8Kz3kprLb5ZcnhVEOKpXN
X-Received: by 10.68.223.202 with SMTP id qw10mr67985pbc.163.1405994042136;
        Mon, 21 Jul 2014 18:54:02 -0700 (PDT)
Received: from localhost ([2600:1010:b01b:59a8:9138:8dc8:286b:79c0])
        by mx.google.com with ESMTPSA id vn5sm15527338pbc.18.2014.07.21.18.53.59
        for <multiple recipients>
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 21 Jul 2014 18:54:01 -0700 (PDT)
...
Subject: [PATCH v3 7/8] x86_64,entry: Treat regs->ax the same in fastpath and slowpath syscalls
Date:   Mon, 21 Jul 2014 18:53:42 -0700
Message-Id: <1382f8ffa16d26c038edbb145ef8093b10bac8a6.1405992946.git.luto@amacapital.net>
