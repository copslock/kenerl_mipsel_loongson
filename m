Received: with ECARTIS (v1.0.0; list linux-mips); Wed, 30 Jan 2013 12:56:33 +0100 (CET)
Received: from mail-da0-f53.google.com ([209.85.210.53]:61167 "EHLO
        mail-da0-f53.google.com" rhost-flags-OK-OK-OK-OK)
        by eddie.linux-mips.org with ESMTP id S6827597Ab3A3L43P4R-v (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Wed, 30 Jan 2013 12:56:29 +0100
Received: by mail-da0-f53.google.com with SMTP id x6so740593dac.26
        for <multiple recipients>; Wed, 30 Jan 2013 03:56:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20120113;
        h=x-received:sender:from:to:cc:subject:date:message-id:x-mailer
         :in-reply-to:references;
        bh=zzxgQ5f6SnYMOlpCeMLAxq/ygTYGzv7lbCGp4uQfEkk=;
        b=
X-Received: by 10.68.130.195 with SMTP id og3mr9900885pbb.10.1359527454776;
        Tue, 29 Jan 2013 22:30:54 -0800 (PST)
Received: from localhost.localdomain ([222.92.8.142])
        by mx.google.com with ESMTPS id gj1sm612282pbc.11.2013.01.29.22.30.38
        (version=TLSv1 cipher=RC4-SHA bits=128/128);
        Tue, 29 Jan 2013 22:30:53 -0800 (PST)
...
Subject: [PATCH V9 05/13] MIPS: Loongson: Add UEFI-like firmware interface support
Date:   Wed, 30 Jan 2013 14:24:58 +0800
Message-Id: <1359527106-22879-6-git-send-email-chenhc@lemote.com>
