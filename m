Received: with ECARTIS (v1.0.0; list linux-mips); Tue, 14 Feb 2017 11:10:42 +0100 (CET)
Received: from mailapp01.imgtec.com ([195.59.15.196]:30908 "EHLO
        imgpgp01.kl.imgtec.org" rhost-flags-OK-OK-OK-FAIL)
        by eddie.linux-mips.org with ESMTP id S23991087AbdBNKKdqHamh (ORCPT
        <rfc822;linux-mips@linux-mips.org>); Tue, 14 Feb 2017 11:10:33 +0100
Received: from imgpgp01.kl.imgtec.org (imgpgp01.kl.imgtec.org [127.0.0.1])
        by imgpgp01.kl.imgtec.org (PGP Universal) with ESMTP id 0786F41F8EB7;
        Tue, 14 Feb 2017 11:14:25 +0000 (GMT)
Received: from mailapp01.imgtec.com ([10.100.180.241])
  by imgpgp01.kl.imgtec.org (PGP Universal service);
  Tue, 14 Feb 2017 11:14:25 +0000
X-PGP-Universal: processed;
        by imgpgp01.kl.imgtec.org on Tue, 14 Feb 2017 11:14:25 +0000
Received: from hhmail02.hh.imgtec.org (unknown [10.100.10.20])
        by Forcepoint Email with ESMTPS id 67C12D0225A11;
        Tue, 14 Feb 2017 10:10:25 +0000 (GMT)
Received: from localhost (192.168.154.110) by hhmail02.hh.imgtec.org
 (10.100.10.21) with Microsoft SMTP Server (TLS) id 14.3.294.0; Tue, 14 Feb
 2017 10:10:27 +0000
Date:   Tue, 14 Feb 2017 10:10:27 +0000
...
Message-ID: <20170214101027.GR24226@jhogan-linux.le.imgtec.org>
References: <20170129020557.1336-1-paul.gortmaker@windriver.com>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
        protocol="application/pgp-signature"; boundary="MI2pJyvBeFc4alSb"
Content-Disposition: inline
In-Reply-To: <20170129020557.1336-1-paul.gortmaker@windriver.com>
...
> diff --git a/arch/mips/alchemy/common/dma.c b/arch/mips/alchemy/common/dm=
a.c
...
>  #include <linux/spinlock.h>
> diff --git a/arch/mips/alchemy/common/gpiolib.c b/arch/mips/alchemy/commo=
n/gpiolib.c
...
> diff --git a/arch/mips/alchemy/common/prom.c b/arch/mips/alchemy/common/p=
rom.c
...
>  #include <linux/syscore_ops.h>
>  #include <asm/cpu.h>
> diff --git a/arch/mips/alchemy/common/vss.c b/arch/mips/alchemy/common/vs=
s.c
...
>  #include <asm/mach-au1x00/au1000.h>
> =20
> diff --git a/arch/mips/alchemy/devboards/bcsr.c b/arch/mips/alchemy/devbo=
ards/bcsr.c
...
> diff --git a/arch/mips/cavium-octeon/executive/cvmx-bootmem.c b/arch/mips=
/cavium-octeon/executive/cvmx-bootmem.c
...
> diff --git a/arch/mips/cavium-octeon/executive/cvmx-helper-errata.c b/arc=
h/mips/cavium-octeon/executive/cvmx-helper-errata.c
...
> =20
> diff --git a/arch/mips/cavium-octeon/executive/cvmx-sysinfo.c b/arch/mips=
/cavium-octeon/executive/cvmx-sysinfo.c
...
>  #include <linux/init.h>
> diff --git a/arch/mips/loongson64/common/cs5536/cs5536_mfgpt.c b/arch/mip=
s/loongson64/common/cs5536/cs5536_mfgpt.c
...
> diff --git a/arch/mips/loongson64/common/setup.c b/arch/mips/loongson64/c=
ommon/setup.c
...
>  #include <asm/wbflush.h>
>  #include <asm/bootinfo.h>
> diff --git a/arch/mips/loongson64/common/uart_base.c b/arch/mips/loongson=
64/common/uart_base.c
...
>  #include <linux/delay.h>
> =20
> diff --git a/arch/mips/loongson64/lemote-2f/irq.c b/arch/mips/loongson64/=
lemote-2f/irq.c
...
> diff --git a/arch/mips/loongson64/loongson-3/irq.c b/arch/mips/loongson64=
/loongson-3/irq.c
...
> diff --git a/arch/mips/mti-malta/malta-platform.c b/arch/mips/mti-malta/m=
alta-platform.c
...
> diff --git a/arch/mips/pmcs-msp71xx/msp_prom.c b/arch/mips/pmcs-msp71xx/m=
sp_prom.c
...
>  #include <linux/init.h>
>  #include <linux/string.h>
> diff --git a/arch/mips/pmcs-msp71xx/msp_time.c b/arch/mips/pmcs-msp71xx/m=
sp_time.c
...
>  #include <asm/io.h>
>  #include <asm/bootinfo.h>
> diff --git a/arch/mips/sgi-ip22/ip22-nvram.c b/arch/mips/sgi-ip22/ip22-nv=
ram.c
...
>  #include <linux/kernel.h>
>  #include <linux/sched.h>
> diff --git a/arch/mips/sgi-ip22/ip22-setup.c b/arch/mips/sgi-ip22/ip22-se=
tup.c
...
>  #include <linux/sched.h>
>  #include <linux/tty.h>
> diff --git a/arch/mips/sgi-ip27/ip27-berr.c b/arch/mips/sgi-ip27/ip27-ber=
r.c
...
>  #include <asm/io.h>
>  #include <asm/mipsregs.h>
> diff --git a/arch/mips/sibyte/bcm1480/setup.c b/arch/mips/sibyte/bcm1480/=
setup.c
...
>  #include <linux/string.h>
> =20
> diff --git a/arch/mips/sibyte/sb1250/setup.c b/arch/mips/sibyte/sb1250/se=
tup.c
...

6RiiLteS7BzEKN1e41Zz
=FyV9
-----END PGP SIGNATURE-----
