Received: with ECARTIS (v1.0.0; list linux-mips); Thu, 03 Aug 2017 01:04:17 +0200 (CEST)
Received: from mx2.mailbox.org ([80.241.60.215]:50344 "EHLO mx2.mailbox.org"
        rhost-flags-OK-OK-OK-OK) by eddie.linux-mips.org with ESMTP
        id S23994863AbdHBW7RXXy6W (ORCPT <rfc822;linux-mips@linux-mips.org>);
        Thu, 3 Aug 2017 00:59:17 +0200
Received: from smtp1.mailbox.org (smtp1.mailbox.org [80.241.60.240])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx2.mailbox.org (Postfix) with ESMTPS id E4BAE46217;
        Thu,  3 Aug 2017 00:59:11 +0200 (CEST)
X-Virus-Scanned: amavisd-new at heinlein-support.de
Received: from smtp1.mailbox.org ([80.241.60.240])
        by spamfilter03.heinlein-hosting.de (spamfilter03.heinlein-hosting.de [80.241.56.117]) (amavisd-new, port 10030)
        with ESMTP id iNw52yOnsDLj; Thu,  3 Aug 2017 00:59:10 +0200 (CEST)
...
Subject: [PATCH v8 14/16] phy: Add an USB PHY driver for the Lantiq SoCs using the RCU module
Date:   Thu,  3 Aug 2017 00:57:15 +0200
Message-Id: <20170802225717.24408-15-hauke@hauke-m.de>
